...
Public Class C_Lote2
    ...
    Public Shared Function IRIS_GRABA_QC_LOTE_DE_MUESTRA(ByVal AREA_COD As String,
        ...
        datas = NN.IRIS_GRABA_QC_LOTE_DE_MUESTRA(AREA_COD, AREA_DES, ID_ESTADO, ID_ANA, EXP)
    ...
    <Services.WebMethod()>
    Public Shared Function IRIS_QC_BUSCA_LOTE_ACTIVO_DESACTIVO_() As List(Of E_IRIS_QC_BUSCA_LOTE_ACTIVO_DESACTIVO)
        ...
        datas = NN.IRIS_QC_BUSCA_LOTE_ACTIVO_DESACTIVO_()

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Examenes_Sum.aspx.vb" Inherits="Presentacion.Examenes_Sum" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function Ajax_Ddl() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Examenes_Sum.aspx/Llenar_Ddl",
                //"data": '{}',
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Examenes_Sum.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Examenes_Sum.aspx/Gen_Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
...
<div id="mError_AAH" class="modal fade" role="dialog">
    ...
    <div class="flex_col">
        ...
        <div class="card-header bg-bar p-2">
            <h5>Resumen por Tipo de Examen</h5>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg">
            ...
            <div class='input-group date' id='Txt_Date02'>
                ...
                <div class="col-lg">
                    <label for="DdlExamen">Tipo de Examen:</label>

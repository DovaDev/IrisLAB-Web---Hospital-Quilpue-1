...
Public Class D_IRIS_WEBF_BUSCA_USUARIO_TM_GRILLA
    Function IRIS_WEBF_BUSCA_USUARIO_TM_GRILLA(ByVal ID_USU As Integer) As List(Of E_IRIS_WEBF_BUSCA_USUARIO_TM_GRILLA)
        ...
        'Declaraciones 'lista'
        Dim E_Proc_Item As E_IRIS_WEBF_BUSCA_USUARIO_TM_GRILLA
        Dim E_Proc_List As New List(Of E_IRIS_WEBF_BUSCA_USUARIO_TM_GRILLA)

        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_BUSCA_USUARIO_TM_GRILLA"
        ...
        While Obj_Reader.Read
            E_Proc_Item = New E_IRIS_WEBF_BUSCA_USUARIO_TM_GRILLA

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Config_Ate_LM_3.aspx.vb" Inherits="Presentacion.Config_Ate_LM_3" %>
...
("<div class='alert alert-danger alertas'><strong>La suma de los agendados (normal, prioritario y espóntaneo) debe ser igual a Agendado Total</strong>  </div>")
    ...
    <script>
        ...
        function Call_AJAX_Ddl_Año() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Config_Ate_LM_3.aspx/Llenar_Ddl_Año",
                //"data": Data_Par,
        ...
        function Call_AJAX_Ddl_LugarTM() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Config_Ate_LM_3.aspx/Llenar_Ddl_LugarTM",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": data => {
        ...
        function Call_AJAX_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Config_Ate_LM_3.aspx/Llenar_Tabla",
                "data": strParam,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": data => {
        ...
        function Call_AJAX_Guardar() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Config_Ate_LM_3.aspx/Guardar_Conf_Examenes",
                "data": strParam,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": data => {
        ...
        function Call_AJAX_Modificar() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Config_Ate_LM_3.aspx/Modificar_Conf_Examenes",
                "data": strParam,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": data => {

...
Public Class D_IRIS_WEBF_UPDATE_NACIONALIDAD
    'Declaraciones Generales
    Dim CC_ConnBD As Conexion.ConexionBD
    Dim DD_GEN As New D_General_Functions
    Function IRIS_WEBF_UPDATE_NACIONALIDAD(ByVal ID_NAC As Integer,
                                            ByVal NAC_COD As String,
                                            ByVal NAC_DES As String,
        ...
        With Cmd_SQL
            ...
            .CommandText = "IRIS_WEBF_UPDATE_NACIONALIDAD"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Enviar parámetros
        With Cmd_SQL.Parameters
            .Add("@ID_NAC", OleDbType.Numeric).Value = ID_NAC

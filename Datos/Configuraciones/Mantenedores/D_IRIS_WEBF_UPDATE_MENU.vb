...
Public Class D_IRIS_WEBF_UPDATE_MENU
    'Declaraciones Generales
    Dim CC_ConnBD As Conexion.ConexionBD
    Dim DD_GEN As New D_General_Functions
    Function IRIS_WEBF_UPDATE_MENU(ByVal ID As Integer,
                                            ByVal NOM As String,
        ...
        With Cmd_SQL
            ...
            .CommandText = "IRIS_WEBF_UPDATE_MENU"
        ...
        With Cmd_SQL.Parameters
            ...
            .Add("@DESC", OleDbType.VarChar).Value = DESC
        End With

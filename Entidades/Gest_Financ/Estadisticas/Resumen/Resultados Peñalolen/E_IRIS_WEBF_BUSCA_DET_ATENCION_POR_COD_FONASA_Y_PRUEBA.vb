Public Class E_IRIS_WEBF_BUSCA_DET_ATENCION_POR_COD_FONASA_Y_PRUEBA
    ...
    Public Property TP_RESUL_COD As String
        ...
        End Set
    End Property
    Public Property ID_U_MEDIDA As String
        Get
    ...
    Public Property PAC_RUT As String
        ...
        End Set
    End Property
    Public Property PRU_ORDEN As String
        Get
            Return EE_PRU_ORDEN
        End Get
        Set(value As String)

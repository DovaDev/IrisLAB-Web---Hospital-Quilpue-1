...
Public Class Lis_Env_Mues_Lab_5
    ...
    Public Shared Function Llenar_Ddl_Exam() As String
        ...
        Data_Exam = NN_Exam.IRIS_WEBF_BUSCA_CB_DESC_TODOS()
    ...
    Public Shared Function Excel(ByVal DOMAIN_URL As String, ByVal TIPO As Integer, ByVal DESDE As String, ByVal HASTA As String,
        ...
        'Colocar Título
        xls.SetCellValue(1, 1, "Estados de Exámenes por Tubos")
        ...
        Dim Relative_Path As String = "IRISPDFDERIVADOS\Estados_de_Examenes_Por_Tubos" & Format(Date.Now, "dd-MM-yyyy_hh-mm-ss") & ".xlsx"
    ...
    <Services.WebMethod()>
    Public Shared Function PDFF(ByVal DOMAIN_URL As String, ByVal TIPO As Integer, ByVal DESDE As String, ByVal HASTA As String,
                                            ByVal ID_PRE As Integer,
                                            ByVal ID_CF As String) As String
        'Declaraciones del Serializador
        Dim Serializer As New JavaScriptSerializer
        ...
        link = NN_pdf.PDFF_tubaso(DOMAIN_URL, TIPO, DESDE, HASTA, ID_PRE, ID_CF)
        Return link
    End Function

    <Services.WebMethod()>
    Public Shared Function Llenar_DataTable(ByVal TIPO As Integer, ByVal DESDE As String, ByVal HASTA As String, ByVal ID_PRE As Integer, ByVal ID_CF As String) As E_List_wDict

...
Public Class D_IRIS_WEBF_UPDATE_CODIGO_FONASA
    Dim DD_GEN As New D_General_Functions
    Function D_IRIS_WEBF_UPDATE_CODIGO_FONASA(ByVal ID_CF As Integer, ByVal COD_CF As String, ByVal DESC_CF As String, ByVal CORTO_CF As String, ByVal DIAS_CF As Integer, ByVal ID_ESTADO As Integer, ByVal SOLA_CF As String, ByVal IMP_NOM_CF As String, ByVal IMP_SEL_CF As String, ByVal IMP_PAR_CF As String, ByVal HOST_CF As String, ByVal ID_MUESTRA As String) As Integer
        Dim objconexion As New Conexion.ConexionBD
        Dim Cmd_command As New OleDb.OleDbCommand
        Dim Read_Sql As Integer
        'definiendo tipo de consulta a la BD
        Cmd_command.CommandType = CommandType.StoredProcedure
        Cmd_command.CommandText = "IRIS_WEBF_UPDATE_CODIGO_FONASA"

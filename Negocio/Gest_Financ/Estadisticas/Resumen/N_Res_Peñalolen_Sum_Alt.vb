...
Imports Datos
Imports Entidades
Public Class N_Res_Peñalolen_Sum_Alt
    ...
    End Function
    Function Gen_Excel(ByVal DOMAIN_URL As String, ByVal ALL As Boolean, ByVal DESDE As String, ByVal HASTA As String, ByVal ID_CF As Long, ByVal ID_TM As Long, ByVal ID_PREV As Long, ByVal ID_PROG As Long, ByVal ID_SUBPROG As Long) As String
        'Declaraciones Generales

...
Public Class Lugar_TM_2
    ...
    Public Shared Function IRIS_WEBF_BUSCA_PROCEDENCIA() As String
        ...
        data_paciente = NN.IRIS_WEBF_BUSCA_PROCEDENCIA_2()
        If (data_paciente.Count > 0) Then
            'Serializar con JSON
            Serializer.MaxJsonLength = 999999999
            Serializer.Serialize(data_paciente, str_Builder)
    ...
    Public Shared Function IRIS_WEBF_UPDATE_PROCEDENCIA(ByVal ID_PROCEDENCIA As Integer,
                                                        ...
                                                        ByVal COD_AVIS As String) As String
        'Declaraciones del Serializador
        Dim Serializer As New JavaScriptSerializer
        Dim str_Builder As New StringBuilder
        Dim datas As String = ""
        ...
        Dim NN As N_IRIS_WEBF_UPDATE_PROCEDENCIA = New N_IRIS_WEBF_UPDATE_PROCEDENCIA
        numerin = NN.IRIS_WEBF_UPDATE_PROCEDENCIA_2(ID_PROCEDENCIA, PROC_COD, PROC_DES, ID_ESTADO, COD_AVIS)
        If (numerin > 0) Then
            'Serializar con JSON
            Serializer.MaxJsonLength = 999999999
    ...
    Public Shared Function IRIS_WEBF_GRABA_PROCEDENCIA(ByVal PROC_COD As String,
        ...
        'Declaraciones internas
        Dim numerin As Integer = 0
        Dim NN As N_IRIS_WEBF_GRABA_PROCEDENCIA = New N_IRIS_WEBF_GRABA_PROCEDENCIA
        numerin = NN.IRIS_WEBF_GRABA_PROCEDENCIA(PROC_COD, PROC_DES, ID_ESTADO)

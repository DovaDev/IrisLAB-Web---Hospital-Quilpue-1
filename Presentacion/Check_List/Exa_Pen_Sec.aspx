<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Exa_Pen_Sec.aspx.vb" Inherits="Presentacion.Exa_Pen_Sec" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
        ...
        var Mx_Exam = [
    {
        ...
        function Ajax_Exam() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Exa_Pen_Sec.aspx/Llenar_Ddl_Exam",
                //"data": Data_Par,
        ...
        var Mx_Dtt_Det_Ate = [
  {
      ...
      "ENCRYPTED_ID": 0
        ...
        function Ajax_DataTable_Det_Ate(ID_ATE,yyyy) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Exa_Pen_Sec.aspx/Llenar_DataTable_Det_Ate",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
    ...
    <script>
        ...
        function Fill_Ddl_Exam() {
            ...
            for (y = 0; y < Mx_Exam.length; ++y) {
                $("<option>", {
                    "value": Mx_Exam[y].ID_RLS_LS
                }).text(Mx_Exam[y].RLS_LS_DESC).appendTo("#Ddl_Exam");
            }
        };
                    ...
                    $("<tr>", {
                        ...
                        $("<td>").css("text-align", "center").text(function () {
                            if (Mx_Dtt[i].EST_DESCRIPCION == "ESPERA") {
                                $(this).css("cssText", "background-color:#ffdaaa !important; color:inherit; text-align:center;").text(Mx_Dtt[i].EST_DESCRIPCION);
                            }
                            else {
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
    ...
    <div class="row">
        ...
        <h5 style="text-align: center; padding: 5px;">
            ...
            Búsqueda de Exámenes Pendientes por Sección
        </h5>
    </div>
    <div class="row mb-3" style="margin-left:2px; margin-right: 2px;">
        ...
        <div class="col-md">
            <label for="Ddl_Exam">Secciones:</label>
    ...
    <div class="row" id="Id_Conte">
        <div class="col-md-12" id="Paciente">
            <h5 style="text-align: center; padding: 5px; font-size: 15px;"><i class="fa fa-fw fa-list"></i>Listado de Atenciónes</h5>

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="IN_PAC_MAN_2.aspx.vb" Inherits="Presentacion.IN_PAC_MAN_2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function Ajax_guardar() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_2.aspx/Guardar_TodoByVal",
                "data": Data_Par,
        ...
        var Mx_Dtt_exam02_respaldo = [
  {
      ...
      "CF_DIAS": 0,
        ...
        function Ajax_DataTable_examen02() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_2.aspx/Llenar_tabla_exam2",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable_examen3(cod_fonasa, id, cod, txis) {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_2.aspx/Llenar_tabla_exam",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_2.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Ddl = [
    {
        ...
        function Call_AJAX_Ddl() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_2.aspx/Llenar_Ddl_LugarTM",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_busca_rut() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_2.aspx/Llenar_rut",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DL_SEXO() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_2.aspx/Llenar_DL_SEXO",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DL_NAC() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_2.aspx/Llenar_DL_NAC",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Ciudad() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_2.aspx/IRIS_WEBF_BUSCA_CIUDAD",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Comuna() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_2.aspx/IRIS_WEBF_BUSCA_RELACION_CIU_COMUNA",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_TP_ATE = [
     {
        ...
        function Ajax_DL_TP_ATE() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_2.aspx/Llenar_DL_aTENCIONES",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_Sec = [
    {
        ...
        function Ajax_DL_sec() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_2.aspx/Llenar_DL_Sectores",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_DOC = [
  {
      ...
      "ID_ESTADO": 0
        ...
        function Ajax_DL_DOC() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_2.aspx/Llenar_DL_DOC",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_orden_ate = [
 {
     ...
     "ID_ESTADO": 0
        ...
        function Ajax_DL_orden_ate() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_2.aspx/Llenar_DL_ordenATE",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Diagnostico() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_2.aspx/IRIS_WEBF_BUSCA_DIAGNOSTICO",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {

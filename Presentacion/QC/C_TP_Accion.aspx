<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="C_TP_Accion.aspx.vb" Inherits="Presentacion.C_TP_Accion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
    ...
    <script>
        let _Cod, _Desc, _Estado, _Id_TP_Accion;
        $(document).ready(() => {
        ...
        function Ajax_Codiguin(ID_TP_QC_ACCION,
            TP_QC_COD,
            TP_QC_DESC,
            ID_ESTADO) {

            _Id_TP_Accion = ID_TP_QC_ACCION;
            $("#txt_Cod").val(TP_QC_COD);
            $("#txt_Desc").val(TP_QC_DESC);
        ...
        function Ajax_Guardar() {
            ...
            $.ajax({
                "type": "POST",
                "url": "C_TP_Accion.aspx/IRIS_GRABA_QC_TP_ACCION",
                "data": Data_Par,
        ...
        function Ajax_Update() {
            ...
            $.ajax({
                "type": "POST",
                "url": "C_TP_Accion.aspx/IRIS_UPDATE_QC_TP_ACCION",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Tabla() {
            ...
            $.ajax({
                "type": "POST",
                "url": "C_TP_Accion.aspx/IRIS_QC_BUSCA_TP_ACCION",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Fill_DataTable() {
            ...
            for (i = 0; i < Mx_Dtt.length; i++) {
                $("#DataTable tbody").append(
                    $("<tr>", {
                        "onclick": `Ajax_Codiguin("` + Mx_Dtt[i].ID_TP_QC_ACCION + `","` + Mx_Dtt[i].TP_QC_COD + `","` + Mx_Dtt[i].TP_QC_DESC + `","` + Mx_Dtt[i].ID_ESTADO + `")`,
                        "class": "manito"
                    }).append(
                        $("<td>", { "align": "left" }, { "class": "textoReducido" }).text(i + 1),
                        $("<td>", { "align": "left" }, { "class": "textoReducido" }).text(Mx_Dtt[i].TP_QC_COD),
                        $("<td>", { "align": "left" }, { "class": "textoReducido" }).text(Mx_Dtt[i].TP_QC_DESC),
    ...
    <div class="card border-bar">
        <div class="card-header bg-bar text-center">
            <h3 class="m-0">Antecedentes de Tipo de Acción
            </h3>
        </div>
        <div class="card-body">
            <div class="row">
    ...
    <div class="row mb-3" id="Id_Conte">
        <div class="col-md-12">
            <h4 style="text-align: center; padding: 5px;">Lista de Tipo de Acciones</h4>

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="AVIS_C_D_VER.aspx.vb" Inherits="Presentacion.AVIS_C_D_VER" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#TXT_NOMBRE").click(function () {
                $("#AVIS").val("");
                $("#RUT").val("");
            });
            $("#TXT_APELLIDO").click(function () {
                $("#AVIS").val("");
                $("#RUT").val("");
            });
            $("#TXT_APELLIDO_MATERNO").click(function () {
                $("#AVIS").val("");
                $("#RUT").val("");
            });
    ...
    <script>
        ...
        function Ajax_N_PACIENTE() {
            ...
            var Data_Par_tabla = JSON.stringify({
                ...
                "APELLIDO_MAT": $("#TXT_APELLIDO_MATERNO").val()
            });
            var ajax_tabla = $.ajax({
                "type": "POST",
                "url": "AVIS_C_D_VER.aspx/Llenar_AVIS",
                "data": Data_Par_tabla,
    ...
    <script>
        function Ajax_Exa_no_dis(id_01) {
            ...
            var ajax_tabla = $.ajax({
                "type": "POST",
                "url": "AVIS_C_D_VER.aspx/Ajax_Exa_dis",
                "data": Data_Par_tabla,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Exa_dis(id_02) {
            ...
            var ajax_tabla = $.ajax({
                "type": "POST",
                "url": "AVIS_C_D_VER.aspx/Ajax_Exa_no_dis",
                "data": Data_Par_tabla,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Fill_DataTable2() {
            ...
            $("#DataTable_pac thead").append(
                $("<tr>").append(
                    ...
                    $("<th>", { "class": "textoReducido text-center" }).text("Nom. Paciente"),
                    $("<th>", { "class": "textoReducido text-center" }).text("Desc. Examen"),
                    $("<th>", { "class": "textoReducido text-center" }).text("Prestador"),
                ...
                $("#DataTable_pac tbody").append(
                    $("<tr>", {
                        ...
                        $("<td>", {
                            "align": "center",
                            "class": "textoReducido"
                        }).text(Mx_Dtt2[i].HO_Nombres + " " + Mx_Dtt2[i].HO_ApellidoPaterno + " " + Mx_Dtt2[i].HO_ApellidoMaterno),
                        $("<td>", {
                            "align": "center",
                            "class": "textoReducido",
                            "data-ayy": true
                        ...
                        $("<td>", {
                            ...
                            "class": "textoReducido",
                            "data-ayy": true
                        }).text(Mx_Dtt2[i].HO_NombreMedico),
                        $("<td>", {
                            "align": "center",
                            "class": "textoReducido",
                            "data-ayy": true
                        }).text(Mx_Dtt2[i].IRIS_H_FECHA),
                        $("<td>", {
        ...
        function Ajax_modal_exa(preingreso_paciente, atencion_paciente, ATE_NUM_ATENCION_MODAL) {
            ...
            if ((preingreso_paciente == 0 || preingreso_paciente == "null" || preingreso_paciente == null) && atencion_paciente == 0) {
                ...
                $.ajax({
                    "type": "POST",
                    "url": "AVIS_C_D_VER.aspx/MODAL_PAC",
                    "data": Data_Par_modal,
                    "contentType": "application/json;  charset=utf-8",
                    "dataType": "json",
                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-lg">
                            ...
                            <input type='text' id="TXT_APELLIDO" class="form-control" placeholder="" />
                        </div>
                        <div class="col-lg">
                            <label class="">Apellido Materno:</label>
                            <input type='text' id="TXT_APELLIDO_MATERNO" class="form-control" placeholder="" />
                        </div>

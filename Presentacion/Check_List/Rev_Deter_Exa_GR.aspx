<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Rev_Deter_Exa_GR.aspx.vb" Inherits="Presentacion.Rev_Deter_Exa_GR" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
        ...
        var Mx_Exam = [
    {
        ...
        function Ajax_Exam() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_GR.aspx/Llenar_Ddl_Exam",
                //"data": Data_Par,
        ...
        function Call_AJAX_Ddl() {
            AJAX_Ddl = $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_GR.aspx/Llenar_Ddl_LugarTM",
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": data => {
                    Mx_Ddl = data.d;
        ...
        var Mx_Dtt_Det = [
    {
        ...
        function Ajax_Det() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_GR.aspx/Llenar_Ddl_Det",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_GR.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_Det_Ate = [
  {
      ...
      "ENCRYPTED_ID": 0
        ...
        function Ajax_DataTable_Det_Ate(ID_ATE) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_GR.aspx/Llenar_DataTable_Det_Ate",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_Excel = [
    {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_GR.aspx/Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
                        ...
                        $("#DataTable tbody").append(
                            $("<tr>", {
                                ...
                                $("<td>").css("text-align", "").text(function () {
                                    if (Mx_Dtt[i].NEW_VIH == "Seleccione" || Mx_Dtt[i].NEW_VIH == "" || Mx_Dtt[i].NEW_VIH == 0 || Mx_Dtt[i].NEW_VIH == "0") {
                                        return "-";
                                    } else {
                                ...
                                $("<td>").css("text-align", "").text(function () {
                                    if (Mx_Dtt[i].ATE_SUR_VIH == 0 || Mx_Dtt[i].ATE_SUR_VIH == "" || Mx_Dtt[i].ATE_SUR_VIH == "0") {
                                        return "-";
                                    } else if (Mx_Dtt[i].ATE_SUR_VIH == 1) {
                                        return "GESTANTES PRIMER TRIMESTRE EMBARAZO";
                                    }
                                    else if (Mx_Dtt[i].ATE_SUR_VIH == 2) {
                                        return "GESTANTES SEGUNDO TRIMESTRE EMBARAZO";
                                    }
                                    else if (Mx_Dtt[i].ATE_SUR_VIH == 3) {
                                        return "GESTANTES TERCER TRIMESTRE EMBARAZO";
                                    }
                                    else if (Mx_Dtt[i].ATE_SUR_VIH == 4) {
                                        return "GESTANTES TRIMESTRE EMBARAZO IGNORADO";
                                    }
                                    else if (Mx_Dtt[i].ATE_SUR_VIH == 5) {
                                        return "GESTANTES EN SEGUIMIENTO POR DIAGNÓSTICO SÍFILIS";
                                    }
                                    else if (Mx_Dtt[i].ATE_SUR_VIH == 6) {
                                        return "PAREJA DE GESTANTE CON SEROLOGÍA REACTIVA";
                                    }
                                    else if (Mx_Dtt[i].ATE_SUR_VIH == 7) {
                                        return "MUJERES QUE INGRESAN A MATERNIDAD POR PARTO";
                                    }
                                    else if (Mx_Dtt[i].ATE_SUR_VIH == 8) {
                                        return "MUJERES QUE INGRESAN POR ABORTO";
                                    }
                                    else if (Mx_Dtt[i].ATE_SUR_VIH == 9) {
                                        return "MUJERES EN CONTROL GINECOLÓGICO";
                                    }
                                    else if (Mx_Dtt[i].ATE_SUR_VIH == 10) {
                                        return "RECIÉN NACIDO Y LACTANTE PARA DETECCIÓN DE SÍFILIS CONGÉNITA";
                                    }
                                    else if (Mx_Dtt[i].ATE_SUR_VIH == 11) {
                                        return "PERSONAS EN CONTROL POR COMERCIO SEXUAL";
                                    }
                                    else if (Mx_Dtt[i].ATE_SUR_VIH == 12) {
                                        return "PERSONAS EN CONTROL FECUNDIDAD";
                                    }
                                    else if (Mx_Dtt[i].ATE_SUR_VIH == 13) {
                                        return "CONSULTANTES POR ITS";
                                    }
                                    else if (Mx_Dtt[i].ATE_SUR_VIH == 14) {
                                        return "PERSONAS CON EMP";
                                    }
                                    else if (Mx_Dtt[i].ATE_SUR_VIH == 15) {
                                        return "DONANTES DE SANGRE";
                                    }
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
    ...
    <div class="row">
        ...
        <h5 style="text-align: center; padding: 5px;">
            ...
            Listado de exámenes con Resultados VIH - Sífilis
        </h5>
    </div>

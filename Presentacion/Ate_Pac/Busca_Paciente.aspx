<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Busca_Paciente.aspx.vb" Inherits="Presentacion.Busca_Paciente" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Busca_Paciente.aspx/Llenar_DataTable",
                "data": Data_Par,
        ...
        function Ajax_DataTable_Ate_ONCLICK(ID_PAC) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Busca_Paciente.aspx/Llenar_DataTable_Ate_ONCLICK",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable_Ate() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Busca_Paciente.aspx/Llenar_DataTable_Ate",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_Det_Ate = [
  {
      ...
      "ENCRYPTED_ID": 0
        ...
        function Ajax_DataTable_Det_Ate(ID_ATE) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Busca_Paciente.aspx/Llenar_DataTable_Det_Ate",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
                ...
                <div class="card-body">
                    ...
                    <div id="Id_Conte">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <h5 style="text-align: center; padding: 5px; font-size: 15px;"><i class="fa fa-fw fa-list mr-2"></i>Listado de Atenciones</h5>

...
Public Class D_IRIS_WEBF_GRABA_TRX_BONOS
    ...
    Function IRIS_WEBF_GRABA_TRX_BONOS(ByVal ID_FP As Integer, ByVal MONTO As Integer, ByVal ID_USU As Integer) As Integer
        ...
        With Cmd_SQL
            ...
            .CommandText = "IRIS_WEBF_GRABA_TRX_BONOS"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Enviar parámetros
        With Cmd_SQL.Parameters
            .Add("@ID_FP", OleDbType.Numeric).Value = ID_FP
            .Add("@MONTO", OleDbType.Numeric).Value = MONTO
    ...
    Function IRIS_WEBF_GRABA_TRX_EFECTIVO(ByVal ID_FP As Integer, ByVal MONTO As Integer, ByVal ID_USU As Integer) As Integer
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_GRABA_TRX_EFECTIVO"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Enviar parámetros
        With Cmd_SQL.Parameters

...
Public Class D_IRIS_WEBF_UPDATE_ORDEN_ATENCION
    'Declaraciones Generales
    Dim CC_ConnBD As Conexion.ConexionBD
    Dim DD_GEN As New D_General_Functions
    Function IRIS_WEBF_UPDATE_ORDEN_ATENCION(ByVal ID_ORD As Integer,
        ...
        With Cmd_SQL
            ...
            .CommandText = "IRIS_WEBF_UPDATE_ORDEN_ATENCION"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Enviar parámetros
        With Cmd_SQL.Parameters
            .Add("@ID_ORD", OleDbType.Numeric).Value = ID_ORD

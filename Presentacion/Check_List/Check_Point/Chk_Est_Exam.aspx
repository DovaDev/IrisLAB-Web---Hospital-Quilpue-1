<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Chk_Est_Exam.aspx.vb" Inherits="Presentacion.Chk_Est_Exam" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
        ...
        var Mx_Dtt_LugarTM = [
    {
        ...
        function Ajax_LugarTM() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Chk_Est_Exam.aspx/Llenar_Ddl_LugarTM",
                //"data": Data_Par,
        ...
        var Mx_Exam = [
    {
        ...
        function Ajax_DataTable() {
            ...
            var Data_Par = JSON.stringify({
                ...
                "ID_RECHA": $("#Ddl_Rechaza").val(),
            });
            $(".block_wait").fadeIn(500);
            $.ajax({
                "type": "POST",
                "url": "Chk_Est_Exam.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable_por_rut() {
            modal_show();
            ...
            $.ajax({
                "type": "POST",
                "url": "Chk_Est_Exam.aspx/Llenar_DataTable_por_rut",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_Det_Ate = [
  {
      ...
      "ENCRYPTED_ID": 0
        ...
        function Ajax_DataTable_Det_Ate(ID_ATE, yyy) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Chk_Est_Exam.aspx/Llenar_DataTable_Det_Ate",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_Excel = [
    {
        ...
        function Ajax_Excel_Rut() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Chk_Est_Exam.aspx/Excel_Rut",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
                    ...
                    $("<tr>", {
                        ...
                        $("<td>").css("text-align", "center").text(function () {
                            if (i > 0) {
                                if (Mx_Dtt[i - 1].ATE_NUM == Mx_Dtt[i].ATE_NUM) {
                                    ...
                                    if (Mx_Dtt[i].PAC_RUT == "") {
                                        $(this).css("cssText", "text-align:center;").text(Mx_Dtt[i].DNI);
                                    } else {
                        ...
                        $("<td>").text(function () {
                            if (i > 0) {
                                if (Mx_Dtt[i - 1].ATE_NUM == Mx_Dtt[i].ATE_NUM) {
                                    ...
                                    $(this).text(Mx_Dtt[i].FECHA_NAC);
                                }

                            } else {
                                $(this).text(Mx_Dtt[i].EE_FECHA_NAC);
                            }
                        }),
                        $("<td>").text(function () {
                            if (i > 0) {
                                if (Mx_Dtt[i - 1].ATE_NUM == Mx_Dtt[i].ATE_NUM) {
                                    ...
                                    $(this).text(Mx_Dtt[i].NACIONALIDAD);
                                }
                                                   ...
                                                   $("<td>").text(function () {
                                                       if (i > 0) {
                                                           if (Mx_Dtt[i - 1].ATE_NUM == Mx_Dtt[i].ATE_NUM) {
                                                               ...
                                                               $(this).text(Mx_Dtt[i].NUMERO_INTERNO);
                                                           }
                                                       } else {
                                                           $(this).text(Mx_Dtt[i].NUMERO_INTERNO);
                                                       }
                        ...
                        $("<td>").text(function () {
                            if (i > 0) {
                                if (Mx_Dtt[i - 1].ATE_NUM == Mx_Dtt[i].ATE_NUM) {
                                    ...
                                    $(this).text(Mx_Dtt[i].MEDICO_SOLICITANTE + " " + Mx_Dtt[i].MEDICO_SOLICITANTE_2);
                                }
                            } else {
                                $(this).text(Mx_Dtt[i].MEDICO_SOLICITANTE + " " + Mx_Dtt[i].MEDICO_SOLICITANTE_2);
                            }
                        ...
                        $("<td>").css("text-align", "center").text(function () {
                            if (Mx_Dtt[i].ATE_EST_RECEP == "9") {
                                $(this).css("cssText", "text-align:center; background-color:#9bffb1 !important;").text("SI");           //RECEPCIONADO
                            }
                            else {
                        ...
                        $("<td>").css("text-align", "center").text(function () {
                            if ((Mx_Dtt[i].Expr1 == "VALIDADO") || (Mx_Dtt[i].Expr1 == "IMPRESO")) {
                                $(this).css("cssText", "background-color:#9bffb1 !important; cursor:pointer; text-align:center;").text("SI");       //VALIDADO
                            }
                            else {
                                $(this).css("cssText", "background-color:#ffdaaa color:inherit; text-align:center;").text("NO");                    
                            }
                        }),
                        $("<td>").css("text-align", "center").text(function () {
                            if (Mx_Dtt[i].ATE_EST_RECHAZO == "7") {
                                ...
                                $(this).css("cssText", "text-align:center; background-color:#9bffb1 !important;").text("SI");                      //RECHAZADO
                            }
                        })
                    )
                );
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
    ...
    <div class="row mb-3" style="margin-left:2px; margin-right: 2px;">
        ...
        <div class="col-md">
            ...
            <input id="txt_Rut" class="form-control"/>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <button id="Btn_Rut" class="btn btn-info btn-block" style="margin-bottom: 1vh; padding: 2px;" type="submit"><i class="fa fa-fw fa-search mr-2"></i>Por Rut</button>
        </div>
                <div class="col-md-2">
            <button id="Btn_Excel_Rut" class="btn btn-info btn-block" style="margin-bottom: 1vh; padding: 2px;" type="submit"><i class="fa fa-fw fa-file-excel-o mr-2"></i>Excel Rut</button>
        </div>
    </div>

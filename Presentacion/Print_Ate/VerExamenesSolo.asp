...
<%
 ...
 '	set rst_BM3 = connBM3.execute("IRISLABWEB_GRABA_IMPRESION_FOLIO '"&Id_atencion_&"', '"& ID_USUARIO_WEB &"'  ")	
	...
	WEND
 	...
 	set rst_BM3 = connBM3.execute("IRISLABWEB_BUSCA_LISTADO_DE_EXAMENES_CODIGO_FONASA2_ANT '"&Id_atencion_&"', '"& ID_PERFIL_NUEVO_REAL &"' ")	
...
IF  w_USUARIO_2 = "RLEAL" THEN
	...
	w_USUARIO_2 = "/FIRMAS/" & w_USUARIO_2 & ".BMP"
END IF
END IF
END IF
END IF
...
'	Set Image = Doc.OpenImage(Server.MapPath("" & w_USUARIO_2) )
	Set Param = Pdf.CreateParam
	Param("x") = 450	
	Param("y") = 35
	Param("ScaleX") = (0.43)

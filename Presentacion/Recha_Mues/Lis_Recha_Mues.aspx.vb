...
Public Class Lis_Recha_Mues
    ...
    End Function
    <Services.WebMethod()>
    Public Shared Function Llenar_DataTable(ByVal DESDE As String, ByVal HASTA As String, ByVal ID_PRE As Integer) As String
        'Declaraciones del Serializador
        Dim Serializer As New JavaScriptSerializer
        Dim str_Builder As New StringBuilder
        ...
        If data_fechas.Count > 0 Then
            For i = 0 To data_fechas.Count - 1
                data_lote = NN_Lote.IRIS_WEBF_BUSCA_LOTE_RECEPCIONADO_LOTE_2_RECHAZO_NUEVO_1_2(data_fechas(i).LOTE_RECHAZO_NUM, 0, ID_PRE)
    ...
    End Function
    <Services.WebMethod()>
    Public Shared Function Excel(ByVal DOMAIN_URL As String, ByVal DESDE As String, ByVal HASTA As String) As String
        'Declaraciones del Serializador
        'Dim Serializer As New JavaScriptSerializer
        Dim str_Builder As New StringBuilder
        Dim datas As String = ""
        ...
        If data_fechas.Count > 0 Then
            For i = 0 To data_fechas.Count - 1
                data_lote = NN_Lote.IRIS_WEBF_BUSCA_LOTE_RECEPCIONADO_LOTE_2_RECHAZO_NUEVO_1(data_fechas(i).LOTE_RECHAZO_NUM, 0)
        ...
        If (data_det_ate.Count > 0) Then
            ...
            Dim Mx_Datax(24, 0) As Object
            'Llenar Matriz
            For y = 0 To (data_det_ate.Count - 1)

                If (y > 0) Then
                    ReDim Preserve Mx_Data(24, y)
                End If
                ...
                Mx_Data(24, y) = data_det_ate(y).PROC_DESC
            Next y
        Else
            Return "null"
        End If
        ...
        sl.SetCellValue("Y8", "Procedencia")
        ...
        'insertar tabla
        tabla = sl.CreateTable("A8", CStr("y" & ltabla + 1))

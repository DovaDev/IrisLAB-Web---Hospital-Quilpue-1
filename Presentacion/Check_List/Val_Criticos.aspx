<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Val_Criticos.aspx.vb" Inherits="Presentacion.Val_Criticos" %>
        ...
        var Mx_Exam = [
    {
        ...
        function Call_Data_Table() {
            ...
            AJAX_Data_Table = $.ajax({
                "type": "POST",
                "url": "Val_Criticos.aspx/Call_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Call_Export() {
            ...
            AJAX_Data_Table = $.ajax({
                "type": "POST",
                "url": "Val_Criticos.aspx/Call_Export",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master_Solicitud.Master" CodeBehind="Reg_Solicitud.aspx.vb" Inherits="Presentacion.Reg_Solicitud" %>
    ...
    <script>
        ...
        function IRIS_WEBF_GRABA_REG_SOLICITUD() {
            ...
            var Data_Par = JSON.stringify({
                ...
                "MOTIVO": $("#Ddl_Motivo option:selected").text(),
    ...
    <div class="container mt-3">
        <div class="card border-bar">
            <div class="card-header bg-bar text-center">
                <h4><i class="fa fa-plane fa-fw"></i>FORMULARIO DE SOLICITUD, CONSULTAS Y/O RECLAMOS </h4>
                <h5>LABORATORIO CLÍNICO CMVM </h5>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-4">
                        <label for="Ddl_LugarTM">Consultorio en que se atiende:(*)</label>
                        <select id="Ddl_LugarTM" class="form-control">
                            <option value="0">Seleccionar</option>
                        </select>
                    </div>
                    <div class="col-lg-4">
                        <label for="Ddl_Motivo">Motivo del requerimiento:(*)</label>
                    ...
                    <div class="col-lg-4">
                        <label for="fecha">Fecha en que se motivó requerimiento:(*)</label>
                ...
                <div class="row">
                    <div class="col-lg">
                        <label style="text-align:center">Su requerimiento será revisado por el laboratorio Clínico CMVM, y se remitirá la respuesta a su correo electrónico.</label>
                    </div>
                </div>
                <div class="row mt-3">

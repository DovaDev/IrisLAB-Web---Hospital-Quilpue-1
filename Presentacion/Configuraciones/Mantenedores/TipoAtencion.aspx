<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="TipoAtencion.aspx.vb" Inherits="Presentacion.TipoAtencion" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
        ...
        var Mx_Dtt = [
    {
        ...
        function Ajax_Tabla() {
            ...
            $.ajax({
                "type": "POST",
                "url": "TipoAtencion.aspx/IRIS_WEBF_BUSCA_PROGRAMA",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Update() {
            ...
            $.ajax({
                "type": "POST",
                "url": "TipoAtencion.aspx/IRIS_WEBF_UPDATE_BANCOS",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Guardar() {
            ...
            $.ajax({
                "type": "POST",
                "url": "TipoAtencion.aspx/IRIS_WEBF_GRABA_BANCO",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
    ...
    <div class="row">
        <div class="col-lg">
            ...
            <div class="row mb-3" style="margin-left: 0px;margin-right: 0px;margin-top: 15px;">
                <div class="col-md-4">
            ...
            <div class="row mb-3" id="Id_Conte">
                <div class="col-md-12" id="Paciente">
                    <h5 style="text-align: center; padding: 5px; font-size: 15px;"><i class="fa fa-list"></i> Lista de Tipo de Atenciónes
                    </h5>

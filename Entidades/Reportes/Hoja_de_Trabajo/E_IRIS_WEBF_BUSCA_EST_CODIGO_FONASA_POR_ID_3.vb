Public Class E_IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_POR_ID_3
    ...
    Dim EE_ATE_NUMERO_INTERNO As String
    ...
    Public Property DOC_NOMBRE() As String
        ...
        End Set
    End Property
    Public Property ATE_NUMERO_INTERNO() As String
        Get
            Return EE_ATE_NUMERO_INTERNO
        End Get
        Set(ByVal value As String)
            EE_ATE_NUMERO_INTERNO = value
        End Set
    End Property

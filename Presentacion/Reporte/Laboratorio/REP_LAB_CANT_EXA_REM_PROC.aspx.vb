...
Public Class REP_LAB_CANT_EXA_REM_PROC
...
#Region "HELPER"
    ...
    Public Shared Function Setear_Cero(ByRef result As List(Of E_IRIS_WEBF_BUSCA_CANT_EXAMENES), ByVal list_codigos As List(Of Integer))

        For Each item In result.Where(Function(items) list_codigos.Contains(items.ID_CODIGO_FONASA)).ToList()
            item.CANTIDAD = 0
            ' ATENCION ABIERTA
            item.CAE = 0
            item.USM_HDIURNO = 0
    ...
    Public Shared Function Contar_Por_Codigo(ByVal list_det_ate As List(Of E_IRIS_WEBF_BUSCA_DET_ATENCION_POR_FECHA), ByVal COD_A As String, ByVal COD_B As String) As IEnumerable(Of Object)
        Dim atenciones = From dato In list_det_ate
                         ...
                         Where Conteo_Examen > 0 ' Filtra solo las procedencias con al menos un resultado
                         Select New With {

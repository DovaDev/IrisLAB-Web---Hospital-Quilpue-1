...
Public Class D_IRIS_WEBF_CMVM_BUSCA_ATE_PAC_DIA
    ...
    Function IRIS_WEBF_CMVM_BUSCA_ATE_PAC_DIA(ByVal DESDE As String, ByVal HASTA As String, ByVal USUARIO As Long) As List(Of E_IRIS_WEBF_CMVM_BUSCA_ATE_PAC_DIA)
        ...
        Dim Obj_Read_Dt As E_IRIS_WEBF_CMVM_BUSCA_ATE_PAC_DIA
        Dim List_Reader As New List(Of E_IRIS_WEBF_CMVM_BUSCA_ATE_PAC_DIA)
        Dim Reader_Comm As OleDbDataReader
        Dim DD_GEN As New D_General_Functions
        'definiendo tipo de consulta a la BD
        Cmd_command.CommandType = CommandType.StoredProcedure
        Cmd_command.CommandText = "IRIS_WEBF_CMVM_BUSCA_ATE_PAC_DIA"
        ...
        While Reader_Comm.Read
            Obj_Read_Dt = New E_IRIS_WEBF_CMVM_BUSCA_ATE_PAC_DIA

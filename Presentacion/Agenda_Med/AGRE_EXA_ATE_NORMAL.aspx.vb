...
Public Class AGRE_EXA_ATE_NORMAL
    ...
    Public Shared Function Llenar_DL_prevision() As String
        ...
        data_paciente = NN.IRIS_WEBF_CMVM_BUSCA_PREVISION_ACTIVO_TODO_Y_PARTICULAR()
    ...
    Public Shared Function Llenar_tabla_exam2(ByVal ID_PREVE As Integer, ByVal Fecha As String) As String
        ...
        Dim ANO As Date
        ANO = CDate(Fecha)
        data_paciente = NN.IRIS_WEBF_CMVM_BUSCA_CODIGO_FONASA_PARA_CARGA_ATENCION_BONIFICACION_CF_PART_TIPO(Format(ANO, "yyyy"), ID_PREVE)
        If (data_paciente.Count > 0) Then
            'Serializar con JSON
            Serializer.MaxJsonLength = 999999999
            Serializer.Serialize(data_paciente, str_Builder)
    ...
    Public Shared Function Llenar_tabla_exam2_particular(ByVal ID_PREVE As Integer, ByVal Fecha As String) As String
        ...
        data_particular = NN_particular.IRIS_WEBF_CMVM_BUSCA_CODIGO_FONASA_PARA_CARGA_ATENCION_PARTICULAR_BONIFICACION_CF_PART_CF(Format(ANO, "yyyy"), ID_PREVE)
    ...
    <Services.WebMethod()>
    Public Shared Function Elimina_Examen_Con_Log(ByVal ID_ATENCION As Integer, ID_CODIGO_FONASA As Integer, ID_USUARIO As Integer) As String
        Return D_IRIS_WEBF_GRABA_ATENCION_PROGRA2_PRO_SECTOR_AVIS.IRIS_WEBF_ELIMINA_EXAMEN_ATE_RESULTADO_UPDATE_VALOR_ATE_GRABA_HISTORIAL_CAMBIO(ID_ATENCION, ID_CODIGO_FONASA, ID_USUARIO)
    End Function
    ...
    Public Shared Function Guardar_TodoByVal(ByVal ids As List(Of ids5555_CC),
        ...
        Dim ORIGEN As String = "AGRE_EXA_ATE_CJ - AGREGA EXAMEN"
        If (reset_copago <> 0) Then
            '--------------------------- DUAL COPAGO ---------------------------
            If (data_rel_copago_old.Count > 0) Then
                dual_copago = ddx.IRIS_WEBF_CMVM_GRABA_REL_COPAGO_2(ID_ATENCION,
        ...
        For i = 0 To ids.Count - 1
            ...
            id = jj.IRIS_WEBF_CMVM_GRABA_DETALLE_ATENCION_INTERFAZ_OMI_3_NEW_AGREGA_EXAM(ID_ATENCION,
                                                                                         ...
                                                                                         ids(i).id_CF,
                                                                                         ids(i).id_PER,
                                                                                         If(data_money_old(0).ID_PREVE = 332, 19, If(ids(i).ATE_DET_TP_1 = 0, 1, ids(i).ATE_DET_TP_1)),
                                                                                         ids(i).ATE_DET_NUM_BONO,
                                                                                         ids(i).Valor,
                                                                                         (ids(i).Valor - ids(i).ATE_DET_VALOR_BENEF - ids(i).ATE_DET_VALOR_CS),
                                                                                         valor_copago_det,
                                                                                         ids(i).HO_CC,

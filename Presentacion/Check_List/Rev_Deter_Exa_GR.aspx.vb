...
Public Class Rev_Deter_Exa_GR
    ...
    Public Shared Function Llenar_DataTable(ByVal DESDE As String, ByVal HASTA As String,
                                         ...
                                         ByVal ID_EST As Integer,
                                            ByVal LUGARTM As Integer) As String
        'Declaraciones del Serializador
        Dim Serializer As New JavaScriptSerializer
        Dim str_Builder As New StringBuilder
        'Declaraciones internas
        ...
        Data = NN.IRIS_BUSCA_EXAMEN_DET_ESTADISTICA_CHECK_TODOS_2_GR(CDate(DESDE), CDate(HASTA), ID_CF, ID_EST, LUGARTM)
    ...
    Public Shared Function Excel(ByVal DOMAIN_URL As String, ByVal DESDE As String, ByVal HASTA As String,
        ...
        If (Data.Count > 0) Then
            ...
            For y = 0 To (Data.Count - 1)
                ...
                Mx_Data(9, y) = Data(y).PAC_RUT

                If (Data(y).ATE_DNI <> "") Then
                    Mx_Data(10, y) = Data(y).ATE_DNI
                Else
                    Mx_Data(10, y) = ""
                End If

                If (Data(y).NAC_DESC <> "") Then
                    Mx_Data(11, y) = Data(y).NAC_DESC
                Else
                    Mx_Data(11, y) = ""
                End If
                ...
                Mx_Data(12, y) = Data(y).PRU_DESC

                If Data(y).NEW_VIH = "Seleccione" Or Data(y).NEW_VIH = "" Or Data(y).NEW_VIH = "0" Then
                    Mx_Data(13, y) = "-"
                Else
                    Mx_Data(13, y) = Data(y).NEW_VIH
                End If

                If (Data(y).ATE_SUR_VIH = "0" Or Data(y).ATE_SUR_VIH = "") Then
                    Mx_Data(14, y) = "-"
                ElseIf Data(y).ATE_SUR_VIH = 1 Then
                    Mx_Data(14, y) = "GESTANTES PRIMER TRIMESTRE EMBARAZO"
                ElseIf Data(y).ATE_SUR_VIH = 2 Then
                    Mx_Data(14, y) = "GESTANTES SEGUNDO TRIMESTRE EMBARAZO"
                ElseIf Data(y).ATE_SUR_VIH = 3 Then
                    Mx_Data(14, y) = "GESTANTES TERCER TRIMESTRE EMBARAZO"
                ElseIf Data(y).ATE_SUR_VIH = 4 Then
                    Mx_Data(14, y) = "GESTANTES TRIMESTRE EMBARAZO IGNORADO"
                ElseIf Data(y).ATE_SUR_VIH = 5 Then
                    Mx_Data(14, y) = "GESTANTES EN SEGUIMIENTO POR DIAGNÓSTICO SÍFILIS"
                ElseIf Data(y).ATE_SUR_VIH = 6 Then
                    Mx_Data(14, y) = "PAREJA DE GESTANTE CON SEROLOGÍA REACTIVA"
                ElseIf Data(y).ATE_SUR_VIH = 7 Then
                    Mx_Data(14, y) = "MUJERES QUE INGRESAN A MATERNIDAD POR PARTO"
                ElseIf Data(y).ATE_SUR_VIH = 8 Then
                    Mx_Data(14, y) = "MUJERES QUE INGRESAN POR ABORTO"
                ElseIf Data(y).ATE_SUR_VIH = 9 Then
                    Mx_Data(14, y) = "MUJERES EN CONTROL GINECOLÓGICO"
                ElseIf Data(y).ATE_SUR_VIH = 10 Then
                    Mx_Data(14, y) = "RECIÉN NACIDO Y LACTANTE PARA DETECCIÓN DE SÍFILIS CONGÉNITA"
                ElseIf Data(y).ATE_SUR_VIH = 11 Then
                    Mx_Data(14, y) = "PERSONAS EN CONTROL POR COMERCIO SEXUAL"
                ElseIf Data(y).ATE_SUR_VIH = 12 Then
                    Mx_Data(14, y) = "PERSONAS EN CONTROL FECUNDIDAD"
                ElseIf Data(y).ATE_SUR_VIH = 13 Then
                    Mx_Data(14, y) = "CONSULTANTES POR ITS"
                ElseIf Data(y).ATE_SUR_VIH = 14 Then
                    Mx_Data(14, y) = "PERSONAS CON EMP"
                ElseIf Data(y).ATE_SUR_VIH = 15 Then
                    Mx_Data(14, y) = "DONANTES DE SANGRE"
                ElseIf Data(y).ATE_SUR_VIH = 16 Then
                    Mx_Data(14, y) = "DONANTES DE ÓRGANOS Y/O TEJIDOS"
                ElseIf Data(y).ATE_SUR_VIH = 17 Then
                    Mx_Data(14, y) = "PACIENTES EN DIÁLISIS"
                ElseIf Data(y).ATE_SUR_VIH = 18 Then
                    Mx_Data(14, y) = "VÍCTIMA DE VIOLENCIA SEXUAL"
                End If
                ...
                If (Data(y).DOC_NOMBRE = "") Then
                    Mx_Data(17, y) = "SIN MÉDICO"
                Else
                    Mx_Data(17, y) = Data(y).DOC_NOMBRE & " " & Data(y).DOC_APELLIDO
                End If

                If (Data(y).UM_DESC = "") Then
                    Mx_Data(18, y) = "SIN UNIDAD"
                Else
                        ...
                        If (Data(y).ATE_R_DESDE <> ".") Then
                            If (Data(y).ATE_R_DESDE <> "-") Then
                                ...
                                If (IsNumeric(Data(y).ATE_R_DESDE) = True) Then
                                    ...
                                    Mx_Data(20, y) = NN_Ate.Num_Dec(Data(y).ATE_R_DESDE, Data(y).PRU_DECIMAL)
                                Else
                                    Mx_Data(20, y) = Data(y).ATE_R_DESDE
                                End If
                            Else
                                Mx_Data(20, y) = ""
                            End If
                                    ...
                                    If (Data(y).ATE_RR_DESDE <> ".") Then
                                        If (Data(y).ATE_RR_DESDE <> "-") Then
                                            ...
                                            If (IsNumeric(Data(y).ATE_RR_DESDE) = True) Then
                                                ...
                                                Mx_Data(20, y) = NN_Ate.Num_Dec(Data(y).ATE_RR_DESDE, Data(y).PRU_DECIMAL)
                                            Else
                                                Mx_Data(20, y) = Data(y).ATE_RR_DESDE
                                            End If
                                        Else
                                            Mx_Data(20, y) = ""
                                        End If
                        ...
                        If (Data(y).ATE_R_HASTA <> ".") Then
                            If (Data(y).ATE_R_HASTA <> "-") Then
                                ...
                                If (IsNumeric(Data(y).ATE_R_HASTA) = True) Then
                                    ...
                                    Mx_Data(21, y) = NN_Ate.Num_Dec(Data(y).ATE_R_HASTA, Data(y).PRU_DECIMAL)
                                Else
                                    Mx_Data(21, y) = Data(y).ATE_R_HASTA
                                End If
                            Else
                                Mx_Data(21, y) = ""
                            End If
                                    ...
                                    If (Data(y).ATE_RR_HASTA <> ".") Then
                                        If (Data(y).ATE_RR_HASTA <> "-") Then
                                            ...
                                            If (IsNumeric(Data(y).ATE_RR_HASTA) = True) Then
                                                ...
                                                Mx_Data(21, y) = NN_Ate.Num_Dec(Data(y).ATE_RR_HASTA, Data(y).PRU_DECIMAL)
                                            Else
                                                Mx_Data(21, y) = Data(y).ATE_RR_HASTA
                                            End If
                                        Else
                                            Mx_Data(21, y) = ""
                                        End If
        ...
        For y = 1 To 22
            sl.SetColumnWidth(y, 21)
        Next y

        'nombrar hoja 
        sl.RenameWorksheet("Sheet1", "Listado de Resultados por Determinaciones VIH - Sífilis")
        'titulo de la tabla
        sl.SetCellValue("B2", "Listado de Resultados por Determinaciones VIH - Sífilis")
        ...
        sl.SetCellValue("J8", "Rut Paciente")
        sl.SetCellValue("K8", "DNI")
        sl.SetCellValue("L8", "Nacionalidad")
        sl.SetCellValue("M8", "Determinación")
        sl.SetCellValue("N8", "Grupos Riesgo VIH")
        sl.SetCellValue("O8", "Grupo Riesgo Sífilis")
        sl.SetCellValue("P8", "T")
        sl.SetCellValue("Q8", "Resultado")
        sl.SetColumnWidth("Q", 60)
        sl.SetCellValue("R8", "Médico")
        sl.SetColumnWidth("R", 40)
        sl.SetCellValue("S8", "Unidad")
        sl.SetCellValue("T8", "E")
        sl.SetCellValue("U8", "Rango Desde")
        sl.SetCellValue("V8", "Rango Hasta")

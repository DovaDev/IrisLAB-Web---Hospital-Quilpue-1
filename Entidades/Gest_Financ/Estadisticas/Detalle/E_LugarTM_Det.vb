Public Class E_IRIS_WEBF_BUSCA_EST_ESTADOS_INFORMAR45_6
    ...
    Dim EE_ATE_DET_V_PREVI As Long
    Dim EE_ATE_MES As Long
    Dim EE_ATE_DIA As Long
    ...
    Public Property ATE_DET_V_PREVI As Long
        ...
        End Set
    End Property
    Public Property ATE_MES As Long
        Get
            Return EE_ATE_MES
        End Get
        Set(value As Long)
        ...
        End Set
    End Property
    Public Property ATE_DIA As Long
        Get
            Return EE_ATE_DIA
        End Get
        Set(value As Long)

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Lis_Env_Mues_Lab.aspx.vb" Inherits="Presentacion.Lis_Env_Mues_Lab" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
        ...
        var Mx_Dtt_LugarTM = [
    {
        ...
        function Ajax_LugarTM() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Lis_Env_Mues_Lab.aspx/Llenar_Ddl_LugarTM",
                //"data": Data_Par,
        ...
        var Mx_Exam = [
    {
        ...
        function Ajax_Exam() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Lis_Env_Mues_Lab.aspx/Llenar_Ddl_Exam",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Lis_Env_Mues_Lab.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_Excel = [
    {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Lis_Env_Mues_Lab.aspx/Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
            ...
            for (i = 0; i < Mx_Dtt.length; i++) {
                ...
                $("#DataTable tbody").append(
                    $("<tr>").append(
                        ...
                        //$("<td>", { "align": "left" }, { "class": "textoReducido" }).text("[" + Mx_Dtt[i].CB_DESC + "]" + " " + Mx_Dtt[i].T_MUESTRA_DESC),
                ...
                //} else if (((xi > 0) && (Mx_Dtt[xi].CB_DESC != Mx_Dtt[xi - 1].CB_DESC))) {
                //$("#DataTable tbody").append(
                //    $("<tr>").append(
                //        $("<td>", { "align": "center" }, { "class": "textoReducido" }).text(i + 1),
                //        $("<td>").css("text-align", "center").text(function () {

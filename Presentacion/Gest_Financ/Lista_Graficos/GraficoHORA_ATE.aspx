<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="GraficoHORA_ATE.aspx.vb" Inherits="Presentacion.GraficoHORA_ATE" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
        ...
        function jsDecimals(e) {
            ...
            if (key != null) {
                ...
                if ((key < 48 || key > 57) && (key < 96 || key > 105)) {
                    //Acá tenemos que reemplazar "Decimals" por "NoDecimals" si queremos que no se permitan decimales
    ...
    <script>
        ...
        function AJAX_JSON_Graph() {
            ...
            $.ajax({
                "type": "POST",
                "url": "GraficoHORA_ATE.aspx/Data_Graph",
                "data": Data_Par,
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "GraficoHORA_ATE.aspx/Gen_Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
    ...
    <script>
        ...
        function Fill_DataTable() {
            ...
            $("#DataTable thead").addClass("tableth").append(
                $("<tr>").append(
            ...
            $("#DataTableTotal tbody").append(
                    $("<tr>").append(
                        $("<td>", { "align": "center" }).text(T_Ate) //cFormat.numToString(, 0, ".", ",")
                       // $("<td>", { "align": "center" }).text(cFormat.numToString(T_Pro, 0, ".", ","))
                    )
                );
            grafico();
        };
...
<asp:Content ID="Content3" ContentPlaceHolderID="Cph_Body" runat="server">
    <div class="card mb-3 border-bar">
        <div class="card-header bg-bar">
            <h5>Visor de Atenciones por Hora</h5>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg">

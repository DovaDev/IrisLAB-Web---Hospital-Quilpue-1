<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Rev_Deter_Exa_2.aspx.vb" Inherits="Presentacion.Rev_Deter_Exa_2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
        ...
        var Mx_Exam = [
    {
        ...
        function Ajax_Exam() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_2.aspx/Llenar_Ddl_Exam",
                //"data": Data_Par,
        ...
        var Mx_Dtt_Det = [
    {
        ...
        function Ajax_Det() {
            ...
            var Data_Par = JSON.stringify({
                "ID_CF": 1, //$("#Ddl_Exam").val()
            });
            $(".block_wait").fadeIn(500);
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_2.aspx/Llenar_Ddl_Det",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_2.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_Det_Ate = [
  {
      ...
      "ENCRYPTED_ID": 0
        ...
        function Ajax_DataTable_Det_Ate(ID_ATE) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_2.aspx/Llenar_DataTable_Det_Ate",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_Excel = [
    {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_2.aspx/Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
            ...
            for (i = 0; i < Mx_Exam.length; i++) {
                ...
                $("#DataTable_Examenes tbody").append(
                    $("<tr>", {
                        ...
                        $("<td>").css("text-align", "center").text(Mx_Exam[i].CF_DESC),
                        $("<td>").css("text-align", "center").text(function () {
                            $(this).html("<div class='checkbox checkbox-success pz' style='margin-top:-10px;'><input type='checkbox' value='" + Mx_Exam[i].ID_CODIGO_FONASA + "' class='manitos2' id='Hasdasd" + i + "'/><label class='manitos2' for='Hasdasd" + i + "'></label></div>")
                        })
                    )
                );
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
    ...
    <div id="mError_AAH" class="modal fade" role="dialog">
        ...
        <div id="Modal_Examenes" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                    <%--<button type="button" class="close" data-dismiss="modal">&times;</button>--%>
                    <h4 class="modal-title">Seleccione Exámenes</h4>
                </div>
                <div class="modal-body">
                    <div>
...
<%--        <div class="col-md">
        ...
        <div class="col-md-2">
            ...
            <br />
            <button id="Btn_Agregar_Exa" class="btn btn-info" type="submit"><i class="fa fa-fw fa-plus-circle"></i> Agregar</button> 
        </div>
    </div>

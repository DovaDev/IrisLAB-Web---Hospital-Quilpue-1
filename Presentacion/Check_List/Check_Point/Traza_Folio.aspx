<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Traza_Folio.aspx.vb" Inherits="Presentacion.Traza_Folio" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function Ajax_DDL_RECHAZOS_ACTIVOS() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Traza_Folio.aspx/DDL_TIPO_RECHAZO_ACTIVOS",
                //"data": Data_Par,
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Traza_Folio.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_Det_Ate = [
  {
      ...
      "ENCRYPTED_ID": 0
        ...
        function Ajax_DataTable_Det_Ate(ID_ATE, yyy) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Traza_Folio.aspx/Llenar_DataTable_Det_Ate",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
            ...
            <div class="card mb-3 border-bar">
                <div class="card-header bg-bar">
                    <h5 style="text-align: center; padding: 5px;">
                        ...
                        Trazabilidad de Muestra por Folio de Atención
                    </h5>
                </div>
                <div class="card-body">

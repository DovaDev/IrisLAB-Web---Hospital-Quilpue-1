<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="C_Lote2.aspx.vb" Inherits="Presentacion.C_Lote2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
    <script>
        ...
        function Ajax_Ordena_Nivel(_DESC) {
            ...
            $.ajax({
                "type": "POST",
                "url": "C_Lote2.aspx/IRIS_QC_BUSCA_NIVEL_POR_LOTE_DESC",
                "data": Data_Par,
        ...
        function Ajax_Busca_Nivel() {
            $.ajax({
                "type": "POST",
                "url": "C_Lote2.aspx/IRIS_QC_BUSCA_NIVEL_ACTIVO",
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Guardar() {
            ...
            $.ajax({
                "type": "POST",
                "url": "C_Lote2.aspx/IRIS_GRABA_QC_LOTE_DE_MUESTRA",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Update() {
            ...
            $.ajax({
                "type": "POST",
                "url": "C_Lote2.aspx/IRIS_UPDATE_QC_LOTE",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Busca_Ana() {
            ...
            $.ajax({
                "type": "POST",
                "url": "C_Lote2.aspx/IRIS_QC_BUSCA_ANALIZADOR_ACTIVO",
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
                    var json_receiver = response.d;
        ...
        function Ajax_Tabla() {
            ...
            $.ajax({
                "type": "POST",
                "url": "C_Lote2.aspx/IRIS_QC_BUSCA_LOTE_ACTIVO_DESACTIVO",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Fill_DataTable() {
            ...
            for (i = 0; i < Mx_Dtt.length; i++) {
                $("#DataTable tbody").append(
                    $("<tr>", {
                        "onclick": `Ajax_Codiguin("` + Mx_Dtt[i].ID_QC_LOTE + `","` + Mx_Dtt[i].QC_LOTE_COD + `","` + Mx_Dtt[i].QC_LOTE_DESC + `","` + Mx_Dtt[i].ID_ESTADO + `","` + Mx_Dtt[i].ID_QC_ANALIZADOR + `","` + Mx_Dtt[i].QC_LOTE_FECHA_EXP + `")`,
                        "class": "manito"
                    }).append(

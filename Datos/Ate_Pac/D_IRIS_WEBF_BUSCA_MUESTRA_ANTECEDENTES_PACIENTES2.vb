...
Public Class D_IRIS_WEBF_BUSCA_MUESTRA_ANTECEDENTES_PACIENTES2
    ...
    Function IRIS_WEBF_BUSCA_MUESTRA_ANTECEDENTES_PACIENTES2(ByVal ID_ATE As Integer) As List(Of E_IRIS_WEBF_BUSCA_MUESTRA_ANTECEDENTES_PACIENTES2)
        ...
        'Declaraciones 'lista'
        Dim E_Proc_Item As E_IRIS_WEBF_BUSCA_MUESTRA_ANTECEDENTES_PACIENTES2
        Dim E_Proc_List As New List(Of E_IRIS_WEBF_BUSCA_MUESTRA_ANTECEDENTES_PACIENTES2)
        'Configuración general
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_BUSCA_MUESTRA_ANTECEDENTES_PACIENTES2"
        ...
        While Obj_Reader.Read
            E_Proc_Item = New E_IRIS_WEBF_BUSCA_MUESTRA_ANTECEDENTES_PACIENTES2

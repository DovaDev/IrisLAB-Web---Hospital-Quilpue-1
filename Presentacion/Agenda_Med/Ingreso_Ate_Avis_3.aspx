<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Ingreso_Ate_Avis_3.aspx.vb" Inherits="Presentacion.Ingreso_Ate_Avis_3" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        var agregar_folio = 0;
        var omi_save = 0;
        $(document).ready(function () {                                                     //DOCUMENT PUNTO REDIIII MEN!
        ...
        function AJAX_SIN_RUT() {
            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis_3.aspx/AJAX_SIN_RUT",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
        ...
        function IRIS_WEBF_BUSCA_MEDICO_COMPARA_SI_EXISTE(holita) {
            var Data_Par = JSON.stringify({
                "NOMBRE": holita//Mx_AVIS[0].HO_NombreMedico
            });

            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis_3.aspx/IRIS_WEBF_BUSCA_MEDICO_COMPARA_SI_EXISTE",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
                    var json_receiver = response.d;
                    if (json_receiver != "null") {
                        Mx_DL_DOC_REPITED = JSON.parse(json_receiver);

                        $("#Doctor").empty();

                        $("<option>", {"value": Mx_DL_DOC_REPITED[0].ID_DOCTOR}).text(Mx_DL_DOC_REPITED[0].DOC_NOMBRE + " " + Mx_DL_DOC_REPITED[0].DOC_APELLIDO).appendTo("#Doctor");
        ...
        function ajax_eliminar() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis_3.aspx/MODAL_elimanar",
                "data": Data_Par44,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis_3.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_modal_exa() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis_3.aspx/MODAL_PAC",
                "data": Data_Par_modal,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
        ...
        function llenarmodal() {
            ...
            IRIS_WEBF_BUSCA_MEDICO_COMPARA_SI_EXISTE(Mx_Detalle_ate.proparra3[0].DOC_NOMBRE);
    ...
    <script>
        ...
        function Ajax_guardar() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis_3.aspx/Guardar_TodoByVal",
        ...
        function Ajax_Diagnostico() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis_3.aspx/IRIS_WEBF_BUSCA_DIAGNOSTICO",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function buscar_avis() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis_3.aspx/Llenar_AVIS_2",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_N_PACIENTE_3() {
            ...
            var ajax_tabla = $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis_3.aspx/Llenar_AVIS",
                "data": Data_Par_tabla,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_modal_exa_3(preingreso_paciente, atencion_paciente, ATE_NUM_ATENCION_MODAL) {
            ...
            if ((preingreso_paciente == 0 || preingreso_paciente == "null" || preingreso_paciente == null) && atencion_paciente == 0) {
                ...
                $.ajax({
                    "type": "POST",
                    "url": "Ingreso_Ate_Avis_3.aspx/Llenar_DataTable_Ate",
                    "data": Data_Par_modal,
                    "contentType": "application/json;  charset=utf-8",
                    "dataType": "json",
                    "success":function (response) {
        ...
        var Mx_examenes_OMI = [
{
    ...
    "HO_CC": ""
        ...
        function Ajax_Examens_OMI() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis_3.aspx/IRIS_WEBF_BUSCA_examenes_paciente",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_exam02_respaldo = [
{
    ...
    "CF_DIAS": 0,
        ...
        function Ajax_DataTable_examen02() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis_3.aspx/Llenar_tabla_exam2_2",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_exam02_respaldo_global = [
      {
        ...
        function Ajax_DataTable_examen0GObal() {
           $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis_3.aspx/Llenar_tabla_exam2_global",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable_examen3(cod_fonasa, id, cod, txis) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis_3.aspx/Llenar_tabla_exam",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Ddl = [
     {
        ...
        function Call_AJAX_Ddl() {
            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis_3.aspx/Llenar_Ddl_LugarTM",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function creardoctor(doc) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis_3.aspx/crearDoc",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_busca_rut() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis_3.aspx/Llenar_AVIS_RUT",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_busca_rut_22() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis_3.aspx/Llenar_rut",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DL_SEXO() {
            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis_3.aspx/Llenar_DL_SEXO",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DL_NAC() {
            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis_3.aspx/Llenar_DL_NAC",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Ciudad() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis_3.aspx/Llenar_DL_Ciudad",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Comuna() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis_3.aspx/IRIS_WEBF_BUSCA_RELACION_CIU_COMUNA",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_prevision = [
      {
        ...
        function Ajax_DL_prevision() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis_3.aspx/Llenar_DL_prevision",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_TP_ATE = [
     {
        ...
        function Ajax_DL_TP_ATE() {
            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis_3.aspx/Llenar_DL_aTENCIONES",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_Sec = [
    {
        ...
        function Ajax_DL_sec() {
            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis_3.aspx/Llenar_DL_Sectores",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_Programa = [
   {
       ...
       "ID_ESTADO": 0
        ...
        function Ajax_DL_programa() {
            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis_3.aspx/Llenar_DL_Programa",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_DOC = [
{
    ...
    "ID_ESTADO": 0
        ...
        function Ajax_DL_DOC2() {
            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis_3.aspx/Llenar_DL_DOC",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_DOC = [
  {
      ...
      "ID_ESTADO": 0
        ...
        function Ajax_DL_DOC() {
            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis_3.aspx/Llenar_DL_DOC_2",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_orden_ate = [
 {
     ...
     "ID_ESTADO": 0
        ...
        function Ajax_DL_orden_ate() {
            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis_3.aspx/Llenar_DL_ordenATE",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_Diag = [
{
    ...
    "DIA_HOST_AVIS": 0
        ...
        function Ajax_DLdiag(hosts) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis_3.aspx/IRIS_WEBF_BUSCA_DIAGNOSTICO_POR_HOST",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_Diag2 = [
{
    ...
    "DIA_HOST_AVIS": 0
        ...
        function Ajax_DLdiag2(hosts) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis_3.aspx/IRIS_WEBF_BUSCA_DIAGNOSTICO_POR_HOST2",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Examens_avis() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis_3.aspx/IRIS_WEBF_BUSCA_examenes_paciente_2",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
    ...
    <script>
        ...
        function Fill_DL_DOC2() {
            console.log("Fill_DL_DOC2");
            $("#Doctor").empty();
            IRIS_WEBF_BUSCA_MEDICO_COMPARA_SI_EXISTE(Mx_AVIS[0].HO_NombreMedico)
            //for (y = 0; y < Mx_DL_DOC.length; ++y) {
            //    $("<option>", {
            //        "value": Mx_DL_DOC[y].ID_DOCTOR
            //    }).text(Mx_DL_DOC[y].DOC_NOMBRE + " " + Mx_DL_DOC[y].DOC_APELLIDO).appendTo("#Doctor");
        ...
        function Fill_DL_Rut() {
            ...
            Mx_DL_DOC_REPITED.length = 0;
            IRIS_WEBF_BUSCA_MEDICO_COMPARA_SI_EXISTE(Mx_Dtt2[0].HO_NombreMedico);
        ...
        function Fill_DL_AVIS() {
            ...
            //let DocStat = false;
            //let regeX = new RegExp(`${strAVIS.replace(/\s+/g, "\\s+")}`, `gi`);
            // console.log(regeX + " " + "NOMBRE DESPUES DEL REGEX");
            //for (i = 0; i < drLng; i++) {
            //    let Sel_Val = $("#Doctor option").eq(i).text();
            //    if (Sel_Val.match(regeX) != null) {
            //        console.log(Mx_AVIS[0].HO_NombreMedico);
            //        console.log($("#Doctor option").eq(i).text());
            //        $("#Doctor option").eq(i).prop('selected', true);
            //        DocStat = true;
            //        break;
            //    }
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg">
                                ...
                                <select id="Doctor" class="form-control textoReducido" style="height: 31.75px;">
                                    <option value="539">Sin Médico</option>
                                </select>
                            </div>
                            <div class="col-lg">

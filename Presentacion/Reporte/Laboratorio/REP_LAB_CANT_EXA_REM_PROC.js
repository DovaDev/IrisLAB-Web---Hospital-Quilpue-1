...
function AJAX_Excel_Async() {
    ...
    $.ajax({
        "type": "POST",
        "url": "REP_LAB_CANT_EXA_REM_PROC.aspx/Gen_Excel_Async",
        "data": Data_Par,
...
function Ajax_Excel() {
    ...
    $.ajax({
        "type": "POST",
        "url": "REP_LAB_CANT_EXA_REM_PROC.aspx/Gen_Excel_Desagrupado",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": (resp) => {
...
function Ajax_DataTable() {
    ...
    $.ajax({
        "type": "POST",
        "url": "REP_LAB_CANT_EXA_REM_PROC.aspx/Llenar_DataTable_REM",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": resp => {
...
function Call_Frotis(Data_Par) {
    $.ajax({
        type: "POST",
        url: "REP_LAB_CANT_EXA_REM_PROC.aspx/Call_Frotis",
        data: Data_Par,
        contentType: "application/json;  charset=utf-8",
        dataType: "json",
        success: (resp) => {

...
Public Class GraficoT_Sistema
    ...
    Public Shared Function Gen_Excel(ByVal MAIN_URL As String, ByVal Mes As String, ByVal Año As String) As String
        ...
        Return NN_Prev.Gen_ExcelSistema(MAIN_URL, Mes, Año)
    End Function

    Private Sub GraficoT_Sistema_Load(sender As Object, e As EventArgs) Handles Me.Load

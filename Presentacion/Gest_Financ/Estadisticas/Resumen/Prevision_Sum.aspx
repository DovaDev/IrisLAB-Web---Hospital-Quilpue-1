<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Prevision_Sum.aspx.vb" Inherits="Presentacion.Prevision_Sum" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function Ajax_Ddl() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Prevision_Sum.aspx/Llenar_Ddl",
                //"data": '{}',
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Prevision_Sum.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Prevision_Sum.aspx/Gen_Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Fill_DataTable() {
            ...
            $("#DataTable thead").append(
                $("<tr>").append(
                    ...
                    $("<th>", { "class": "text-center" }).text("Total Usuarios"),
            ...
            for (i = 0; i < Mx_Dtt.length; i++) {
                $("#DataTable tbody").append(
                    $("<tr>").append(
                        ...
                        $("<td>", { "align": "center" }).text("$ " + cFormat.numToString(Mx_Dtt[i].TOTA_SIS, 0, ".", ",")),
                        $("<td>", { "align": "center" }).text("$ " + cFormat.numToString(Mx_Dtt[i].TOTA_USU, 0, ".", ",")),
                        $("<td>", { "align": "center" }).text("$ " + cFormat.numToString(Mx_Dtt[i].TOTA_COPA, 0, ".", ",")),
                        $("<td>", { "align": "center" }).text("$ " + cFormat.numToString(parseFloat(Mx_Dtt[i].TOTA_USU) + parseFloat(Mx_Dtt[i].TOTA_COPA), 0, ".", ","))
                    )
                );
            }
            ...
            $("#DataTableTotal tbody").append(
                $("<tr>").append(
                    ...
                    $("<td>", { "align": "center" }).text("$ " + cFormat.numToString(T_Usu, 0, ".", ",")),
                    $("<td>", { "align": "center" }).text("$ " + cFormat.numToString(T_Cop, 0, ".", ",")),
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
    ...
    <div class="flex_col">
        ...
        <div id="Id_conte">
            <div class="card mb-3 border-bar">
                <div class="card-header bg-bar p-2">
                    <h5>Valoralización de Atenciones por Previsión</h5>
                </div>

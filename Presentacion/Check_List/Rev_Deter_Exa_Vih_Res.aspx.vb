...
Public Class Rev_Deter_Exa_Vih_Res
    ...
    Public Shared Function Llenar_DataTable(ByVal DESDE As String, ByVal HASTA As String,
        ...
        Dim data_id_per As New List(Of E_IRIS_BUSCA_EXAMEN_DET_ESTADISTICA_CHECK_TODOS_2)

        Dim Json_Item_Res As New E_Json_Result_DataTable_Values2
        Dim NN_Ate As New N_Ate_Resultados2
        Data = NN.IRIS_WEBF_BUSCA_EXAMEN_DET_ESTADISTICA_CHECK_TODOS_2_2_VIH_PDF(CDate(DESDE), CDate(HASTA), ID_CF, ID_EST, LUGARTM)
    ...
    Public Shared Function Excel(ByVal DOMAIN_URL As String, ByVal DESDE As String, ByVal HASTA As String,
        ...
        If (Data.Count > 0) Then
            ...
            For y = 0 To (Data.Count - 1)
                ...
                Mx_Data(13, y) = Data(y).TP_RESUL_COD

                If (Data(y).ATE_RESULTADO = "") Then
                    Mx_Data(14, y) = Data(y).ATE_RESULTADO = ""
                    If (Data(y).ATE_RESULTADO_NUM = "") Then
                        Mx_Data(14, y) = ""
                    Else
                        Mx_Data(14, y) = Data(y).ATE_RESULTADO_NUM
                    End If
                Else
                    Mx_Data(14, y) = Data(y).ATE_RESULTADO
                End If
                ...
                If (Data(y).DOC_NOMBRE = "") Then
                    Mx_Data(15, y) = "SIN MÉDICO"
                Else
                    Mx_Data(15, y) = Data(y).DOC_NOMBRE & " " & Data(y).DOC_APELLIDO
                End If

                If (Data(y).UM_DESC = "") Then
                    Mx_Data(16, y) = "SIN UNIDAD"
                Else
                    Mx_Data(16, y) = Data(y).UM_DESC
                End If
                        ...
                        If (Data(y).ATE_R_DESDE <> ".") Then
                            If (Data(y).ATE_R_DESDE <> "-") Then
                                ...
                                If (IsNumeric(Data(y).ATE_R_DESDE) = True) Then
                                    ...
                                    Mx_Data(18, y) = NN_Ate.Num_Dec(Data(y).ATE_R_DESDE, Data(y).PRU_DECIMAL)
                                Else
                                    Mx_Data(18, y) = Data(y).ATE_R_DESDE
                                End If
                            Else
                                Mx_Data(18, y) = ""
                            End If
                                    ...
                                    If (Data(y).ATE_RR_DESDE <> ".") Then
                                        If (Data(y).ATE_RR_DESDE <> "-") Then
                                            ...
                                            If (IsNumeric(Data(y).ATE_RR_DESDE) = True) Then
                                                ...
                                                Mx_Data(18, y) = NN_Ate.Num_Dec(Data(y).ATE_RR_DESDE, Data(y).PRU_DECIMAL)
                                            Else
                                                Mx_Data(18, y) = Data(y).ATE_RR_DESDE
                                            End If
                                        Else
                                            Mx_Data(18, y) = ""
                                        End If
                        ...
                        If (Data(y).ATE_R_HASTA <> ".") Then
                            If (Data(y).ATE_R_HASTA <> "-") Then
                                ...
                                If (IsNumeric(Data(y).ATE_R_HASTA) = True) Then
                                    ...
                                    Mx_Data(19, y) = NN_Ate.Num_Dec(Data(y).ATE_R_HASTA, Data(y).PRU_DECIMAL)
                                Else
                                    Mx_Data(19, y) = Data(y).ATE_R_HASTA
                                End If
                            Else
                                Mx_Data(19, y) = ""
                            End If
                                    ...
                                    If (Data(y).ATE_RR_HASTA <> ".") Then
                                        If (Data(y).ATE_RR_HASTA <> "-") Then
                                            ...
                                            If (IsNumeric(Data(y).ATE_RR_HASTA) = True) Then
                                                ...
                                                Mx_Data(19, y) = NN_Ate.Num_Dec(Data(y).ATE_RR_HASTA, Data(y).PRU_DECIMAL)
                                            Else
                                                Mx_Data(19, y) = Data(y).ATE_RR_HASTA
                                            End If
                                        Else
                                            Mx_Data(19, y) = ""
                                        End If
        ...
        'nombrar hoja 
        sl.RenameWorksheet("Sheet1", "Listado de Resultados por Determinaciones VIH")
        'titulo de la tabla
        sl.SetCellValue("B2", "Listado de Resultados por Determinaciones VIH")
        ...
        sl.SetCellValue("N8", "T")
        sl.SetCellValue("O8", "Resultado")
        sl.SetColumnWidth("O", 60)
        sl.SetCellValue("P8", "Médico")
        sl.SetColumnWidth("P", 40)
        sl.SetCellValue("Q8", "Unidad")
        sl.SetCellValue("R8", "E")
        sl.SetCellValue("S8", "Rango Desde")
        sl.SetCellValue("T8", "Rango Hasta")

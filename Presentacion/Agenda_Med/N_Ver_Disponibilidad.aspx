<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="N_Ver_Disponibilidad.aspx.vb" Inherits="Presentacion.N_Ver_Disponibilidad" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function Call_AJAX_Ddl() {
            ...
            AJAX_Ddl = $.ajax({
                "type": "POST",
                "url": "N_Ver_Disponibilidad.aspx/Llenar_Ddl_LugarTM",
                //"data": Data_Par,
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "N_Ver_Disponibilidad.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
        ...
        function Ajax_Agendar(NUM, fecha_ac) {
            $('#Manual').attr("onclick", "window.location.href='/Agenda_Med/IN_PAC_MAN.aspx?kl=" + NUM + "&FF=" + fecha_ac + "'");
            $('#AVIS').attr("onclick", "window.location.href='/Agenda_Med/IN_PAC_AVIS.aspx?kl=" + NUM + "&FF=" + fecha_ac + "'");
            $('#eModal').modal('show');
        }
        var Mx_Detalle_ate = {
            "proparra1": [{
        ...
        function Ajax_modal_exa(id_ate) {
            ...
            $.ajax({
                "type": "POST",
                "url": "N_Ver_Disponibilidad.aspx/MODAL_PAC",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Fill_DataTable() {
            ...
            for (i = 0; i < Mx_Dtt.length; i++) {
                ...
                $("#DataTable tbody").append(
                    $("<tr>", {
                        "onclick": `Ajax_N_PACIENTE("` + $("#Ddl_LugarTM").val() + `","` + Mx_Dtt[i].CONF_DIAS_EXA_BUSCA_DIAS + `","` + Mx_Dtt[i].TOTAL_ATE + `","` + Mx_Dtt[i].FECHA + `")`,
                    ...
                    <div class="row">
                        <div class="col-lg mb-1">
                            <div class='input-group date' id='datetimepicker1' style="margin-bottom: 1vh;">
                                <input type='text' id="fecha" class="form-control" readonly="true" placeholder="Fecha" disabled="disabled" />

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="GraficoOrdAte.aspx.vb" Inherits="Presentacion.GraficoOrdAte" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function Ajax_Ddl() {
            ...
            $.ajax({
                "type": "POST",
                "url": "GraficoOrdAte.aspx/Llenar_Ddl",
                //"data": '{}',
        ...
        function Ajax_Ddl_Proce() {
            ...
            $.ajax({
                "type": "POST",
                "url": "GraficoOrdAte.aspx/Llenar_Ddl_Proce",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function AJAX_DataTable() {
            ...
            var Data_Par = JSON.stringify({
                "Dll": String($("#DllTM").val()),
                "Año": $("#DllAño option:selected").text()
            });
            modal_show();
            $.ajax({
                "type": "POST",
                "url": "GraficoOrdAte.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "GraficoOrdAte.aspx/Gen_Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
    ...
    <script>
        ...
        function Fill_Ddl_Proce() {
            ...
            $("<option>", {
                "value": 0
            }).text("Todos").appendTo("#DllTM");
            for (y = 0; y < Mx_Ddl_Proce.length; ++y) {
                $("<option>", {
                    "value": Mx_Ddl_Proce[y].ID_ORDEN
                }).text(Mx_Ddl_Proce[y].ORD_DESC).appendTo("#DllTM");
            }
        };
...
<asp:Content ID="Content3" ContentPlaceHolderID="Cph_Body" runat="server">
    <div class="card mb-3 border-bar">
        <div class="card-header bg-bar">
            <h5>Cantidad Anuales por Orden de Atención</h5>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg">
                ...
                <div class="col-lg">
                    <label for="DllTM">Orden de Atención:</label>
                    <select id="DllTM" class="form-control"></select>
                </div>
                <div class="col-lg">

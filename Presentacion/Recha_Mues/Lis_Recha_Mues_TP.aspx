<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Lis_Recha_Mues_TP.aspx.vb" Inherits="Presentacion.Lis_Recha_Mues_TP" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#Btn_Buscar").click(function () {
                if ($("#Ddl_Motivo").val() == 666) {
                    $("#mError_AAH h4").text("Seleccione Tipo");
                    $("#mError_AAH button").attr("class", "btn btn-danger");
                    $("#mError_AAH p").text("Por favor, seleccione un tipo de rechazo.");
                    $("#mError_AAH").modal();
                } else {
                    $("#Div_Tabla").empty();
                    Ajax_DataTable();
    ...
    <script>
        ...
        function Ajax_DDL_RECHAZOS_ACTIVOS() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Lis_Recha_Mues_TP.aspx/DDL_TIPO_RECHAZO_ACTIVOS",
                //"data": Data_Par,
        ...
        function Ajax_DataTable() {
            ...
            var Data_Par = JSON.stringify({
                ...
                "ID_TP_RECHA": $("#Ddl_Motivo").val()
            });
            $(".block_wait").fadeIn(500);
            $.ajax({
                "type": "POST",
                "url": "Lis_Recha_Mues_TP.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_Excel = [
    {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Lis_Recha_Mues_TP.aspx/Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Fill_Ddl_Motivo() {
            $("#Ddl_Motivo").empty();
            $("<option>", { "value": 666 }).text("Seleccione Tipo").appendTo("#Ddl_Motivo");

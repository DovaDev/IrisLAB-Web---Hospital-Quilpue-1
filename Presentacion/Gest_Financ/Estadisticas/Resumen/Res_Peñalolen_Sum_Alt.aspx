<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Res_Peñalolen_Sum_Alt.aspx.vb" Inherits="Presentacion.Res_Peñalolen_Sum_Alt" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function Ajax_Ddl_TM() {
            ...
            obj_AJAX.push($.ajax({
                "type": "POST",
                "url": "Res_Peñalolen_Sum_Alt.aspx/Llenar_Ddl_TM",
                //"data": '{}',
        ...
        function Ajax_Ddl_Prev() {
            ...
            obj_AJAX.push($.ajax({
                "type": "POST",
                "url": "Res_Peñalolen_Sum_Alt.aspx/Llenar_Ddl_Prev",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Ddl_Prog() {
            ...
            obj_AJAX.push($.ajax({
                "type": "POST",
                "url": "Res_Peñalolen_Sum_Alt.aspx/Llenar_Ddl_Prog",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Ddl_SubProg() {
            ...
            obj_AJAX.push($.ajax({
                "type": "POST",
                "url": "Res_Peñalolen_Sum_Alt.aspx/Llenar_Sub_Prog",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "success": function (response) {
                    var json_receiver = response.d;
        ...
        function Ajax_DataTable() {
            ...
            obj_AJAX.push($.ajax({
                "type": "POST",
                "url": "Res_Peñalolen_Sum_Alt.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Excel() {
            ...
            obj_AJAX.push($.ajax({
                "type": "POST",
                "url": "Res_Peñalolen_Sum_Alt.aspx/Gen_Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
                ...
                "error": function (response) {
                    $(".block_wait").fadeOut(500, function () {
                        ...
                        if (response == undefined) {
                            ...
                            str_Error = "El servidor tardado demasiado en Responder. Por favor contacte con asistencia técnica.";
                        }
                        cModal_Error("Error", str_Error);
                    });

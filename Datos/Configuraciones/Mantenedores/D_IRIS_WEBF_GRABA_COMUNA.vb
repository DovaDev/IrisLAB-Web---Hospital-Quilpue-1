...
Public Class D_IRIS_WEBF_GRABA_COMUNA
    'Declaraciones Generales
    Dim CC_ConnBD As Conexion.ConexionBD
    Dim DD_GEN As New D_General_Functions
    Function IRIS_WEBF_GRABA_COMUNA(ByVal COM_COD As String, ByVal COM_DES As String, ByVal ID_ESTADO As String) As Integer
        'Declaraciones
        ...
        With Cmd_SQL
            ...
            .CommandText = "IRIS_WEBF_GRABA_COMUNA"

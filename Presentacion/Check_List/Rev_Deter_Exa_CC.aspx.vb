...
Public Class Rev_Deter_Exa_CC
    ...
    Public Shared Function Llenar_DataTable(ByVal DESDE As String, ByVal HASTA As String,
        ...
        Data = NN.IRIS_WEBF_BUSCA_EXAMEN_DET_ESTADISTICA_CHECK_TODOS_2_2_CC(CDate(DESDE), CDate(HASTA), ID_CF, ID_EST, LUGARTM)
    ...
    Public Shared Function Excel(ByVal DOMAIN_URL As String, ByVal DESDE As String, ByVal HASTA As String,
        ...
        'nombrar hoja 
        sl.RenameWorksheet("Sheet1", "Listado de Resultados por Determinaciones Cultivo Streptococcus Grupo B")
        'titulo de la tabla
        sl.SetCellValue("B2", "Listado de Resultados por Determinaciones Cultivo Streptococcus Grupo B")

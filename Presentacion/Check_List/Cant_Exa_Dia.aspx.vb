...
Public Class Cant_Exa_Dia
    ...
    Public Shared Function Llenar_DataTable(ByVal DESDE As String, ByVal HASTA As String,
        ...
        Dim str_Builder As New StringBuilder
        'Declaraciones internas
        Dim NN As New N_IRIS_WEBF_BUSCA_CANTIDAD_EXAMEN_PACIENTE_POR_TM
        Dim Data As New List(Of E_IRIS_WEBF_BUSCA_CANTIDAD_EXAMEN_PACIENTE_POR_TM)
        ...
        Data = NN.IRIS_WEBF_BUSCA_CANTIDAD_EXAMEN_PACIENTE_POR_TM(CDate(DESDE), CDate(HASTA), ID_CF)
    ...
    Public Shared Function Excel(ByVal DOMAIN_URL As String, ByVal DESDE As String, ByVal HASTA As String,
        ...
        If (Data.Count > 0) Then
            ...
            For y = 0 To (Data.Count - 1)
                ...
                Mx_Data(3, y) = Format(Data(y).ATE_FECHA, "dd/mm/yyyy")
                Mx_Data(4, y) = Format(Data(y).ATE_FECHA, "hh:mm:ss")
                Mx_Data(5, y) = Data(y).PROC_DESC
                Mx_Data(6, y) = Data(y).CANT
                Mx_Data(7, y) = Data(y).SEXO_DESC
        ...
        sl.SetCellValue("E8", "Hora")
        sl.SetCellValue("F8", "Lugar de TM")
        sl.SetCellValue("G8", "Cantidad")
        sl.SetCellValue("H8", "Sexo")
        sl.SetCellValue("I8", "Rut")
        For y = 1 To 9
            sl.SetColumnWidth(y, 20.0)
        Next y

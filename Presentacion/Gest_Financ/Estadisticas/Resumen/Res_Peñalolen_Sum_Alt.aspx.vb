...
Public Class Res_Peñalolen_Sum_Alt
    ...
    Public Shared Function Llenar_Ddl_Prev(ByVal ID_TM As Long) As String
        ...
        Dim NN_Activos_02 As New N_Res_Peñalolen_Sum_Alt
    ...
    <Services.WebMethod()>
    Public Shared Function Gen_Excel(ByVal DOMAIN_URL As String, ByVal ALL As Boolean, ByVal DESDE As String, ByVal HASTA As String, ByVal ID_CF As Long, ByVal ID_TM As Long, ByVal ID_PREV As Long, ByVal ID_PROG As Long, ByVal ID_SUBPROG As Long) As String
        Dim NN_Usuario_Sum As New N_Res_Peñalolen_Sum_Alt

        Return NN_Usuario_Sum.Gen_Excel(DOMAIN_URL, ALL, DESDE, HASTA, ID_CF, ID_TM, ID_PREV, ID_PROG, ID_SUBPROG)
    End Function

    Private Sub Res_Peñalolen_Sum_Alt_Load(sender As Object, e As EventArgs) Handles Me.Load

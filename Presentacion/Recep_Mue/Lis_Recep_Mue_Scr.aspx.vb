...
Public Class Lis_Recep_Mue_Scr
    ...
    Public Shared Function Excel(ByVal DOMAIN_URL As String, ByVal TIPO As Integer, ByVal DESDE As String, ByVal HASTA As String,
        ...
        'nombrar hoja 
        sl.RenameWorksheet("Sheet1", "Listado de Recepción de Exámenes: Screening Sífilis")

        'titulo de la tabla
        sl.SetCellValue("B2", "Listado de Recepción de Exámenes: Screening Sífilis")

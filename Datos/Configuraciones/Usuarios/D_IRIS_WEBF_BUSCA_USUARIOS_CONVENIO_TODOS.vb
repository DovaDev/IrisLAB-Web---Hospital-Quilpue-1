...
Public Class D_IRIS_WEBF_BUSCA_USUARIOS_CONVENIO_TODOS
    ...
    Function IRIS_WEBF_BUSCA_USUARIOS_CONVENIO_TODOS() As List(Of E_IRIS_WEBF_BUSCA_USUARIOS_CONVENIO_TODOS)
        ...
        'Declaraciones 'lista'
        Dim E_Proc_Item As E_IRIS_WEBF_BUSCA_USUARIOS_CONVENIO_TODOS
        Dim E_Proc_List As New List(Of E_IRIS_WEBF_BUSCA_USUARIOS_CONVENIO_TODOS)

        'Configuración general
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_BUSCA_USUARIOS_CONVENIO_TODOS"
        ...
        While Obj_Reader.Read
            E_Proc_Item = New E_IRIS_WEBF_BUSCA_USUARIOS_CONVENIO_TODOS

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Rev_Deter_Exa_3.aspx.vb" Inherits="Presentacion.Rev_Deter_Exa_3" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#Btn_Agregar_Detasdasdasdasasd").click(() => {
                selected2 = new Array();
                ...
                if (selected2 == "" || selected2 == 0) {
                    ...
                    $("#mError_AAH_2 h4").text("Confirme");
                    $("#mError_AAH_2 p").text("¿Esta seguro que desea marcar las siguientes determinaciones?");
                    $("#mError_AAH_2").modal();
            ...
            $("#Button_mError_AAH_2").click(() => {
                IRIS_WEBF_UPDATE_DET_ATENCION_ATE_RESULTADO_NOTIFICACION_AVISO();             //<-------..-.-.-.-.-..-.-.-.-...-.----__...__.-.-.-.
            });
            ...
            $("#Btn_Exportar_Marcados").click(function () {
                Ajax_DataTable_2();
        ...
        var Mx_Exam = [
    {
        ...
        function Ajax_Exam() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_3.aspx/Llenar_Ddl_Exam",
                //"data": Data_Par,
        ...
        var Mx_Dtt_Det = [
    {
        ...
        function Ajax_Det() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_3.aspx/Llenar_Ddl_Det",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_tp_aviso() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_3.aspx/Llenar_Ddl_tp_aviso",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_3.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable_2() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_3.aspx/Llenar_DataTable_2",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_Det_Ate = [
  {
      ...
      "ENCRYPTED_ID": 0
        ...
        function Ajax_DataTable_Det_Ate(ID_ATE) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_3.aspx/Llenar_DataTable_Det_Ate",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable_Click_1(ID_ATE_RES) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_3.aspx/IRIS_WEBF_BUSCA_VALOR_CRITICO_POR_ID_ATE_RESULTADO",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable_Click_2(ID_ATE_RES) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_3.aspx/IRIS_WEBF_BUSCA_DETALLE_VALORES_CRITICOS_QUE_SE_HIZO_POR_ID_ATE_RES",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function IRIS_WEBF_UPDATE_DET_ATENCION_ATE_RESULTADO_NOTIFICACION_AVISO() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_3.aspx/IRIS_WEBF_UPDATE_DET_ATENCION_ATE_RESULTADO_NOTIFICACION_AVISO",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
                    ...
                    if (json_receiver != "null") {
                        ...
                        $("#mError_AAH h4").text("Marcado Exitoso");
                        $("#mError_AAH button").attr("class", "btn btn-success");
                        $("#mError_AAH p").text("Las determinaciones de han marcado exitosamente.");
                        $("#mError_AAH").modal();
        ...
        var Mx_Dtt_Excel = [
    {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_3.aspx/Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
    ...
    <script>
        function Ajax_Exa_Print(ide, per) {
            console.log("ATE " + ide + " PER: " + per);
            var loc = location.origin;
            //window.open(loc + "/Print_Ate/VerExamenesSolo.asp?dato1=" + (ateIDD * 2) + "&dato2=" + (ateIDD * 5) + "&dato3=" + (per) + "&dato4=" + (per * 5));
            window.open(loc + "/Print_Ate/VerExamenesSoloAVIS.asp?id_cliente=" + ide + "&id_perfil=" + per);
        }
        //---------------------------------------------------- TABLA  -------------------------------------------------------------------------------|
                    ...
                    $("<tr>", {
                        ...
                        //"class": "manito"
                                ...
                                $("<td>").css("text-align", "left").text(function () {
                                    if (Mx_Dtt[i].ATE_REVISION_1 == 1) {
                                        return "MARCADO";
                                    } else {
                                        return "";
                                    }
                                }), $("<td>").css("text-align", "center").text(function () {
                                    if (Mx_Dtt[i].ATE_EST_VALIDA == 6 || Mx_Dtt[i].ATE_EST_VALIDA == 14) {
                                        ...
                                        $(this).append("<button type='button' class='btn btn-danger btn-sm' onclick='Ajax_Exa_Print(" + Mx_Dtt[i].ID_ATENCION + "," + Mx_Dtt[i].ID_PER + ")'><i class='fa fa-fw fa-file-text mr-2'></i>Ver PDF</button>");
                                ...
                                $("<td>").css("text-align", "center").text(function () {
                                    if (Mx_Dtt[i].ATE_REVISION_1 == 1) {
                                        ...
                                        $(this).html("<div class='checkbox checkbox-success2 pz' style='margin-top:-10px;'><input type='checkbox' value='" + Mx_Dtt[i].ID_ATENCION + "~" + Mx_Dtt[i].ID_CODIGO_FONASA + "~" + Mx_Dtt[i].ID_ATE_RES + "' class='manitos2' id='Hasdasd2" + i + "'/><label class='manitos2' for='Hasdasd2" + i + "'></label></div>")
                                    }
        ...
        function Fill_DataTable_2() {
            ...
            $("#DataTable_2").attr("class", "table table-hover table-striped table-iris");
            $("#DataTable_2 thead").attr("class", "cabezera");
            $("#DataTable_2 thead").append(
                $("<tr>").append(
                    $("<th>", { "class": "textoReducido" }).text("#"),
                    $("<th>", { "class": "textoReducido text-center" }).text("N° Atención"),
                    $("<th>", { "class": "textoReducido text-center" }).text("Fecha Ingreso"),
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
    ...
    <div id="mError_AAH" class="modal fade" role="dialog">
        ...
        <div id="mError_AAH_2" class="modal fade" role="dialog">
        <div class="modal-dialog modal-sm">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                    <button type="button" id="Button_mError_AAH_2" class="btn btn-success" data-dismiss="modal">Marcar</button>
                </div>
            </div>
        </div>
    </div>
...
<%--            <label for="Ddl_Det">Determinación:</label>
        ...
        <div class="col-md-1">
            <label>Aviso</label>
            <br />
            <button id="Btn_Agregar_Detasdasdasdasasd" class="btn btn-warning" type="submit"><i class="fa fa-fw fa-plus-circle"></i> Marcar</button> 
        </div>
        <div class="col-md-1">
            <label>Marcados</label>
            <br />
            <button id="Btn_Exportar_Marcados" class="btn btn-success" type="submit"><i class="fa fa-fw fa-file-excel-o mr-2"></i> Exportar</button> 
        </div>
    </div>

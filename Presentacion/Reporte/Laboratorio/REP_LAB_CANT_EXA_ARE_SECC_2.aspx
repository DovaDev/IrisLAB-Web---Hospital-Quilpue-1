<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="REP_LAB_CANT_EXA_ARE_SECC_2.aspx.vb" Inherits="Presentacion.REP_LAB_CANT_EXA_ARE_SECC_2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script src="REP_LAB_CANT_EXA_ARE_SECC_2.js"></script>
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div id="Div_Excel_DesAgrupado" class="col-lg">
                    <button id="Btn_Export" type="button" class="btn btn-block btn-success btn-sm"><i class="fa fa-fw fa-file-excel-o mr-2"></i> Excel D</button>
                </div>

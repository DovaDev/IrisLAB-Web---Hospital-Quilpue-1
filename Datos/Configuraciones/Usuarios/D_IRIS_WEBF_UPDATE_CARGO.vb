...
Public Class D_IRIS_WEBF_UPDATE_CARGO
    'Declaraciones Generales
    Dim CC_ConnBD As Conexion.ConexionBD
    Dim DD_GEN As New D_General_Functions
    Function IRIS_WEBF_UPDATE_CARGO(ByVal ID_CAR As Integer,
        ...
        With Cmd_SQL
            ...
            .CommandText = "IRIS_WEBF_UPDATE_CARGO"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Enviar parámetros
        With Cmd_SQL.Parameters
            .Add("@ID_CAR", OleDbType.Numeric).Value = ID_CAR

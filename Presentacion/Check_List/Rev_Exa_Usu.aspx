<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Rev_Exa_Usu.aspx.vb" Inherits="Presentacion.Rev_Exa_Usu" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function Ajax_Ddl_Exa() {
            $.ajax({
                "type": "POST",
                "url": "Rev_Exa_Usu.aspx/Llenar_Ddl_Exa",
                //"data": '{}',
        ...
        function Ajax_Ddl_Usu() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Exa_Usu.aspx/Llenar_Ddl_Usu",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Table() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Exa_Usu.aspx/Llenar_DTT",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Exa_Usu.aspx/Gen_Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {

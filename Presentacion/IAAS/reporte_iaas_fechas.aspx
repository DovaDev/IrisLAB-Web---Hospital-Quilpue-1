<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="reporte_iaas_fechas.aspx.vb" Inherits="Presentacion.reporte_iaas_fechas" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
  ...
  <script>
      ...
      function Ajax_LugarTM() {
          ...
          $.ajax({
              "type": "POST",
              "url": "/Check_List/Check_Point/Traza_Fechas.aspx/Llenar_Ddl_LugarTM",
              //"data": Data_Par,
      ...
      function Ajax_Seccion() {
          ...
          $.ajax({
              "type": "POST",
              "url": "/Check_List/Check_Point/Traza_Fechas.aspx/Llenar_Ddl_Seccion",
              //"data": Data_Par,
              "contentType": "application/json;  charset=utf-8",
              "dataType": "json",
              "success": function (response) {
      ...
      function Ajax_DDL_RECHAZOS_ACTIVOS() {
          ...
          $.ajax({
              "type": "POST",
              "url": "/Check_List/Check_Point/Traza_Fechas.aspx/DDL_TIPO_RECHAZO_ACTIVOS",
              //"data": Data_Par,
              "contentType": "application/json;  charset=utf-8",
              "dataType": "json",
              "success": function (response) {
      ...
      function Ajax_DataTable() {
          ...
          $.ajax({
              "type": "POST",
              "url": "reporte_iaas_fechas.aspx/Llenar_DataTable",
              "data": Data_Par,
              "contentType": "application/json;  charset=utf-8",
              "dataType": "json",
              "success": function (response) {
                  ...
                  if (json_receiver != "null") {
                      ...
                      console.log("Datos recividos: ", Mx_Dtt)
                      $("#Div_Tabla").empty();
      ...
      function Ajax_DataTable_Det_Ate(ID_ATE, yyy) {
          ...
          $.ajax({
              "type": "POST",
              "url": "/Check_List/Check_Point/Traza_Fechas.aspx/Llenar_DataTable_Det_Ate",
              "data": Data_Par,
              "contentType": "application/json;  charset=utf-8",
              "dataType": "json",
              "success": function (response) {
      ...
      function Ajax_Excel() {
          ...
          $.ajax({
              "type": "POST",
              "url": "reporte_iaas_fechas.aspx/Excel",
              //"url": "reporte_iaas_fechas.aspx/Llenar_DataTable",
              "data": Data_Par,
              "contentType": "application/json;  charset=utf-8",
              "dataType": "json",
                  ...
                  $("#DataTable tbody").append(
                      $("<tr>", {
                          ...
                          $("<td>", { "align": "center" }, { "class": "textoReducido" }).html(function () {
                              ...
                              console.log("Deberia ser SI: ", Mx_Dtt[i].ATE_EST_TM_DESC)
                              // if (Mx_Dtt[i].ATE_EST_TM_DESC == "SI") {
            ...
            <div class="card mb-3 border-bar">
                <div class="card-header bg-bar">
                    <h5 style="text-align: center; padding: 5px;">
                        ...
                        Trazabilidad de Muestra por Rango de Fechas y Filtros con Uso de DIP y Sospecha de AREpi
                    </h5>
                </div>
                <div class="card-body">

							...
							IF (CANTIDAD_REG + contLINEA_ ) < 50 THEN
								...
								END IF										
								 ...
								 WHILE NOT rst_BM3.eof
									...
									CALL IMPRIME_RESULTADO(w_ID_PRUEBA, w_ID_UM, w_UM, w_ResultadoA, w_ResultadoN, w_Rango_DESDE, w_Rango_HASTA, w_ID_TP_RESUL, contLINEA_, w_Nom_Seccion, w_TP_Alerta,w_ID_PER_P, w_FORMATON, w_TXT_EXTRA,w_EST_RECHAZO)	   
...
FUNCTION IMPRIME_RESULTADO(w_ID_PRUEBA, w_ID_UM, w_UM, w_ResultadoA, w_ResultadoN, w_Rango_DESDE, w_Rango_HASTA, w_ID_TP_RESUL, contLINEA_, w_Nom_Seccion, w_TP_Alerta,w_ID_PER_P,w_FORMATON, w_TXT_EXTRA,w_EST_RECHAZO)	
    Dim YYYY 
    Dim YY

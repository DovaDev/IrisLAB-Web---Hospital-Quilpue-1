<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Config_Ate_LM.aspx.vb" Inherits="Presentacion.Config_Ate_LM" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function Call_AJAX_Ddl_Año() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Config_Ate_LM.aspx/Llenar_Ddl_Año",
                //"data": Data_Par,
        ...
        function Call_AJAX_Ddl_LugarTM() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Config_Ate_LM.aspx/Llenar_Ddl_LugarTM",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": data => {
        ...
        function Call_AJAX_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Config_Ate_LM.aspx/Llenar_Tabla",
                "data": strParam,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": data => {
        ...
        function Call_AJAX_Guardar() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Config_Ate_LM.aspx/Guardar_Conf_Examenes",
                "data": strParam,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": data => {
        ...
        function Call_AJAX_Modificar() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Config_Ate_LM.aspx/Modificar_Conf_Examenes",
                "data": strParam,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": data => {
        ...
        //FUNCTION ON CLICK
        function Ajax_Click(fclick, cantexa, est, id) {
        ...
        function Fill_Dtt() {
            ...
            Mx_Dtt.forEach(aah => {
                ...
                if (fdia != "Domingo") {
                    $("<tr>", {
                        "onclick": `Ajax_Click("` + aah.N_FECHA + `","` + aah.N_CANT_EXA + `","` + aah.N_ESTADO + `","` + aah.N_ID + `")`,
                        "class": "manito"
                    }).append(
                        ...
                        <div class="col-md-5">
                            <div class="container">
                                <div class="form-row">
                                    ...
                                    <div class="col-sm-5">
                                        <h3>
                                            <label>Fecha:</label></h3>
                                        <input id="Fecha" type="text" class="form-control font-weight-bold text-center" disabled style="color: red; font-size: 17px;" />
                                    </div>
                                    <div class="col"></div>
                                </div>
                                <div class="form-row mb-3">
                                    ...
                                    <div class="col-sm-5">
                                        <h3>
                                            <label>Cantidad:</label></h3>
                                        <input id="Cantidad" type="text" class="form-control font-weight-bold text-center" style="font-size: 17px;" />
                                    </div>
                                    <div class="col"></div>
                                </div>
                            </div>

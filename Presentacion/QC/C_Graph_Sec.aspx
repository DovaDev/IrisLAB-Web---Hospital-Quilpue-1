<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="C_Graph_Sec.aspx.vb" Inherits="Presentacion.C_Graph_Sec" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
	<script>
		...
		function Ajax_Fijar_Var() {
			...
			$.ajax({
				"type": "POST",
				"url": "C_Graph_Sec.aspx/IRIS_QC_GRABA_UPDATE_FIJA_VARIABLES",
				"data": Data_Par,
		...
		function Ajax_Ingreso_Manual() {
			...
			$.ajax({
				"type": "POST",
				"url": "C_Graph_Sec.aspx/IRIS_GRABA_QC_RESULTADO_MANUAL",
				"data": Data_Par,
				"contentType": "application/json;  charset=utf-8",
				"dataType": "json",
				"success": function (response) {
		...
		function Ajax_Modificar_Resul() {
			...
			$.ajax({
				"type": "POST",
				"url": "C_Graph_Sec.aspx/IRIS_UPDATE_QC_RESULTADO",
				"data": Data_Par,
				"contentType": "application/json;  charset=utf-8",
				"dataType": "json",
				"success": function (response) {
		...
		function Ajax_Buscar_TreeView() {
			...
			$.ajax({
				"type": "POST",
				"url": "C_Graph_Sec.aspx/IRIS_QC_BUSCA_TREEVIEW",
				"contentType": "application/json;  charset=utf-8",
				"dataType": "json",
				"success": function (response) {
				    console.log(response);
		...
		function Fill_Tree() {
			...
			Mx_Tree.forEach(aah => {
				...
				$("#ul_Lote_" + _li_sec + _li_ana + _li_lote).append(
							$("<li>", { "name": "li_det", "data-ana": _li_ana, "data-lote": _li_lote, "data-det": _li_det }).text(aah.QC_DET_DESC + " " + aah.UM_DESC)
					);
			});
			...
			$("li[name=li_det]").click((e) => {
				...
				$(e.currentTarget).css({ "color": "rgb(219, 0, 0)", "font-weight": "600" });

				let _det_20, _lote_20, _ana_20;

				_det_20 = $(e.currentTarget).attr("data-det");
				_lote_20 = $(e.currentTarget).attr("data-lote");
				_ana_20 = $(e.currentTarget).attr("data-ana");

				console.log($(e.currentTarget).text() + " " + _ana_20 + " " + _lote_20 + " " + _det_20);

				_ID_ANA = _ana_20;
				_ID_LOTE = _lote_20;
				_ID_DET = _det_20;
				_FEC = moment().format("DD-MM-YYYY HH:ss:mm");
				_N = 20;
		...
		function Ajax_Buscar() {
			...
			$.ajax({
				"type": "POST",
				"url": "C_Graph_Sec.aspx/IRIS_QC_BUSCA_DATOS_RESULTADO_POR_CRITERIOS20_FECHA",
				"data": Data_Par,
				"contentType": "application/json;  charset=utf-8",
				"dataType": "json",
				"success": function (response) {
		...
		function Ajax_20() {
			...
			$.ajax({
				"type": "POST",
				"url": "C_Graph_Sec.aspx/IRIS_QC_BUSCA_DATOS_RESULTADO_POR_CRITERIOS20_ULT",
				"data": Data_Par,
				"contentType": "application/json;  charset=utf-8",
				"dataType": "json",
				"success": function (response) {
					...
					if (json_receiver != null) {
						...
						console.log(Mx_20);
						console.log("LG F: " + Mx_Fijos.length);
						Ajax_Fill_Arr_20();

						let Iv_G = setInterval(() => {
						    if (Mx_Fijos.length > 0) {
						        console.log("FILL MDL DATA");
								//if (Mx_Fijos[0].REL_ADL_LI_F != "") {
		...
		function Ajax_Accion() {
			$.ajax({
				"type": "POST",
				"url": "C_Graph_Sec.aspx/IRIS_QC_BUSCA_TP_ACCION_ACTIVAS",
				"contentType": "application/json;  charset=utf-8",
				"dataType": "json",
				"success": function (response) {
					var json_receiver = response.d;
		...
		function Ajax_Fijos() {
			...
			$.ajax({
				"type": "POST",
				"url": "C_Graph_Sec.aspx/IRIS_QC_BUSCA_REL_ANA_DET_LOTE_POR_PARAM",
				"data": Data_Par,
				"contentType": "application/json;  charset=utf-8",
				"dataType": "json",
				"success": function (response) {
		...
		<div class="col-lg-4">
			<div class="card border-bar">
				...
				<div class="card-body pl-1 pr-1 pb-1 pt-2">
					...
					<%--Tabla--%>
					<div style="height: 45.5vh; overflow: auto;" id="div_treeview" class="pt-2">
					...
					<div style="height: 45vh; overflow: auto;" id="div_datatable">

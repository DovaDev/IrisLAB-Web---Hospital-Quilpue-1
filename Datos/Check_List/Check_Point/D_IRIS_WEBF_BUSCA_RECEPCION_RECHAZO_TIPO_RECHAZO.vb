...
Public Class D_IRIS_WEBF_BUSCA_RECEPCION_RECHAZO_TIPO_RECHAZO
    ...
    Function IRIS_WEBF_BUSCA_RECEPCION_RECHAZO_TIPO_RECHAZO(ByVal ID_ATE As Integer, ByVal CURVA As String) As List(Of E_IRIS_WEBF_BUSCA_RECEPCION_RECHAZO_TIPO_RECHAZO)
        ...
        'Declaraciones 'lista'
        Dim E_Proc_Item As E_IRIS_WEBF_BUSCA_RECEPCION_RECHAZO_TIPO_RECHAZO
        Dim E_Proc_List As New List(Of E_IRIS_WEBF_BUSCA_RECEPCION_RECHAZO_TIPO_RECHAZO)

        'Configuración general
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_BUSCA_RECEPCION_RECHAZO_TIPO_RECHAZO"
        ...
        While Obj_Reader.Read
            E_Proc_Item = New E_IRIS_WEBF_BUSCA_RECEPCION_RECHAZO_TIPO_RECHAZO

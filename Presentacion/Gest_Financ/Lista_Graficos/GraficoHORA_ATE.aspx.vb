...
Public Class GraficoHORA_ATE
    Inherits System.Web.UI.Page

    Private Sub GraficoHORA_ATE_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    End Function
    <Services.WebMethod()>
    Public Shared Function Gen_Excel(ByVal DOMAIN_URL As String, ByVal str_Date As String) As String
        Dim NN_Excel As New N_GraficoVisor
        Return NN_Excel.Gen_Excel_HORA_ATE(DOMAIN_URL, str_Date)
    End Function
End Class
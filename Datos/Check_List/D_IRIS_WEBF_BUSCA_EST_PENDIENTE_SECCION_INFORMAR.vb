...
Public Class D_IRIS_WEBF_BUSCA_EST_PENDIENTE_SECCION_INFORMAR
    Function IRIS_WEBF_BUSCA_EST_PENDIENTE_SECCION_INFORMAR(ByVal DESDE As Date, ByVal HASTA As Date, ByVal ID_CF As Integer) As List(Of E_IRIS_WEBF_BUSCA_EST_PENDIENTE_SECCION_INFORMAR)
        ...
        'Declaraciones 'lista'
        Dim E_Proc_Item As E_IRIS_WEBF_BUSCA_EST_PENDIENTE_SECCION_INFORMAR
        Dim E_Proc_List As New List(Of E_IRIS_WEBF_BUSCA_EST_PENDIENTE_SECCION_INFORMAR)
        'Configuración general
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_BUSCA_EST_PENDIENTE_SECCION_INFORMAR"
        ...
        With Cmd_SQL.Parameters
            ...
            .Add("@ID_SECC", OleDbType.Numeric).Value = ID_CF
        End With
        ...
        While Obj_Reader.Read
            E_Proc_Item = New E_IRIS_WEBF_BUSCA_EST_PENDIENTE_SECCION_INFORMAR
            ...
            E_Proc_Item.ATE_DET_V_ID_ESTADO = DD_GEN.DB_NULL(Obj_Reader, 19, Nothing)
            E_Proc_Item.EST_DESCRIPCION = DD_GEN.DB_NULL(Obj_Reader, 20, Nothing)

...
Public Class D_IRIS_WEBF_BUSCA_EST_SECCIONES_POR_RANGO_NUM
    ...
    Function IRIS_WEBF_BUSCA_EST_SECCIONES_POR_RANGO_NUM(ByVal DESDE As Integer, ByVal HASTA As Integer, ByVal ID_REL As Integer) As List(Of E_IRIS_WEBF_BUSCA_EST_SECCIONES_POR_RANGO_NUM)
        ...
        'Declaraciones 'lista'
        Dim E_Proc_Item As E_IRIS_WEBF_BUSCA_EST_SECCIONES_POR_RANGO_NUM
        Dim E_Proc_List As New List(Of E_IRIS_WEBF_BUSCA_EST_SECCIONES_POR_RANGO_NUM)
        'Configuración general
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_BUSCA_EST_SECCIONES_POR_RANGO_NUM"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Enviar parámetros
        With Cmd_SQL.Parameters
            .Add("@DESDE", OleDbType.Integer).Value = DESDE
            .Add("@HASTA", OleDbType.Integer).Value = HASTA
            .Add("@HASTA", OleDbType.Integer).Value = ID_REL
        End With
        ...
        While Obj_Reader.Read
            E_Proc_Item = New E_IRIS_WEBF_BUSCA_EST_SECCIONES_POR_RANGO_NUM
            ...
            E_Proc_Item.ID_RLS_LS = DD_GEN.DB_NULL(Obj_Reader, 17, Nothing)
            E_Proc_Item.RLS_LS_DESC = DD_GEN.DB_NULL(Obj_Reader, 18, Nothing)
            E_Proc_Item.PAC_FNAC = DD_GEN.DB_NULL(Obj_Reader, 19, Nothing)
            E_Proc_Item.ATE_DNI = DD_GEN.DB_NULL(Obj_Reader, 20, Nothing)
            ...
            E_Proc_Item.ATE_NUM_INTERNO = DD_GEN.DB_NULL(Obj_Reader, 24, Nothing)
            E_Proc_Item.DOC_NOMBRE = DD_GEN.DB_NULL(Obj_Reader, 25, Nothing)
            E_Proc_Item.DOC_APELLIDO = DD_GEN.DB_NULL(Obj_Reader, 26, Nothing)
            E_Proc_Item.PAC_RUT = DD_GEN.DB_NULL(Obj_Reader, 27, Nothing)

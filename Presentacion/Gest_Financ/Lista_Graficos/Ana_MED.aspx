<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Ana_MED.aspx.vb" Inherits="Presentacion.Ana_MED" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function Ajax_Ddl_Proce() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ana_MED.aspx/Llenar_Ddl_Proce",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function AJAX_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ana_MED.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
    ...
    <script>
        ...
        function Fill_Ddl_Proce() {
            ...
            for (y = 0; y < Mx_Ddl_Proce.length; ++y) {
                $("<option>", {
                    "value": Mx_Ddl_Proce[y].ID_DOCTOR
                }).text(Mx_Ddl_Proce[y].DOC_NOMBRE + " " + Mx_Ddl_Proce[y].DOC_APELLIDO).appendTo("#DllTM");
            }
        };
...
<asp:Content ID="Content3" ContentPlaceHolderID="Cph_Body" runat="server">
    <div class="card mb-3 border-bar">
        <div class="card-header bg-bar">
            <h5>Cantidades Anuales por Médico</h5>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg">

        ...
        Else
            ...
            If (RUT_PAC = "") Then
                ...
                PREINGRESO2_PRO_SEC = cc.IRIS_WEBF_GRABA_PREINGRESO3_PRO_SEC_AVIS_NEW(correlativo,
                                                                             ...
                                                                             xHora, EMPRESA, 0)
            Else
                data_paciente = NNv.IRIS_WEBF_BUSCA_PACIENTE_POR_RUT(RUT_PAC)
                If (data_paciente.Count = 0) Then
                    Rpaciente = nn.IRIS_WEBF_GRABA_PACIENTE_ATENCION(RUT_PAC, NOMBRE_PAC, APE_PAC, CDate(FNAC_PAC), ID_SEXO, ID_NACIONALIDAD, FONO1, MOVIL1, ID_CIU_COM, DIR_PAC, EMAIL_PAC, 1, "", 1, "", ID_ETNIA, PAC_NOM_SOCIAL)
                    correlativo = dd.IRIS_WEBF_BUSCA_CORRELATIVO_PREINGRESO()
                    PREINGRESO2_PRO_SEC = cc.IRIS_WEBF_GRABA_PREINGRESO3_PRO_SEC_AVIS_NEW(correlativo,
                ...
                Else
                    ...
                    PREINGRESO2_PRO_SEC = cc.IRIS_WEBF_GRABA_PREINGRESO3_PRO_SEC_AVIS_NEW(correlativo,
                                                                                 ...
                                                                                 Sector, ATE_SAYDEX, DIAG1, DIAG2, sub_atencion, vih,
                                                                                xHora, EMPRESA, 0)
                    Rpaciente = vv.IRIS_WEBF_UPDATE_PACIENTE_ATENCION(data_paciente(0).ID_PACIENTE, RUT_PAC, NOMBRE_PAC.ToUpper, APE_PAC.ToUpper, CDate(FNAC_PAC), ID_SEXO, ID_NACIONALIDAD, FONO1, MOVIL1, ID_CIU_COM, DIR_PAC.ToUpper, EMAIL_PAC, 1, OB.ToUpper, 1, ID_ETNIA, PAC_NOM_SOCIAL)
                End If

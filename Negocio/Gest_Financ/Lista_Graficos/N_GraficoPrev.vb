...
Imports Datos
Imports Entidades
Public Class N_GraficoPrev
    Dim DD_Data As D_GraficoPrev
    Dim DD_Data_Todo As D_GraficoTM_Todo
    Sub New()
        DD_Data = New D_GraficoPrev
        DD_Data_Todo = New D_GraficoTM_Todo
    End Sub
    Function IRIS_WEBF_BUSCA_CANT_EXAMENES_ATE_PREVISION(ByVal ID_PAC As Long, ByVal Año As Long, ByVal Mes As Long) As List(Of E_IRIS_WEBF_BUSCA_CANT_EXAMENES_ATE_PREVISION)
        Return DD_Data.IRIS_WEBF_BUSCA_CANT_EXAMENES_ATE_FORMA_PAGO(ID_PAC, Año, Mes)
    End Function
    Function Gen_Excel(ByVal MAIN_URL As String, ByVal Dll As Long, ByVal Año As String) As String
        ...
        For i = 0 To Data_Proce.Count - 1
            If Data_Proce(i).ID_PREVE = Dll Then
                Prev_Desc = Data_Proce(i).PREVE_DESC
            End If
        Next i

...
Public Class N_IRIS_WEBF_UPDATE_USUARIOS_CONVENIO
    'Declaraciones Generales
    Dim DD_Data As D_IRIS_WEBF_UPDATE_USUARIOS_CONVENIO

    Sub New()
        DD_Data = New D_IRIS_WEBF_UPDATE_USUARIOS_CONVENIO
    End Sub

    Function IRIS_WEBF_UPDATE_USUARIOS_CONVENIO(ByVal ID_USU As Integer,
        ...
        Return DD_Data.IRIS_WEBF_UPDATE_USUARIOS_CONVENIO(ID_USU,
                                                          USU_CONV_NIC,
                                                          USU_CONV_PASS,
                                                          USU_CONV_NOMBRE,
                                                          USU_CONV_APELLIDO,

...
Public Class Ate_LTM_Detalle
    ...
    Public Shared Function Llenar_DataTable(ByVal DESDE As Date,
        ...
        Data = NN.IRIS_WEBF_BUSCA_EST_ESTADOS_INFORMAR44_2(DESDE, HASTA, ID_CF)
    ...
    Public Shared Function Excel(ByVal DOMAIN_URL As String, ByVal DESDE As Date,
        ...
        Dim Relative_Path As String = "IRISPDFDERIVADOS\Listado_Hoja_Trabajo_Procedencia_Detallado_" & Format(Date.Now, "dd-MM-yyyy_hh-mm-ss") & ".xlsx"

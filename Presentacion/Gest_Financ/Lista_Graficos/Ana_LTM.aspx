<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Ana_LTM.aspx.vb" Inherits="Presentacion.Ana_LTM" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function Ajax_Ddl_Proce() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ana_LTM.aspx/Llenar_Ddl_Proce",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function AJAX_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ana_LTM.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Fill_Ddl_Proce() {
            ...
            if (procee == 0) {
                ...
                Mx_Ddl_Proce.forEach(aaa => {
                    ...
                    ).text(aaa.PROC_DESC).appendTo("#DllTM");
                });
            }
            else {
                Mx_Ddl_Proce.forEach(aaa => {
...
<asp:Content ID="Content3" ContentPlaceHolderID="Cph_Body" runat="server">
    ...
    <div class="card mb-3 border-bar">
        <div class="card-header bg-bar">
            <h5>Cantidad Anuales por Lugar de Toma de Muestra</h5>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg">
                ...
                <div class="col-lg">
                    <label for="DllTM">Lugar TM:</label>

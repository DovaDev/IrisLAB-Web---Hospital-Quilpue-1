...
Public Class D_IRIS_WEBF_GRABA_RELACION_PROG_PREVE
    'Declaraciones Generales
    Dim CC_ConnBD As C_ConnBD
    Dim DD_GEN As New D_General_Functions

    Function IRIS_WEBF_GRABA_RELACION_PROG_PREVE(ByVal ID_PROGRA As Integer,
                                                 ByVal ID_PREVE As Integer,
                                                 ByVal ID_ESTADO As String) As Integer
        'Declaraciones
        ...
        With Cmd_SQL
            ...
            .CommandText = "IRIS_WEBF_GRABA_RELACION_PROG_PREVE"

...
Public Class HT_LugarTM
    ...
    Public Shared Function Llenar_DataTable(ByVal DESDE As Date,
                                            ByVal HASTA As Date,
                                            ByVal ID_CF As Integer) As List(Of E_IRIS_WEBF_BUSCA_EST_ESTADOS_INFORMAR2)

        'Declaraciones internas
        Dim NN As New N_IRIS_WEBF_BUSCA_EST_ESTADOS_INFORMAR2
        Dim Data As New List(Of E_IRIS_WEBF_BUSCA_EST_ESTADOS_INFORMAR2)
        'Dim ID_SECC = 0
        Dim N_ECrypt As New N_Encrypt

        Data = NN.IRIS_WEBF_BUSCA_EST_ESTADOS_INFORMAR2(DESDE, HASTA, ID_CF)
    ...
    End Function
    <Services.WebMethod()>
    Public Shared Function Llenar_DataTable_2(ByVal DESDE As Date,
                                        ByVal HASTA As Date,
                                        ByVal ID_CF As Integer) As List(Of E_IRIS_WEBF_BUSCA_EST_ESTADOS_INFORMAR2)
        ...
        Data = NN.IRIS_WEBF_BUSCA_EST_ESTADOS_INFORMAR2_2(DESDE, HASTA, ID_CF)
    ...
    Public Shared Function Excel(ByVal DOMAIN_URL As String, ByVal DESDE As Date,
        ...
        'Declaraciones internas
        Dim data_det_ate As New List(Of E_IRIS_WEBF_BUSCA_EST_ESTADOS_INFORMAR2)
        Dim NN As New N_IRIS_WEBF_BUSCA_EST_ESTADOS_INFORMAR2

        data_det_ate = NN.IRIS_WEBF_BUSCA_EST_ESTADOS_INFORMAR2_2(DESDE, HASTA, ID_CF)
        ...
        'Colocar Título
        xls.SetCellValue(1, 1, "Listado de hoja de trabajo por Procedencia ")
        ...
        For Each List_Data As E_IRIS_WEBF_BUSCA_EST_ESTADOS_INFORMAR2 In data_det_ate
            x2 = x1
            y2 += 1
            ...
            xls.SetCellStyle(y2, x2, css_TCell_center)
            xls.SetCellValue(y2, x2, List_Data.ATE_DNI) : x2 += 1
            xls.SetCellStyle(y2, x2, css_TCell_center)
            ...
            xls.SetCellStyle(y2, x2, css_TCell_center)
            xls.SetCellValue(y2, x2, List_Data.NAC_DESC) : x2 += 1
            xls.SetCellStyle(y2, x2, css_TCell_center)
            xls.SetCellValue(y2, x2, List_Data.CF_DESC) : x2 += 1
            xls.SetCellStyle(y2, x2, css_TCell_center)
            xls.SetCellValue(y2, x2, List_Data.PROGRA_DESC) : x2 += 1
            xls.SetCellStyle(y2, x2, css_TCell_center)
            xls.SetCellValue(y2, x2, List_Data.SECTOR_DESC) : x2 += 1
            xls.SetCellStyle(y2, x2, css_TCell_center)
        ...
        Dim Relative_Path As String = "IRISPDFDERIVADOS\Listado_Hoja_Trabajo_Procedencia_" & Format(Date.Now, "dd-MM-yyyy_hh-mm-ss") & ".xlsx"

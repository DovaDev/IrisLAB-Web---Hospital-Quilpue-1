...
Public Class Prevision_Det
    ...
    End Function
    <Services.WebMethod()>
    Public Shared Function Llenar_DataTable(ByVal ID_PREV As Long, ByVal DATE_str01 As String, ByVal DATE_str02 As String) As List(Of E_IRIS_WEBF_BUSCA_LIS_ADM_PREVISION)
        'Declaraciones del Serializador
        Dim Serializer As New JavaScriptSerializer
        Dim str_Builder As New StringBuilder
        'Declaraciones internas
        ...
        Data_Prev = NN_Prev.IRIS_WEBF_BUSCA_LIS_ADM_PREVISION(ID_PREV, DATE_str01, DATE_str02)
    ...
    Private Sub Prevision_Det_Load(sender As Object, e As EventArgs) Handles Me.Load

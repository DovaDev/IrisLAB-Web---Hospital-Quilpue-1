...
Public Class D_IRIS_WEBF_UPDATE_QUITA_DETALLE_EXAMEN_FONASA
    ...
    Function IRIS_WEBF_UPDATE_QUITA_DETALLE_EXAMEN_FONASA(ByVal ID_REL As Integer, ByVal ID_COST As Integer) As Integer
        ...
        With Cmd_SQL
            ...
            .CommandText = "IRIS_WEBF_UPDATE_QUITA_DETALLE_EXAMEN_FONASA"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Enviar parámetros
        With Cmd_SQL.Parameters
            .Add("@ID_REL", OleDbType.Numeric).Value = ID_REL
            .Add("@ID_COST", OleDbType.Numeric).Value = ID_COST
        End With

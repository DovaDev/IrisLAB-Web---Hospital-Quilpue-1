...
Public Class D_IRIS_WEBF_GRABA_PERMISO_USUARIO
    ...
    Function IRIS_WEBF_GRABA_PERMISO_USUARIO(ByVal PU_COD As String, ByVal PU_DES As String, ByVal ID_ESTADO As String) As Integer
        ...
        With Cmd_SQL
            ...
            .CommandText = "IRIS_WEBF_GRABA_PERMISO_USUARIO"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Enviar parámetros
        With Cmd_SQL.Parameters
            .Add("@ESP_COD", OleDbType.VarChar).Value = PU_COD
            .Add("@ESP_DES", OleDbType.VarChar).Value = PU_DES

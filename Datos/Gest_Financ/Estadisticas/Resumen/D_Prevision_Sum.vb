...
Public Class D_Prevision_Sum
    'Declaraciones generales
    Dim CC_ConnBD As C_ConnBD
    Dim DD_Gen As New D_General_Functions
    Function IRIS_WEBF_BUSCA_LIS_ADM_RESU_PREVISION(ByVal ID_PRE As Integer, ByVal Date_01 As Date, ByVal Date_02 As Date) As List(Of E_IRIS_WEBF_BUSCA_LIS_ADM_RESU_PREVISION)
        'Declaraciones SQL
        CC_ConnBD = New C_ConnBD
        Dim Obj_Reader As OleDbDataReader
        Dim Cmd_SQL As New OleDb.OleDbCommand
        'Declaraciones "lista"
        Dim E_Prev_Item As E_IRIS_WEBF_BUSCA_LIS_ADM_RESU_PREVISION
        Dim E_Prev_List As New List(Of E_IRIS_WEBF_BUSCA_LIS_ADM_RESU_PREVISION)
        'Configuración General
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_BUSCA_LIS_ADM_RESU_PREVISION"
        ...
        While Obj_Reader.Read
            E_Prev_Item = New E_IRIS_WEBF_BUSCA_LIS_ADM_RESU_PREVISION
            ...
            E_Prev_Item.PREVE_DESC = DD_Gen.DB_NULL(Obj_Reader, 7, "")

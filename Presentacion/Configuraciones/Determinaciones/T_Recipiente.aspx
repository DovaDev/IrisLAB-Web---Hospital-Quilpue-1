<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="T_Recipiente.aspx.vb" Inherits="Presentacion.T_Recipiente" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function Ajax_Tabla() {
            ...
            $.ajax({
                "type": "POST",
                "url": "T_Recipiente.aspx/IRIS_WEBF_BUSCA_TP_RECIPIENTE",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Update() {
            ...
            $.ajax({
                "type": "POST",
                "url": "T_Recipiente.aspx/IRIS_WEBF_UPDATE_TP_RECIPIENTE",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Guardar() {
            ...
            $.ajax({
                "type": "POST",
                "url": "T_Recipiente.aspx/IRIS_WEBF_GRABA_TP_RECIPIENTE",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Fill_DataTable() {
            ...
            for (i = 0; i < Mx_Dtt.length; i++) {
                $("#DataTable tbody").append(
                    $("<tr>", {
                        "onclick": `Ajax_Codiguin("` + Mx_Dtt[i].GMUE_COD + `","` + Mx_Dtt[i].GMUE_DESC + `","` + Mx_Dtt[i].ID_ESTADO + `","` + Mx_Dtt[i].ID_G_MUESTRA + `")`,
                        "class": "manito"
                    }).append(
                        $("<td>", { "align": "left" }, { "class": "textoReducido" }).text(i + 1),
                        $("<td>", { "align": "left" }, { "class": "textoReducido" }).text(Mx_Dtt[i].GMUE_COD),
                        $("<td>", { "align": "left" }, { "class": "textoReducido" }).text(Mx_Dtt[i].GMUE_DESC),

...
Public Class AVIS_C_D_VER
    Inherits System.Web.UI.Page

    <Services.WebMethod()>
    Public Shared Function Llenar_AVIS(ByVal AVIS As String, ByVal RUT As String, ByVal NOMBRE As String, ByVal APELLIDO As String, ByVal APELLIDO_MAT As String) As String
        ...
        If (AVIS <> "" And RUT = "" And NOMBRE = "" And APELLIDO = "" And APELLIDO_MAT = "") Then
            data_paciente = NN.IRIS_WEBF_HOST_BUSCA_DATOS_PACIENTE_Y_EXAMENES_POR_FOLIO_AVIS_2_global(AVIS)

        ElseIf (RUT <> "" And AVIS = "" And NOMBRE = "" And APELLIDO = "" And APELLIDO_MAT = "") Then
            data_paciente = NN.IRIS_WEBF_HOST_BUCA_DATOS_PACIENTE_POR_RUT_AVIS_GLOBAL(RUT)

        ElseIf ((NOMBRE <> "" Or APELLIDO <> "" Or APELLIDO_MAT <> "") And AVIS = "" And RUT = "") Then
            data_paciente = NN.IRIS_WEBF_HOST_BUCA_DATOS_PACIENTE_POR_RUT_AVIS_2_GLOBAL_POR_NOMBRE(NOMBRE, APELLIDO, APELLIDO_MAT)
        End If
    ...
    End Function
    '<Services.WebMethod()>
    'Public Shared Function Llenar_AVIS_FECHAS(ByVal DESDE As String, ByVal HASTA As String) As String
    '    'Declaraciones del Serializador
    '    Dim Serializer As New JavaScriptSerializer
    '    Dim str_Builder As New StringBuilder
    '    Dim datas As String = ""
    ...
    '    data_paciente = NN.IRIS_WEBF_HOST_BUSCA_DATOS_PACIENTE_Y_EXAMENES_POR_FOLIO_AVIS_2_global(DESDE, HASTA)

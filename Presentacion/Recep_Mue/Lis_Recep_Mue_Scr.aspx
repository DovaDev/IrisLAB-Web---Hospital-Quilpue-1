<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Lis_Recep_Mue_Scr.aspx.vb" Inherits="Presentacion.Lis_Recep_Mue_Scr" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
        ...
        var Mx_Dtt_LugarTM = [
    {
        ...
        function Ajax_LugarTM() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Lis_Recep_Mue_Scr.aspx/Llenar_Ddl_LugarTM",
                //"data": Data_Par,
        ...
        var Mx_Exam = [
    {
        ...
        function Ajax_Exam() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Lis_Recep_Mue_Scr.aspx/Llenar_Ddl_Exam",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Lis_Recep_Mue_Scr.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_Excel = [
    {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Lis_Recep_Mue_Scr.aspx/Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
    ...
    <script>
        ...
        function Fill_Ddl_Exam() {
            ...
            for (y = 0; y < Mx_Exam.length; ++y) {
                if (Mx_Exam[y].ID_CODIGO_FONASA == 1054) {
                    $("<option>", {
    ...
    <script>
        ...
        function Ajax_DataTable_examen3(id, cod) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Lis_Recep_Mue_Scr.aspx/Llenar_tabla_exam",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
            ...
            <div class="card mb-3 border-bar">
                <div class="card-header bg-bar">
                    <h5 style="text-align: center; padding: 5px;">
                        ...
                        Listado de Estados de Exámenes Recepcionados: Screening Sífilis.
                    </h5>
                </div>

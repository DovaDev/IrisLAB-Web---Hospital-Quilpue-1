...
Public Class Rev_Deter_Exa_3
    ...
    Public Shared Function Llenar_DataTable(ByVal DESDE As String, ByVal HASTA As String,
        ...
        Data_Final = NN.IRIS_WEBF_BUSCA_EXAMEN_DET_ESTADISTICA_CHECK_TODOS_2_2_AND_ID_ATE_RES_CON_ARRAY_ID_PER(CDate(DESDE), CDate(HASTA), ID_CF, MUESTRA)
    ...
    <Services.WebMethod()>
    Public Shared Function Llenar_DataTable_2(ByVal DESDE As String, ByVal HASTA As String) As String
        'Declaraciones del Serializador
        Dim Serializer As New JavaScriptSerializer
        Dim str_Builder As New StringBuilder
        'Declaraciones internas
        ...
        Data_Final = NN.IRIS_WEBF_BUSCA_EXAMEN_DET_ESTADISTICA_CHECK_TODOS_2_2_AND_ID_ATE_RES_MARCADOS(CDate(DESDE), CDate(HASTA))
    ...
    <Services.WebMethod()>
    Public Shared Function IRIS_WEBF_UPDATE_DET_ATENCION_ATE_RESULTADO_NOTIFICACION_AVISO(ByVal SELECTED() As Object) As String
        'Declaraciones del Serializador
        Dim Serializer As New JavaScriptSerializer
        Dim str_Builder As New StringBuilder
        Dim datas As String = ""
        ...
        If SELECTED.Length > 0 Then
            For i = 0 To SELECTED.Length - 1
                ...
                If elemento.Length > 1 Then
                    data_det_ate = NN_Det_Ate.IRIS_WEBF_UPDATE_DET_ATENCION_ATE_RESULTADO_NOTIFICACION_AVISO(CInt(elemento(0)), CInt(elemento(1)), CInt(elemento(2)))
                End If

                'SELECTED(0) ID_ATENCION 
                'SELECTED(1) ID_COND_FONASA
                'SELECTED(2) ID_ATE_RES
    ...
    Public Shared Function Excel(ByVal DOMAIN_URL As String,
                                 ...
                                 ByVal HASTA As String) As String
        ...
        If (Data_Final.Count > 0) Then
            ...
            For y = 0 To (Data_Final.Count - 1)
                ...
                Mx_Data(5, y) = Data_Final(y).PAC_NOMBRE + " " + Data_Final(y).PAC_APELLIDO

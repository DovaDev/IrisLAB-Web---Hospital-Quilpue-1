<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Env_Mues_Lab.aspx.vb" Inherits="Presentacion.Env_Mues_Lab" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            //AJAX VER PENDIENTES
            $("#Btn_Ver_Pendiente").click(function () {
            ...
            //$("#Btn_agregar_todas_de_una").click(function (){
            //    $("#modal_agregar_de_una").modal('hide');
            //    Guardar_de_una();
            //});

            //$("#Btn_agregar_de_una").click(function () {
            //    modal_show();
            //    Ajax_Info_Asereje();
    ...
    <script>
        ...
        function Ajax_DataTable_Load() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Env_Mues_Lab.aspx/Form_Table",
                //"data": Data_Par,
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Env_Mues_Lab.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
                    ...
                    if (json_receiver != "null") {
                        try {
                            parsedJson = JSON.parse(json_receiver);
                        } catch (e) {
                            parsedJson = null;
                        }
                        if (json_receiver == "sin-tm" || (parsedJson && parsedJson[0].ATE_ID_ESTADO_TM !== 8)) {
                            Hide_Modal();

                            Swal.fire({
                                icon: 'warning',
                                title: 'No se puede enviar',
                                text: 'No se puede enviar una muestra que no tenga completa la toma de muestra',
                        ...
                        if (json_receiver == "recepcionada") {
                            ...
                            //Hide_Modal();
                            //$("#modal_agregar_de_una").modal('hide');
                            //$("#modal_agregar_de_una").modal('show');
        ...
        function Ajax_Info_Exa_Asereje() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Env_Mues_Lab.aspx/Exa_Info",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Guardar_de_una() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Env_Mues_Lab.aspx/Guardar_de_una",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Marcar_Guardar() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Env_Mues_Lab.aspx/Llenar_DataTable_Marcar",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable_Marcar() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Env_Mues_Lab.aspx/Llenar_DataTable3",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Ver_Pendientes() {
            $.ajax({
                "type": "POST",
                "url": "Env_Mues_Lab.aspx/Ajax_Ver_Pendiente",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
                    var json_receiver = JSON.parse(response.d);
                    if (json_receiver !== null) {
                        $("#eModal_Pend").modal("show");
                        Mx_Pendientes = json_receiver
                        $("#Div_Ver_Pendientes").empty();
                        Fill_DataTable_Pendientes();
                    } else {
                        $("#eModal_Pend").modal("hide");
                        $("#mError_AAH h4").text("Sin resultados");
                        $("#mError_AAH button").attr("class", "btn btn-danger");
                        $("#mError_AAH p").text("No se han encontrado muestras pendientes.");
                        $("#mError_AAH").modal();
                    }
                },
                "error": function (response) {
        ...
        function Ajax_Pendiente_Marcar() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Env_Mues_Lab.aspx/Ajax_Pendiente_Marcar",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        //-------------------------------------------------- TABLA VER PENDIENTES -------------------------------------------------------------|
        function Fill_DataTable_Pendientes() {
            $("<table>", {
                "id": "DataTable_Ver_Pendientes",
                "class": "display",
                "width": "100%",
                "cellspacing": "0"
            }).appendTo("#Div_Ver_Pendientes");

            $("#DataTable_Ver_Pendientes").append(
                $("<thead>"),
                $("<tbody>")
            );
            $("#DataTable_Ver_Pendientes").attr("class", "table table-hover table-striped table-iris");
            $("#DataTable_Ver_Pendientes thead").attr("class", "cabezera2");

            $("#DataTable_Ver_Pendientes thead").append(
                $("<tr>").append(
                    $("<th>", { "class": "textoReducido" }).text("#"),
                    $("<th>", { "class": "textoReducido" }).text("Etiqueta"),
                    $("<th>", { "class": "textoReducido" }).text("Examen Fonasa"),
                    $("<th>", { "class": "textoReducido" }).text("Fecha Pend."),
                    $("<th>", { "class": "textoReducido" }).text("Hora Pend."),
            ...
            Mx_Pendientes.forEach((item, index) => {
                console.log(`ÌTEMMMM : ${item}`)
                $("#DataTable_Ver_Pendientes tbody").append(
                    $("<tr>").append(
                        $("<td>", { "align": "left" }, { "class": "textoReducido2" }).text(index + 1),
                        $("<td>", { "align": "left" }, { "class": "textoReducido2" }).text(`[${item.CB_DESC}] ${item.T_MUESTRA_DESC}`),
                        $("<td>", { "align": "left" }, { "class": "textoReducido2" }).text(item.CF_DESC),
                        $("<td>", { "align": "left", "class": "textoReducido2" }).text(function () {
                            // Obtener valores
                            var dateStr = item.FECHA_PEND;
                        ...
                        $("<td>", { "align": "left" }, { "class": "textoReducido2" }).text(`${item.PAC_NOMBRE} ${item.PAC_APELLIDO}`),
                        $("<td>", { "align": "left" }, { "class": "textoReducido2" }).text(item.ATE_NUM),
                        $("<td>", { "align": "left" }, { "class": "textoReducido2" }).text(item.USU_NIC),
                        $("<td>", { "align": "left" }, { "class": "textoReducido2" }).text("")
                    )
                );
            })
            $("#DataTable_Ver_Pendientes tbody tr").click(function () {
                $("#DataTable_Ver_Pendientes tbody tr").removeClass("active");
        ...
        function Llenar_Modal_Cargar_Doble_click(NUM_ATE) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Env_Mues_Lab.aspx/Llenar_Modal_Cargar_Doble_click",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Guardar_Lote() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Env_Mues_Lab.aspx/Guardar_Lote",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Guardar_Lote_2(correlativin2) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Env_Mues_Lab.aspx/Guardar_Lote2",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Ver_Lotes_Anteriores() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Env_Mues_Lab.aspx/IRIS_WEBF_BUSCA_CANTIDAD_LOTE_RECEPCIONADO",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Muestras_Lotes(NUMLOTE) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Env_Mues_Lab.aspx/IRIS_WEBF_BUSCA_LOTE_RECEPCIONADO_LOTE_2",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Get_values_to_Pendiente2(CBB, ATE_NUMM) {
        ...
        function Fill_DataTable_Load() {
            ...
            $("#DataTable_Load thead").append(
                $("<tr>").append(
                    ...
                    $("<th>", { "class": "textoReducido" }).text("Folio"),
                    $("<th>", { "class": "textoReducido" }).text("Usuario"),
                    //$("<th>").css("text-align", "right").html("<div class='checkbox checkbox-success pz' style='margin-top:-37px;'><input type='checkbox' class='manitos2' id='Hasdasd" + i + "'/><label class='manitos2' for='Hasdasd" + i + "'></label></div>")
            ...
            for (i = 0; i < Mx_Dtt_Load.length; i++) {
                ...
                $("#DataTable_Load tbody").append(
                    $("<tr>", {
                        ...
                        $("<td>").css("text-align", "center").text(function () {
                            $(this).html("<div class='checkbox checkbox-success pz' style='margin-top:-3px;'><input type='checkbox' value='" + Mx_Dtt_Load[i].CB_DESC + "~" + Mx_Dtt_Load[i].ATE_NUM + "~" + Mx_Dtt_Load[i].ATE_NUM_OMI + "~" + Mx_Dtt_Load[i].ATE_CODIGO_TEST + "~" + Mx_Dtt_Load[i].ID_ATENCION + "~" + Mx_Dtt_Load[i].ID_CODIGO_FONASA + "~" + Mx_Dtt_Load[i].CF_DESC + "~" + Mx_Dtt_Load[i].ATE_CF_MULTIPLICADOS + "' class='manitos2' id='Hasdasd" + i + "'/><label class='manitos2' for='Hasdasd" + i + "'></label></div>")
                        })
                        //$("<td>").css("text-align", "right").html("<div class='checkbox checkbox-success pz' style='margin-top:-19px;'><input type='checkbox' class='manitos2' id='Hasdasd" + i + "'/><label class='manitos2' for='Hasdasd" + i + "'></label></div>")
                    )
                );
                ...
                $("#DataTable_Antiguos tbody").append(
                    $("<tr>").append(
                        ...
                        $("<td>", { "align": "left" }, { "class": "textoReducido" }).text(function () {
                            ...
                            if (fecha == "01/01/0001" || fecha == "31/12/0000") {
                                return "-/-";
                            } else {
                                return fecha;
                            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
  ...
  <div id="xxx_xxx">
    ...
    <!--  Modal Ver Pendientes-->
     <div class="modal fade" id="eModal_Pend" tabindex="-1" role="dialog" aria-labelledby="eModalLabel">
     <div class="modal-dialog modal-lg" role="document" style="max-width:60vw">
         <div class="modal-content">
             <div class="modal-header">
             ...
             <div class="modal-body">
                 <div id="Div_Ver_Pendientes" style="width: 100%; height: 400px; overflow: auto;" class="table-responsive"></div>
             </div>
             <div class="modal-footer">
<%--                 <button type="button" id="Btn_Anterior" class="btn btn-dark fa fa-arrow-circle-o-left"></button>
                 <button type="button" id="Btn_Siguiente" class="btn btn-dark fa fa-arrow-circle-o-right"></button>
...
<%--    <div id="modal_agregar_de_una" class="modal fade" role="dialog">
    ...
    <div class="row">
        ...
        <%--<div class="col">
            <button id="Btn_Ver_Pendiente" class="btn btn-danger btn-block" style="margin-bottom: 1vh; padding: 3px;" type="submit"><i class="fa fa-fw fa-clock-o mr-2"></i>Ver Pendientes</button>
        </div>--%>
        <div class="col">

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Recep_Mue.aspx.vb" Inherits="Presentacion.Recep_Mue" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Recep_Mue.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_Atencion_Asereje = [
{
    ...
    "ID_PACIENTE": 0
        ...
        function Ajax_Marcar_Guardar() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Recep_Mue.aspx/Llenar_DataTable_Marcar",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable_Ate_ONCLICK() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Recep_Mue.aspx/Llenar_DataTable2",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable_Marcar() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Recep_Mue.aspx/Llenar_DataTable3",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Pendiente_Marcar() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Recep_Mue.aspx/Ajax_Pendiente_Marcar",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Llenar_Modal_Cargar_Doble_click(NUM_ATE) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Recep_Mue.aspx/Llenar_Modal_Cargar_Doble_click",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Guardar_Lote() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Recep_Mue.aspx/Guardar_Lote",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Guardar_Lote_2(correlativin2) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Recep_Mue.aspx/Guardar_Lote2",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Ver_Lotes_Anteriores() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Recep_Mue.aspx/IRIS_WEBF_BUSCA_CANTIDAD_LOTE_RECEPCIONADO",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Muestras_Lotes(NUMLOTE) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Recep_Mue.aspx/IRIS_WEBF_BUSCA_LOTE_RECEPCIONADO_LOTE_2",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        //--------------------------------------------------- CLICK EN TABLA ----------------------------------------------------------|
        function Ajax_Get_values_to_Pendiente(CBB, ATE_NUMM) {
            ...
            for (i = 0; i < Mx_Dtt_Marcar.length; i++) {
                $("#DataTable_Antiguos tbody").append(
                    ...
                    $("<td>").css("text-align", "center").text(function () {
                        ...
                        $("<td>", { "align": "center" }, { "class": "textoReducido" }).text(function () {
                            let holiwi = moment(Mx_Dtt_Marcar[i].RECEP_ETI_FECHA).format("DD/MM/YYYY");
                            if (holiwi == "01/01/0001") {
                                return "-/-";
                            }
                            else {
                                return holiwi;
                        ...
                        $("<td>", { "align": "center" }, { "class": "textoReducido" }).text(function () {
                            let holowo = moment(Mx_Dtt_Marcar[i].RECEP_ETI_FECHA).format("HH:mm:ss");
                            if (holowo == "00:00:00") {
                                return "-/-";
                            } else {
                                return holowo;

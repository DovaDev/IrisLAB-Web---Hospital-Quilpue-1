<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="HT_LugarTM.aspx.vb" Inherits="Presentacion.HT_LugarTM" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    <script>
        ...
        function Ajax_LugarTM() {
            ...
            $.ajax({
                "type": "POST",
                "url": "HT_LugarTM.aspx/Llenar_Ddl_LugarTM",
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
                    var json_receiver = response.d;
                    if (json_receiver != null) {
                        Mx_PRO = json_receiver;
        ...
        function Ajax_DataTable() {
            ...
            Rutaa = "HT_LugarTM.aspx/Llenar_DataTable_2";
     ...
     "urls": ""
        ...
        function Fill_DataTable() {
            ...
            $("#DataTable thead").append(
                ...
                $("<th>", {"class":  "textreducido" }).text("Ate. Obs.")
                )
            );
            ...
            for (i = 0; i < Mx_Dtt.length; i++) {
                ...
                $("#DataTable tbody").append(
                    $("<tr>", {
                        ...
                        $("<td>", {"align":  "left" }, {"class": "textreducido"}).text(Mx_Dtt[i].ATE_OBS_TM)
                  )
                );
                cont = cont + 1;
            }
            ...
            <div class="card mb-3 border-bar">
                <div class="card-header bg-bar p-1">
                    <h5 style="text-align: center; padding: 5px;">
                        ...
                        Listado de hoja de trabajo por Procedencia
                    </h5>
                </div>
                <div class="card-body">

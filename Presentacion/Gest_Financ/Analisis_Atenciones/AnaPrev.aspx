<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="AnaPrev.aspx.vb" Inherits="Presentacion.AnaPrev" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function Ajax_Ddl_Prev() {
            ...
            $.ajax({
                "type": "POST",
                "url": "AnaPrev.aspx/Llenar_Ddl_Prev",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function AJAX_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "AnaPrev.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
        ...
        <div class="card-header bg-bar">
            <h5>Cantidad Anual Análisis por Previsión</h5>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg">

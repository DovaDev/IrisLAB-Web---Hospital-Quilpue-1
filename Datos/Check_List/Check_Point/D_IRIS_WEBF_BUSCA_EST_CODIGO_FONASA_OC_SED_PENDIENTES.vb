...
Public Class D_IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_OC_SED_PENDIENTES
    ...
    Function IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_OC_SED_PENDIENTES(ByVal DESDE As Date, ByVal HASTA As Date) As List(Of E_IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_OC_SED_PENDIENTES)
        ...
        'Declaraciones 'lista'
        Dim E_Proc_Item As E_IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_OC_SED_PENDIENTES
        Dim E_Proc_List As New List(Of E_IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_OC_SED_PENDIENTES)

        'Configuración general
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_OC_SED_PENDIENTES"
        ...
        While Obj_Reader.Read
            E_Proc_Item = New E_IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_OC_SED_PENDIENTES
            ...
            E_Proc_Item.ATE_DET_V_ID_ESTADO = DD_GEN.DB_NULL(Obj_Reader, 18, Nothing)

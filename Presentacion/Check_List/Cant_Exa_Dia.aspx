<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Cant_Exa_Dia.aspx.vb" Inherits="Presentacion.Cant_Exa_Dia" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
        ...
        var Mx_Exam = [
    {
        ...
        function Ajax_Exam() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Cant_Exa_Dia.aspx/Llenar_Ddl_Exam",
                //"data": Data_Par,
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Cant_Exa_Dia.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_Det_Ate = [
  {
      ...
      "ENCRYPTED_ID": 0
        ...
        function Ajax_DataTable_Det_Ate(ID_ATE,yyyy) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Cant_Exa_Dia.aspx/Llenar_DataTable_Det_Ate",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
    ...
    <script>
        ...
        function Fill_Ddl_Exam() {
            ...
            if (procee == 0) {
                ...
                ).text("Todos").appendTo("#Ddl_Exam");
                Mx_Exam.forEach(aaa => {
                    $("<option>",
                        {
                            "value": aaa.ID_PROCEDENCIA
                        }
                    ).text(aaa.PROC_DESC).appendTo("#Ddl_Exam");
                });
            }
            else {
                Mx_Exam.forEach(aaa => {
        ...
        function Fill_DataTable() {
            ...
            $("#DataTable thead").append(
                $("<tr>").append(
                    ...
                    $("<th>", { "class": "textoReducido  text-center" }).text("Cantidad"),
                        ...
                        $("<td>").css("text-align", "center").text(function () {
                            if (i > 0) {
                                if (Mx_Dtt[i - 1].ATE_NUM == Mx_Dtt[i].ATE_NUM) {
                                    ...
                                    $(this).css("cssText", "text-align:center;").text(Mx_Dtt[i].CANT);
                                }
                            } else {
                                $(this).css("cssText", "text-align:center;").text(Mx_Dtt[i].CANT);
                            }
            ...
            $("#DataTable tbody").append(
                    $("<tr>").append(
                        ...
                        $("<td>", { "align": "left" }).text(""),
                        $("<td>").css("text-align", "center").text(function () {
                            $(this).css("cssText", "text-align:left; font-weight: 700;").text("TOTALES: ");
                        }),
                        $("<td>").css("text-align", "center").text(function () {
                            $(this).css("cssText", "text-align:center; font-weight: 700;").text(totales);
                        }),
                        $("<td>", { "align": "left" }).text(),
                        $("<td>", { "align": "left" }).text()
                        ));
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
    ...
    <div class="row">
        ...
        <h5 style="text-align: center; padding: 5px;">
            ...
            Cantidad de Exámenes por Paciente
        </h5>
    </div>
    ...
    <div class="row mb-3" style="margin-left:2px; margin-right: 2px;">
        ...
        <div class="col-md">
            <label for="Ddl_Exam">Lugar de TM:</label>
    ...
    <div class="row" id="Id_Conte">
        <div class="col-md-12" id="Paciente">
            ...
            <h5 style="text-align: center; padding: 5px; font-size: 15px;"><i class="fa fa-list"></i>Listado de Atenciónes</h5>

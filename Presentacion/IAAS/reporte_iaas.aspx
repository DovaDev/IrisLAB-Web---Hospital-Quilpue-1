<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="reporte_iaas.aspx.vb" Inherits="Presentacion.reporte_iaas" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#Btn_Buscar").click(function () {
                if ($("#txtNAte").val() == "") {
                    $("#mError_AAH h4").text("Ingrese Folio");
    ...
    <script>
        ...
        function Ajax_DDL_RECHAZOS_ACTIVOS() {
            $.ajax({
                "type": "POST",
                "url": "/Check_List/Check_Point/Traza_Folio.aspx/DDL_TIPO_RECHAZO_ACTIVOS",
                //"data": Data_Par,
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "reporte_iaas.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
                    ...
                    if (json_receiver != "null") {
                        ...
                        console.log("DATOS: ", Mx_Dtt)

                        console.log("CUP", Mx_Dtt[0].CUP);
                        console.log("CVC", Mx_Dtt[0].CVC);
                        console.log("PICC LINE", Mx_Dtt[0].PICCLINE);
                        console.log("TET", Mx_Dtt[0].TET);
                        console.log("TQT", Mx_Dtt[0].TQT);
                        console.log("Sospecha de AREpi", Mx_Dtt[0].AREpi);
        ...
        var Mx_Dtt_Det_Ate = [
    {
        ...
        function Ajax_DataTable_Det_Ate(ID_ATE, yyy) {
            ...
            $.ajax({
                "type": "POST",
                "url": "/Check_List/Check_Point/Traza_Folio.aspx/Llenar_DataTable_Det_Ate",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_Excel = [
    {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                //"url": "/Check_List/Check_Point/Traza_Folio.aspx/Excel",
                "url": "reporte_iaas.aspx/Excel", // Cambio de URL
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Fill_DataTable() {
            ...
            $("#DataTable thead").append(
                $("<tr>").append(
                    ...
                    $("<th>", { "class": "textoReducido text-center" }).text("Usuario"),
                    $("<th>", { "class": "textoReducido text-center" }).text("Fecha/Hora"),
                    $("<th>", { "class": "textoReducido text-center" }).text("USO de DIP"),
                    $("<th>", { "class": "textoReducido text-center" }).text("CUP"),
                    $("<th>", { "class": "textoReducido text-center" }).text("CVC"),
                    $("<th>", { "class": "textoReducido text-center" }).text("PICC LINE"),
                    $("<th>", { "class": "textoReducido text-center" }).text("TET"),
                    $("<th>", { "class": "textoReducido text-center" }).text("TQT"),
                    $("<th>", { "class": "textoReducido text-center" }).text("Sospecha de AREpi"),
                    ...
                    $("#DataTable tbody").append(
                        $("<tr>", {
                            ...
                            $("<td>", { "align": "center" }, { "class": "textoReducido" }).text(function () {
                                ...
                                if (Mx_Dtt[i].ATE_EST_TM_DESC == "SI"){
                                    $(this).css("cssText", "text-align:center; background-color:#82a9ff;").text("SI");
                                }
                                else {
                                    $(this).css("cssText", "text-align:center;").text("");
                            ...
                            // Añadir DIP
                            // Si CUP CVC PICC LINE TET TQT son 0 entonces USO DIP es NO
                            // Si CUP CVC PICC LINE TET TQT son 1 entonces USO DIP es SI
                            
                            $("<td>", { "align": "center" }, { "class": "textoReducido" }).text(function () {
                                console.log("Dato",Mx_Dtt[i].ATE_EST_TM_DESC)
                                // if (Mx_Dtt[i].ATE_EST_TM_DESC == "SI") {
                                    if (Mx_Dtt[i].CUP == 0 && Mx_Dtt[i].CVC == 0 && Mx_Dtt[i].PICCLINE == 0 && Mx_Dtt[i].TET == 0 && Mx_Dtt[i].TQT == 0) {
                                        $(this).css("cssText", "text-align:center; background-color:#ff4f4f;").text("NO")
                                    } else {
                                        $(this).css("cssText", "text-align:center; background-color:#ffcf87;").text("SI")
                                    }
                                // } else {
                            ...
                            // Colocar un check con tick si el dato es 1 y sin tick si es 0

                            $("<td>", { "align": "center" }, { "class": "textoReducido" }).html(function () {
                                var isChecked = Mx_Dtt[i].CUP == 1;
                                // if (Mx_Dtt[i].ATE_EST_TM_DESC == "SI") {
                                    return '<span style="pointer-events: none;">' +
                            ...
                            $("<td>", { "align": "center" }, { "class": "textoReducido" }).html(function () {
                                var isChecked = Mx_Dtt[i].PICCLINE == 1;
                                // if (Mx_Dtt[i].ATE_EST_TM_DESC == "SI") {
                                    return '<span style="pointer-events: none;">' +
                                        '<input type="checkbox"' + (isChecked ? ' checked' : '') +
                                        ' style="pointer-events: none;" onclick="return false;">' +
         ...
         <div class="card mb-3 border-bar">
             <div class="card-header bg-bar">
                 <h5 style="text-align: center; padding: 5px;">
                     ...
                     Trazabilidad de Muestra por Folio de Atención con Uso de DIP y Sospecha de AREpi 
                 </h5>
             </div>
             <div class="card-body">
                                 <div class="row mb-3" style="margin-left: 2px; margin-right: 2px;">
                 <div class="col-md">
                     <label for="txtNAte">N° Folio:</label>

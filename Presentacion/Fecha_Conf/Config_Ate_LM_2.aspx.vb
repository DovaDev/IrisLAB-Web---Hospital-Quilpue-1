...
Public Class Config_Ate_LM_2
    ...
    End Function
    <Services.WebMethod()>
    Public Shared Function Guardar_Conf_Examenes(ByVal ID_PRO As String, ByVal FECHA As String, ByVal CANT As String, ByVal normal As String, ByVal prioritario As String, ByVal espontaneo As String) As Integer
        'Declaraciones del Serializador
        Dim Serializer As New JavaScriptSerializer
        Dim str_Builder As New StringBuilder
        Dim datas As String = ""
        ...
        numerito = NN.IRIS_WEBF_GRABA_CONF_EXAMENES_2(ID_PRO, FECHA, CANT, normal, prioritario, espontaneo)
        'Serializar con JSON
        Serializer.MaxJsonLength = 999999999
    ...
    End Function
    <Services.WebMethod()>
    Public Shared Function Modificar_Conf_Examenes(ByVal ID_CONF As String, ByVal CANTIDAD As String, ByVal ID_ESTADO As String, ByVal normal As String, ByVal prioritario As String, ByVal espontaneo As String) As Integer
        'Declaraciones del Serializador
        Dim Serializer As New JavaScriptSerializer
        Dim str_Builder As New StringBuilder
        Dim datas As String = ""
        ...
        Dim numerito As Integer
        numerito = NN.IRIS_WEBF_UPDATE_CONF_DIAS_EXAMEN_NEW(ID_CONF, CANTIDAD, ID_ESTADO, normal, prioritario, espontaneo)
        'Serializar con JSON
        Serializer.MaxJsonLength = 999999999
        Serializer.Serialize(numerito, str_Builder)
        datas = str_Builder.ToString

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="IN_PAC_AVIS.aspx.vb" Inherits="Presentacion.IN_PAC_AVIS" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function Ajax_guardar() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_AVIS.aspx/Guardar_TodoByVal",
        ...
        var Mx_Dtt_exam02_respaldo = [
  {
      ...
      "CF_DIAS": 0,
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_AVIS.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Ddl = [
    {
        ...
        function Call_AJAX_Ddl() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_AVIS.aspx/Llenar_Ddl_LugarTM",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_Diag2 = [
{
    ...
    <script>
        ...
        function Fill_DL_AVIS() {
            ...
            $("#Ape").val(Mx_AVIS[0].HO_ApellidoPaterno + " " + Mx_AVIS[0].HO_ApellidoMaterno);
            $("#fecha").val(ffmm);
            $("#Edad").val(function () {
                var asd = ffmm;
                var array = asd.split("-");
            ...
            if (parseInt8(x_AVIS[0].HO_ProcedenciaCodigo) == 0) {
                        ...
                        <div class="col-sm">
                            ...
                            <div class="input-group" style="height: 31.75px;">
                                ...
                                <span class="input-group-btn">
                                    <button class="btn btn-success" type="button" style="font-size: 11px;">Sin RUT</button>
                                </span>
                            </div>
                        </div>
                            <div class="col-sm">
                                <label class="textoReducido">RUT:</label>
                                <input type='text' style="font-weight:900;"  id="rut" class="form-control textoReducido" placeholder="12.345.789-0" />
                            </div>
                            <div class="col-sm">

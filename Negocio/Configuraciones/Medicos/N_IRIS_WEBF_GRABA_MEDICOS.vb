Imports Datos
Imports Entidades
Public Class N_IRIS_WEBF_GRABA_MEDICOS
    'Declaraciones Generales
    Dim DD_Data As D_IRIS_WEBF_GRABA_MEDICOS
    Sub New()
        DD_Data = New D_IRIS_WEBF_GRABA_MEDICOS
    End Sub
    Function IRIS_WEBF_GRABA_MEDICOS(ByVal RUT_DOC As String,
        ...
        Return DD_Data.IRIS_WEBF_GRABA_MEDICOS(RUT_DOC, NOMBRE_DOC, APE_DOC, ID_SEXO, FNAC_DOC, ID_NACIONALIDAD, DIR_DOC, ID_CIU_COM, FONO1, FONO2, MOVIL1, MOVIL2, EMAIL_DESC, ID_ESPECIALIDAD, ID_ESTADO)
    End Function
End Class

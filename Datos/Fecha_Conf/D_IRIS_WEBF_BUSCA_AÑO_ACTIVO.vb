...
Public Class D_IRIS_WEBF_BUSCA_AÑO_ACTIVO
    Function D_IRIS_WEBF_BUSCA_AÑO_ACTIVO() As List(Of E_IRIS_WEBF_BUSCA_AÑO_ACTIVO)
        Dim objconexion As New Conexion.ConexionBD
        Dim Cmd_command As New OleDb.OleDbCommand
        Dim Obj_Read_Dt As E_IRIS_WEBF_BUSCA_AÑO_ACTIVO
        Dim List_Reader As New List(Of E_IRIS_WEBF_BUSCA_AÑO_ACTIVO)
        Dim Reader_Comm As OleDbDataReader
        Dim DD_GEN As New D_General_Functions
        'definiendo tipo de consulta a la BD
        Cmd_command.CommandType = CommandType.StoredProcedure
        Cmd_command.CommandText = "IRIS_WEBF_BUSCA_AÑO_ACTIVO"
        ...
        While Reader_Comm.Read
            Obj_Read_Dt = New E_IRIS_WEBF_BUSCA_AÑO_ACTIVO

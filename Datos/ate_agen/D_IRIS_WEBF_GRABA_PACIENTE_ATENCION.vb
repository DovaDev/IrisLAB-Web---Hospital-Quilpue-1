...
Public Class D_IRIS_WEBF_GRABA_PACIENTE_ATENCION
    ...
    Function IRIS_WEBF_GRABA_PACIENTE_ATENCION(ByVal RUT_PAC As String,
                                               ...
                                               ByVal PAC_NOM_SOCIAL As String) As String
        ...
        With Cmd_SQL
            ...
            .CommandText = "IRIS_WEBF_CMVM_GRABA_PACIENTE_ATENCION_NOM_SOCIAL"
        ...
        With Cmd_SQL.Parameters
            ...
            .Add("@ID_ETNIA", OleDbType.VarChar).Value = ID_ETNIA
            .Add("@PAC_NOM_SOCIAL", OleDbType.VarChar).Value = PAC_NOM_SOCIAL
            .Add("@RUT_PAC_VIH", OleDbType.VarChar).Value = ""
    ...
    Function IRIS_WEBF_GRABA_PACIENTE_ATENCION_GENERO(ByVal RUT_PAC As String,
                                               ...
                                               ByVal PAC_NOM_SOCIAL As String,
                                                      ByVal IS_NEO As Integer) As String
        'Checar Galletas) As Integer
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            '.CommandText = "IRIS_WEBF_CMVM_GRABA_PACIENTE_ATENCION"
            .CommandText = "IRIS_WEBF_CMVM_GRABA_PACIENTE_ATENCION_NOM_SOCIAL_GENERO_2"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Enviar parámetros
        With Cmd_SQL.Parameters
            ...
            .Add("@PAC_NOM_SOCIAL", OleDbType.VarChar).Value = PAC_NOM_SOCIAL
            .Add("@RUT_PAC_VIH", OleDbType.VarChar).Value = ""
            .Add("@ID_GENERO", OleDbType.VarChar).Value = ID_GENERO
            .Add("@IS_NEO", OleDbType.VarChar).Value = IS_NEO
    ...
    Function IRIS_WEBF_GRABA_PACIENTE_VIH_ATE(ByVal RUT_PAC As String,
        ...
        'Enviar parámetros
        With Cmd_SQL.Parameters
            .Add("@RUT_PAC", OleDbType.VarChar).Value = ""
            .Add("@NOMBRE_PAC", OleDbType.VarChar).Value = NOMBRE_PAC
            .Add("@APE_PAC", OleDbType.VarChar).Value = APE_PAC
            .Add("@FNAC_PAC", OleDbType.Date).Value = FNAC_PAC
            .Add("@ID_SEXO", OleDbType.Numeric).Value = ID_SEXO
            ...
            .Add("@ID_ETNIA", OleDbType.VarChar).Value = ID_ETNIA
            .Add("@PAC_NOM_SOCIAL", OleDbType.VarChar).Value = PAC_NOM_SOCIAL
            .Add("@RUT_PAC_VIH", OleDbType.VarChar).Value = RUT_PAC
        End With
        'Conectar con la Base de Datos
        Select Case CC_ConnBD.Oledbconexion.State
            Case ConnectionState.Open

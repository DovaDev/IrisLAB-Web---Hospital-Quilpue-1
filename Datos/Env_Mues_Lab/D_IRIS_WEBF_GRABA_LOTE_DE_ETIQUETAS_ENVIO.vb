...
Public Class D_IRIS_WEBF_GRABA_LOTE_DE_ETIQUETAS_ENVIO
    Function IRIS_WEBF_GRABA_LOTE_DE_ETIQUETAS_ENVIO(ByVal NUM_LOTE As Integer, ByVal ID_USUARIO As Integer) As List(Of E_IRIS_WEBF_GRABA_LOTE_DE_ETIQUETAS_ENVIO)
        ...
        'Declaraciones 'lista'
        Dim E_Proc_Item As E_IRIS_WEBF_GRABA_LOTE_DE_ETIQUETAS_ENVIO
        Dim E_Proc_List As New List(Of E_IRIS_WEBF_GRABA_LOTE_DE_ETIQUETAS_ENVIO)

        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_GRABA_LOTE_DE_ETIQUETAS_ENVIO"
        ...
        While Obj_Reader.Read
            E_Proc_Item = New E_IRIS_WEBF_GRABA_LOTE_DE_ETIQUETAS_ENVIO

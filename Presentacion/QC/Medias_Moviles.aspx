<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Medias_Moviles.aspx.vb" Inherits="Presentacion.Medias_Moviles" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">

    <script src="../js/HighCharts.js"></script>
    <script src="../js/HighC_Exporting.js"></script>
    <script src="Medias_Moviles.js"></script>
</asp:Content>

...
Public Class Ingreso_Ate_Avis
    ...
    Public Shared Function Guardar_TodoByVal(ByVal RUT_PAC As String,
                                             ...
                                             ByVal ID_GRUPO_PESQUISA As Integer) As String
        ...
        Else
            ...
            Else
                ...
                Else
                    ...
                    PREINGRESO2_PRO_SEC = cc.IRIS_WEBF_GRABA_PREINGRESO3_PRO_SEC_AVIS_NEW(correlativo,
                                                                             ...
                                                                             Programa,
                                                                             Sector,
                                                                             ATE_SAYDEX, DIAG1, DIAG2, sub_atencion, vih, 1, EMPRESA, 0)
                    Rpaciente = vv.IRIS_WEBF_UPDATE_PACIENTE_ATENCION(data_paciente2222(0).ID_PACIENTE, RUT_PAC, NOMBRE_PAC.ToUpper, APE_PAC.ToUpper, CDate(FNAC_PAC), ID_SEXO, ID_NACIONALIDAD, FONO1, MOVIL1, ID_CIU_COM, DIR_PAC.ToUpper, EMAIL_PAC, 1, OB.ToUpper, 1, ID_ETNIA, PAC_NOM_SOCIAL)
                End If
            ...
            id_atencion = ddx.IRIS_WEBF_GRABA_ATENCION_PROGRA2_PRO_SECTOR_AVIS(correlativo2,
                                                                         ...
                                                                         hocc,
                                                                               interno,
                                                                        data_atencion(0).ID_DIAGNOSTICO, data_atencion(0).ID_DIAGNOSTICO2, data_atencion(0).VIH, data_pac(0).DNI, OB, 1, "", "", "", EMPRESA, ID_GRUPO_PESQUISA)
            'id_atencion

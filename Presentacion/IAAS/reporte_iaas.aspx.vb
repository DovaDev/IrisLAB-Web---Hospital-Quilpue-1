...
Public Class reporte_iaas
    ...
    Public Shared Function Llenar_DataTable(ByVal TIPO As Integer,
        ...
        Data_Validado = NN.IRIS_WEBF_BUSCA_ETIQUETAS_NO_RECEPCIONADA_Y_OTRAS_RVDR_2_2_SECCCION_POR_FOLIO(TIPO, Date.Now, Date.Now, ID_PRE, ID_CF, ID_VAL, ID_NMUE, ID_SECCION, ATENUM, ID_ENVIO, ID_DERIVADO)

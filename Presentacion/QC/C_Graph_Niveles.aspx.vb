...
Public Class C_Graph_Niveles
    ...
    End Function
    <Services.WebMethod()>
    Public Shared Function IRIS_QC_BUSCA_TREEVIEW() As List(Of E_IRIS_QC_BUSCA_TREEVIEW)
        Dim dats As List(Of E_IRIS_QC_BUSCA_TREEVIEW)
        Dim NN As N_IRIS_QC_BUSCA_TREEVIEW = New N_IRIS_QC_BUSCA_TREEVIEW


        dats = NN.IRIS_QC_BUSCA_TREEVIEW()
    ...
    End Function
    <Services.WebMethod()>
    Public Shared Function IRIS_QC_BUSCA_DATOS_RESULTADO_POR_CRITERIOS20_ULT(ByVal ID_ANA As Long, ByVal ID_LOTE As Long, ByVal ID_DET As Long, ByVal N As Long) As List(Of E_IRIS_QC_BUSCA_DATOS_RESULTADO_POR_CRITERIOS20_2)
        ...
        dats = NN.IRIS_QC_BUSCA_DATOS_RESULTADO_POR_CRITERIOS20_ULT(ID_ANA, ID_LOTE, ID_DET, N)

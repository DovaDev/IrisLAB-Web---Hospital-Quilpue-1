...
Public Class D_IRIS_WEBF_BUSCA_CANTIDAD_EXAMEN_PACIENTE_POR_TM
    Function IRIS_WEBF_BUSCA_CANTIDAD_EXAMEN_PACIENTE_POR_TM(ByVal DESDE As Date, ByVal HASTA As Date, ByVal ID_CF As Integer) As List(Of E_IRIS_WEBF_BUSCA_CANTIDAD_EXAMEN_PACIENTE_POR_TM)
        ...
        With Cmd_SQL
            ...
            .CommandText = "IRIS_WEBF_BUSCA_CANTIDAD_EXAMEN_PACIENTE_POR_TM"
        ...
        With Cmd_SQL.Parameters
            ...
            .Add("@ID_PRE", OleDbType.Numeric).Value = ID_CF
        End With
        ...
        While Obj_Reader.Read
            ...
            E_Proc_Item.CANT = DD_GEN.DB_NULL(Obj_Reader, 5, Nothing)
            ...
            E_Proc_Item.ATE_TOTAL_PREVI = DD_GEN.DB_NULL(Obj_Reader, 9, Nothing)
            E_Proc_Item.ATE_TOTAL_COPA = DD_GEN.DB_NULL(Obj_Reader, 10, Nothing)
            E_Proc_Item.ATE_TOTAL = DD_GEN.DB_NULL(Obj_Reader, 11, Nothing)
            E_Proc_Item.SEXO_DESC = DD_GEN.DB_NULL(Obj_Reader, 12, Nothing)

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Rev_Deter_Exa_Vih_Res.aspx.vb" Inherits="Presentacion.Rev_Deter_Exa_Vih_Res" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
        ...
        var Mx_Exam = [
    {
        ...
        function Ajax_Exam() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_Vih_Res.aspx/Llenar_Ddl_Exam",
                //"data": Data_Par,
        ...
        function Call_AJAX_Ddl() {
            AJAX_Ddl = $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_Vih_Res.aspx/Llenar_Ddl_LugarTM",
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": data => {
                    Mx_Ddl = data.d;
        ...
        var Mx_Dtt_Det = [
    {
        ...
        function Ajax_Det() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_Vih_Res.aspx/Llenar_Ddl_Det",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_Vih_Res.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_Det_Ate = [
  {
      ...
      "ENCRYPTED_ID": 0
        ...
        function Ajax_DataTable_Det_Ate(ID_ATE) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_Vih_Res.aspx/Llenar_DataTable_Det_Ate",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_Excel = [
    {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_Vih_Res.aspx/Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
    ...
    <script>
        ...
        function Fill_Ddl_Exam() {
            ...
            $("<option>", { "value": 364 }).text("V.I.H.-4ta- Generacion(Ac.+Ag-P-24").appendTo("#Ddl_Exam");

        };

    </script>
    <script>
        function Ajax_Exa_Print(id_ate, per) {
            console.log("ATE " + id_ate + " PER: " + per);
            var loc = location.origin;
            //window.open(loc + "/Print_Ate/VerExamenesSolo.asp?dato1=" + (ateIDD * 2) + "&dato2=" + (ateIDD * 5) + "&dato3=" + (per) + "&dato4=" + (per * 5));
            window.open(loc + "/Print_Ate/VerExamenesSoloAVISVIH.asp?id_cliente=" + id_ate + "&id_perfil=" + per);
        }
        ...
        function Fill_DataTable() {
            ...
            $("#DataTable thead").append(
                $("<tr>").append(
                    ...
                    $("<th>", { "class": "textoReducido text-center" }).text("PDF")
                )
            );
                        ...
                        $("#DataTable tbody").append(
                            $("<tr>", {
                                ...
                                $("<td>").css("text-align", "center").text((function () {
                                  ...
                                  $("<td>").css("text-align", "center").text(function () {
                                      if ((Mx_Dtt[i].ATE_EST_VALIDA == 6 || Mx_Dtt[i].ATE_EST_VALIDA == 14 || Mx_Dtt[i].ATE_EST_VALIDA == "6" || Mx_Dtt[i].ATE_EST_VALIDA == "14") && (Mx_Dtt[i].ATE_EST_RECHAZO != 16 || Mx_Dtt[i].ATE_EST_RECHAZO != "16")) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
    ...
    <div class="row">
        ...
        <h5 style="text-align: center; padding: 5px;">
            ...
            Listado de exámenes con Resultados VIH
        </h5>
    </div>

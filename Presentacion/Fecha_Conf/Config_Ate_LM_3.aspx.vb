...
Public Class Config_Ate_LM_3
    ...
    Public Shared Function Llenar_Tabla(ByVal ID_PRO As Integer, ByVal FECHA As String) As String
        ...
        Data_BUSC_DIAS_CONF_ATE_PROC = NN_BUSC_DIAS_CONF_ATE_PROC.IRIS_WEBF_BUSCA_DIAS_CONF_ATENCIONES_PROCEDENCIA2_NEW(ID_PRO, FECHA)
        ...
        Dim Resp As New List(Of Nose222)
        Dim fcomp = ""
        Dim x = 0
        For dd = 1 To days
            Dim di As String = ""
            ...
            If (Data_BUSC_DIAS_CONF_ATE_PROC.Count <> 0 And x < Data_BUSC_DIAS_CONF_ATE_PROC.Count) Then
                If (Data_BUSC_DIAS_CONF_ATE_PROC(x).CONF_DIAS_FECHA.Equals(Date_01)) Then
                    ...
                    Item_REEEE.N_AGEND_CUPO_NORMAL = Data_BUSC_DIAS_CONF_ATE_PROC(x).AGEND_CUPO_NORMAL
                    Item_REEEE.N_AGEND_PRIORITARIO = Data_BUSC_DIAS_CONF_ATE_PROC(x).AGEND_PRIORITARIO
                    Item_REEEE.N_AGEND_ESPONTANEO = Data_BUSC_DIAS_CONF_ATE_PROC(x).AGEND_ESPONTANEO
                    Item_REEEE.N_ESTADO = 1
                    Item_REEEE.N_ID = Data_BUSC_DIAS_CONF_ATE_PROC(x).ID_CONF_DIAS
                    Item_REEEE.n_AGEND_COMENTARIO_2 = Data_BUSC_DIAS_CONF_ATE_PROC(x).AGEND_COMENTARIO
                ...
                Else
                    ...
                    Item_REEEE.N_AGEND_CUPO_NORMAL = 0
                    Item_REEEE.N_AGEND_PRIORITARIO = 0
                    Item_REEEE.N_AGEND_ESPONTANEO = 0
                    Item_REEEE.N_ID = "NULL"
                    Item_REEEE.N_ESTADO = 0
                    Item_REEEE.n_AGEND_COMENTARIO_2 = ""
                    Resp.Add(Item_REEEE)
                End If
            Else
                Dim Item_REEEE = New Nose222
    ...
    End Function
    <Services.WebMethod()>
    Public Shared Function Guardar_Conf_Examenes(ByVal ID_PRO As String, ByVal FECHA As String, ByVal CANT As String, ByVal normal As String, ByVal prioritario As String, ByVal espontaneo As String, ByVal COMENTARIO As String) As Integer
        'Declaraciones del Serializador
        Dim Serializer As New JavaScriptSerializer
        Dim str_Builder As New StringBuilder
        Dim datas As String = ""
        ...
        numerito = NN.IRIS_WEBF_GRABA_CONF_EXAMENES_2(ID_PRO, FECHA, CANT, normal, prioritario, espontaneo, COMENTARIO)
        'Serializar con JSON
        Serializer.MaxJsonLength = 999999999
    ...
    End Function
    <Services.WebMethod()>
    Public Shared Function Modificar_Conf_Examenes(ByVal ID_CONF As String, ByVal CANTIDAD As String, ByVal ID_ESTADO As String, ByVal normal As String, ByVal prioritario As String, ByVal espontaneo As String, ByVal COMENTARIO As String) As Integer
        'Declaraciones del Serializador
        Dim Serializer As New JavaScriptSerializer
        Dim str_Builder As New StringBuilder
        Dim datas As String = ""
        ...
        Dim numerito As Integer
        numerito = NN.IRIS_WEBF_UPDATE_CONF_DIAS_EXAMEN_NEW(ID_CONF, CANTIDAD, ID_ESTADO, normal, prioritario, espontaneo, COMENTARIO)
        'Serializar con JSON
        Serializer.MaxJsonLength = 999999999
        Serializer.Serialize(numerito, str_Builder)
        datas = str_Builder.ToString
...
Public Class Nose222
    ...
    Private AGEND_CUPO_NORMAL As String
    Public Property N_AGEND_CUPO_NORMAL() As String
        Get
            Return AGEND_CUPO_NORMAL
        End Get
        Set(value As String)
            AGEND_CUPO_NORMAL = value
        End Set
    End Property
    Private AGEND_PRIORITARIO2 As String
    Public Property N_AGEND_PRIORITARIO() As String
        Get
            Return AGEND_PRIORITARIO2
        End Get
        Set(value As String)
            AGEND_PRIORITARIO2 = value
        End Set
    End Property
    Private AGEND_ESPONTANEO2 As String
    Public Property N_AGEND_ESPONTANEO() As String
        Get
            Return AGEND_ESPONTANEO2
        End Get
        Set(value As String)
            AGEND_ESPONTANEO2 = value
        End Set
    End Property
    Private AGEND_COMENTARIO_2 As String
    Public Property n_AGEND_COMENTARIO_2() As String
        Get
            Return AGEND_COMENTARIO_2
        End Get
        Set(value As String)
            AGEND_COMENTARIO_2 = value
        End Set
    End Property

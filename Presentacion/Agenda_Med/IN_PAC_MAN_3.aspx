<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="IN_PAC_MAN_3.aspx.vb" Inherits="Presentacion.IN_PAC_MAN_3" %>
    ...
    <script>
        ...
        function Ajax_guardar() {
            ...
            var Data_Par = JSON.stringify({
                ...
                "vih": $("#vih").val(),
                "dni": $("#dni").val(),
                "Numero_clini": numeritocliniquito
            });
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3.aspx/Guardar_TodoByVal",
                "data": Data_Par,
        ...
        var Mx_Dtt_exam02_respaldo = [
  {
      ...
      "CF_DIAS": 0,
        ...
        function Ajax_DataTable_examen02() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3.aspx/Llenar_tabla_exam2",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable_examen3(cod_fonasa, id, cod, txis) {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3.aspx/Llenar_tabla_exam",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Ddl = [
    {
        ...
        function Call_AJAX_Ddl() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3.aspx/Llenar_Ddl_LugarTM",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_busca_rut() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3.aspx/Llenar_rut",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_busca_dni() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3.aspx/Llenar_dni",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
                    ...
                    if (json_receiver != "null") {
                        ...
                        let FechaREE = moment(Mx_Dtt2_dni[0].PAC_FNAC).format("YYYY-MM-DD");
        ...
        function Ajax_DL_SEXO() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3.aspx/Llenar_DL_SEXO",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DL_NAC() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3.aspx/Llenar_DL_NAC",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Ciudad() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3.aspx/IRIS_WEBF_BUSCA_CIUDAD",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Comuna() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3.aspx/IRIS_WEBF_BUSCA_RELACION_CIU_COMUNA",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_prevision = [
      {
        ...
        function Ajax_DL_prevision() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3.aspx/Llenar_DL_prevision",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_TP_ATE = [
     {
        ...
        function Ajax_DL_TP_ATE() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3.aspx/Llenar_DL_aTENCIONES",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_Sec = [
    {
        ...
        function Ajax_DL_sec() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3.aspx/Llenar_DL_Sectores",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_Programa = [
   {
       ...
       "ID_ESTADO": 0
        ...
        function Ajax_DL_programa() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3.aspx/Llenar_DL_Programa",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_DOC = [
  {
      ...
      "ID_ESTADO": 0
        ...
        function Ajax_DL_DOC() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3.aspx/Llenar_DL_DOC",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_orden_ate = [
 {
     ...
     "ID_ESTADO": 0
        ...
        function Ajax_DL_orden_ate() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3.aspx/Llenar_DL_ordenATE",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Diagnostico() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3.aspx/IRIS_WEBF_BUSCA_DIAGNOSTICO",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md checkbox checkbox-success">
                            ...
                            <input id="checkBox999" value="rutee" type="checkbox"/> <label class="textoReducido" style="padding-left: 0px !important;" for="checkBox999">RUT</label>  |    <input id="checkBox888" value="DNI" type="checkbox"/><label style="margin-left: 15px; padding-left: 0px !important;" class="textoReducido" for="checkBox888">DNI:</label>

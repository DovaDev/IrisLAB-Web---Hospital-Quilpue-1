...
Public Class Rev_Deter_Exa_PCR
    ...
    Public Shared Function Llenar_DataTable(ByVal DESDE As String, ByVal HASTA As String,
        ...
        Data = NN.IRIS_BUSCA_EXAMEN_DET_ESTADISTICA_CHECK_TODOS_2_PCR(CDate(DESDE), CDate(HASTA), ID_CF, ID_EST, LUGARTM)
    ...
    Public Shared Function Excel(ByVal DOMAIN_URL As String, ByVal DESDE As String, ByVal HASTA As String,
        ...
        'nombrar hoja 
        sl.RenameWorksheet("Sheet1", "Listado de Resultados por Determinaciones PCR")
        'titulo de la tabla
        sl.SetCellValue("B2", "Listado de Resultados por Determinaciones PCR")

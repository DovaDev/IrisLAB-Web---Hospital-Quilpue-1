<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Config_Ate_LM_4.aspx.vb" Inherits="Presentacion.Config_Ate_LM_4" %>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#normal").focusout(function () {
                ...
                $("#Cantidad").val();
                var nor = $("#normal").val();
                var pri = 0;  //$("#prioritario").val();
                var esp = 0; //$("#espontaneo").val();
...
("<div class='alert alert-danger alertas'><strong>La suma de los agendados (normal, prioritario y espóntaneo) debe ser igual a Agendado Total</strong>  </div>")
    ...
    <script>
        ...
        function Call_AJAX_Ddl_Año() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Config_Ate_LM_4.aspx/Llenar_Ddl_Año",
                //"data": Data_Par,
        ...
        function Call_AJAX_Ddl_LugarTM() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Config_Ate_LM_4.aspx/Llenar_Ddl_LugarTM",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": data => {
        ...
        function Call_AJAX_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Config_Ate_LM_4.aspx/Llenar_Tabla",
                "data": strParam,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": data => {
        ...
        function Call_AJAX_Guardar() {
            ...
            var strParam = JSON.stringify({
                ...
                "CANT": $("#Cantidad").val(),
                "normal": $("#normal").val(),
                "prioritario": 0, //$("#prioritario").val(),
                "espontaneo": 0, //$("#espontaneo").val(),
                "COMENTARIO": $("#coment").val()
            });

            $.ajax({
                "type": "POST",
                "url": "Config_Ate_LM_4.aspx/Guardar_Conf_Examenes",
                "data": strParam,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": data => {
        ...
        function Call_AJAX_Modificar() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Config_Ate_LM_4.aspx/Modificar_Conf_Examenes",
                "data": strParam,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": data => {
        ...
        //FUNCTION ON CLICK
        function Ajax_Click(fclick, cantexa, valor1, valor2, valor3, est, id, comenta) {
        ...
        function Fill_Dtt() {
            ...
            Mx_Dtt.forEach(aah => {
                ...
                if (fdia != "Domingo") {
                    $("<tr>", {
                        "onclick": `Ajax_Click("` + aah.N_FECHA + `","` + aah.N_CANT_EXA + `","` + aah.N_AGEND_CUPO_NORMAL + `","` + aah.N_AGEND_PRIORITARIO + `","` + aah.N_AGEND_ESPONTANEO + `","` + aah.N_ESTADO + `","` + aah.N_ID + `","` + aah.n_AGEND_COMENTARIO_2 + `")`,
                        "class": "manito"
                    }).append(
                         ...
                         $("<td>").css("text-align", "center").text(fdia),
                            $("<td>").css("text-align", "center").text(aah.n_AGEND_COMENTARIO_2)
...
<%--                                            <div class="col-sm">
                                    ...
                                    <div class="form-row">
                                        <div class="col">
                                            <h6>
                                                <label>Agendado Comentario:</label></h6>
                                            <input id="coment" type="text" class="form-control font-weight-bold text-center" style="font-size: 10px;" />
                                        </div>

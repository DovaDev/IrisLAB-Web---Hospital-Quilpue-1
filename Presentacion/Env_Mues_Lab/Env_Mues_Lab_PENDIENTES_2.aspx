<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Env_Mues_Lab_PENDIENTES_2.aspx.vb" Inherits="Presentacion.Env_Mues_Lab_PENDIENTES_2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
        ...
        var Mx_Dtt_Load = [
    {
        ...
        function Ajax_DataTable_Load() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Env_Mues_Lab_PENDIENTES_2.aspx/Form_Table",
                "data": Data_Par,
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                type: "POST",
                url: "Env_Mues_Lab_PENDIENTES_2.aspx/Llenar_DataTable_Laser",
                data: Data_Par,
                contentType: "application/json;  charset=utf-8",
                dataType: "json",
                success: async (res) => {
                    ...
                    if (json_receiver == 201) { //Created. se procesa correctamente la muestra
                        const cb = ($('#txtNAte').val().substring(0, 2));
                        const ateNum = ($('#txtNAte').val().substring(2, 10));
                        $("#xxx_xxx").text("Último tubo cargado: " + "[" + cb + "]," + " Perteneciente al folio N°: " + ateNum + "  ✖");
        ...
        var Mx_Dtt_Atencion_Asereje = [
{
    ...
    "ID_PACIENTE": 0
        ...
        function Ajax_Info_Asereje() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Env_Mues_Lab_PENDIENTES_2.aspx/Info",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Info_Exa_Asereje() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Env_Mues_Lab_PENDIENTES_2.aspx/Exa_Info",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable_Asereje() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Env_Mues_Lab_PENDIENTES_2.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Guardar_de_una() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Env_Mues_Lab_PENDIENTES_2.aspx/Guardar_de_una",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Marcar_Guardar() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Env_Mues_Lab_PENDIENTES_2.aspx/Llenar_DataTable_Marcar_Nuevo",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable_Ate_ONCLICK() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Env_Mues_Lab_PENDIENTES_2.aspx/Llenar_DataTable2",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        async function Ajax_DataTable_Marcar() {
            ...
            await $.ajax({
                "type": "POST",
                "url": "Env_Mues_Lab_PENDIENTES_2.aspx/Llenar_DataTable3",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Pendiente_Marcar() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Env_Mues_Lab_PENDIENTES_2.aspx/Ajax_Pendiente_Marcar",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Llenar_Modal_Cargar_Doble_click(NUM_ATE) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Env_Mues_Lab_PENDIENTES_2.aspx/Llenar_Modal_Cargar_Doble_click",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
            ...
            $.ajax({
                ...
                "success": function (response) {
                    ...
                    if (json_receiver != "null") {
                        ...
                        $("#superNumAte").text(Mx_Dtt_Marcar[0].ATE_NUM);
                        $("#superNombre").text(Mx_Dtt_Marcar[0].DOC_NOMBRE == "null" ? "" : Mx_Dtt_Marcar[0].DOC_NOMBRE + " " + Mx_Dtt_Marcar[0].DOC_APELLIDO == "null" ? "" : Mx_Dtt_Marcar[0].DOC_APELLIDO);
                        $("#superPrevision").text(Mx_Dtt_Marcar[0].PREVE_DESC);
                        $("#superLugar").text(Mx_Dtt_Marcar[0].PROC_DESC);
                        nombre_waaa = $("#txtNom").val();
                        $("#superNomPaciente").text(Mx_Dtt_Marcar[0].PAC_NOMBRE + " " + Mx_Dtt_Marcar[0].PAC_APELLIDO);
        ...
        function Guardar_Lote() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Env_Mues_Lab_PENDIENTES_2.aspx/Guardar_Lote",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Guardar_Lote_2(correlativin2) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Env_Mues_Lab_PENDIENTES_2.aspx/Guardar_Lote2",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Ver_Lotes_Anteriores() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Env_Mues_Lab_PENDIENTES_2.aspx/IRIS_WEBF_BUSCA_CANTIDAD_LOTE_RECEPCIONADO",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Muestras_Lotes(NUMLOTE) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Env_Mues_Lab_PENDIENTES_2.aspx/IRIS_WEBF_BUSCA_LOTE_RECEPCIONADO_LOTE_2",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
...
/*            const colorTubo = tubo => `<div style="width:20px;height:20px;${tubo?.HEX == '' ? '' : `background-color:${tubo?.HEX};border-radius:100%;box-shadow:0px 0px 6px rgba(0, 0, 0, 0.5);display:inline-block;`}"></div>`*/
            ...
            const tubosDistintos = Array.from(new Set(Mx_Dtt_Load.map(item => JSON.stringify({
                cb: item.ENVIO_ETI_CURVA,
                idAte: item.ID_ATENCION,
                color: item.COLOR_DESC || 'Sin Color',
            })))).map(item => JSON.parse(item));
            console.log(Mx_Dtt_Load)
            let countByColor = {};
                    ...
                    $("<td>").css("text-align", "center").text(function () {
                        ...
                        //    }
                            $("<td>", { "align": "left" }, { "class": "textoReducido" }).text(function () {
                                ...
                                if (horita == "00:00:00" || horita == "22:17:00") {
                                    return "-/-";
                                } else {
                                    return horita;
                                }
...
<%--    <div id="modal_agregar_de_una" class="modal fade" role="dialog">
    ...
    <div class="col-lg-3">
        <div class="row">
        <label for="slct-usuario-tdem">Usuario Envio de Muestras</label>
        </div>
        <div class="row">

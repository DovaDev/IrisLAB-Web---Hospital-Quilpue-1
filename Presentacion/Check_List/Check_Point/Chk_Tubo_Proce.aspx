<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Chk_Tubo_Proce.aspx.vb" Inherits="Presentacion.Chk_Tubo_Proce" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function Ajax_LugarTM() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Chk_Tubo_Proce.aspx/Llenar_Ddl_LugarTM",
                //"data": Data_Par,
        ...
        function Ajax_Seccion() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Chk_Tubo_Proce.aspx/Llenar_Ddl_Seccion",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Chk_Tubo_Proce.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
    ...
    <div class="row mb-3" style="margin-left:2px; margin-right: 2px;">
        ...
        <div class="col-md">
            <label for="Ddl_Seccion">Tubo:</label>

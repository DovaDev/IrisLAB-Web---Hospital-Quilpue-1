<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Lugar_TM_2.aspx.vb" Inherits="Presentacion.Lugar_TM_2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        function Ajax_Codiguin(COD, DESC, ESTADO, ID, COD_AVIS) {
            $("#txtCod").val(COD);
            $("#txtDesc").val(DESC);
            $("#Ddl_Mantenedor").val(ESTADO);
            $("#txtCod_Avis").val(COD_AVIS);
        ...
        function Ajax_Ddl_Mantenedor() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Lugar_TM_2.aspx/IRIS_WEBF_BUSCA_ESTADO_MANTENEDOR",
                //"data": Data_Par,
        ...
        function Ajax_Tabla() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Lugar_TM_2.aspx/IRIS_WEBF_BUSCA_PROCEDENCIA",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Update() {
            ...
            var Data_Par = JSON.stringify({
                "ID_PROCEDENCIA": IDDDDDDD,
                "PROC_COD": $("#txtCod").val(),
                "PROC_DES": $("#txtDesc").val(),
                "ID_ESTADO": $("#Ddl_Mantenedor").val(),
                "COD_AVIS": $("#txtCod_Avis").val()
            });
            $(".block_wait").fadeIn(500);
            $.ajax({
                "type": "POST",
                "url": "Lugar_TM_2.aspx/IRIS_WEBF_UPDATE_PROCEDENCIA",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Guardar() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Lugar_TM_2.aspx/IRIS_WEBF_GRABA_PROCEDENCIA",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Fill_DataTable() {
            ...
            $("#DataTable thead").append(
                $("<tr>").append(
                    ...
                    $("<th>", { "class": "textoReducido" }).text("Codigo Avis"),
            ...
            for (i = 0; i < Mx_Dtt.length; i++) {
                $("#DataTable tbody").append(
                    $("<tr>", {
                        "onclick": `Ajax_Codiguin("` + Mx_Dtt[i].PROC_COD + `","` + Mx_Dtt[i].PROC_DESC + `","` + Mx_Dtt[i].ID_ESTADO + `","` + Mx_Dtt[i].ID_PROCEDENCIA + `","` + Mx_Dtt[i].PROC_DESC_AVIS + `")`,
                        "class": "manito"
                    }).append(
                        $("<td>", { "align": "left" }, { "class": "textoReducido" }).text(i + 1),
                        $("<td>", { "align": "left" }, { "class": "textoReducido" }).text(Mx_Dtt[i].PROC_COD),
                        $("<td>", { "align": "left" }, { "class": "textoReducido" }).text(Mx_Dtt[i].PROC_DESC),
                        $("<td>", { "align": "left" }, { "class": "textoReducido" }).text(Mx_Dtt[i].PROC_DESC_AVIS),
        ...
        <div class="col-lg">
            <div class="card mb-3 border-bar">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-3">
                        <label for="txtCod_Avis">Codigo Avis:</label>
                        <input id="txtCod_Avis" class="form-control text-uppercase textoReducido" type="text" />
                    </div>
                    <div class="col-md-3">
                ...
                <div class="row mb-3" id="Id_Conte">
                    <div class="col-md-12" id="Paciente">
                        <h5 style="text-align: center; padding: 5px; font-size: 15px;"><i class="fa fa-list"></i>Lista de Lugares de Toma de Muestra</h5>

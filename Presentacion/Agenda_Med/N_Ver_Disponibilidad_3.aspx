<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="N_Ver_Disponibilidad_3.aspx.vb" Inherits="Presentacion.N_Ver_Disponibilidad_3" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function Call_AJAX_Ddl() {
            ...
            AJAX_Ddl = $.ajax({
                "type": "POST",
                "url": "N_Ver_Disponibilidad_3.aspx/Llenar_Ddl_LugarTM",
                //"data": Data_Par,
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "N_Ver_Disponibilidad_3.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
            ...
            $.ajax({
                ...
                "success": function (response) {
                    ...
                    if (json_receiver != "null") {
                        ...
                        //console.log(uu + " " + CONF_DIAS_EXA_BUSCA_DIAS + " " + TOTAL_ATE);
                        //if ((TOTAL_ATE == 0) || (uu <= 0)) {
                            if (uu <= 0) {
                            $('#BtnAgenda').attr("disabled", true);
        ...
        function Ajax_Agendar(NUM, fecha_ac) {
            //window.location.href='/Agenda_Med/IN_PAC_AVIS_3.aspx?kl=' + NUM + '&' + 'FF=' + fecha_ac;         //PARA REDIRIGIR ALTIRO A AGENDAMIENTO AVIS


            $('#Manual').attr("onclick", "window.location.href='/Agenda_Med/IN_PAC_MAN_3.aspx?kl=" + NUM + "&FF=" + fecha_ac + "'");
            $('#AVIS').attr("onclick", "window.location.href='/Agenda_Med/IN_PAC_AVIS_3.aspx?kl=" + NUM + "&FF=" + fecha_ac + "'");
        ...
        function Ajax_modal_exa(id_ate) {
            ...
            $.ajax({
                "type": "POST",
                "url": "N_Ver_Disponibilidad_3.aspx/MODAL_PAC",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
          ...
          <h6 class="modal-title" id="sub">Nombre PAc</h6>       
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6" style="text-align: center;">
                            <button type="button" id="AVIS" class="btn btn-info" style="height: 120px; width: 75%;" disabled="disabled"><b>PACIENTE AVIS</b></button>
                        </div>
                    </div>
                </div>
            </div>

...
Public Class Lis_Recep_Mue_VIH
    ...
    Public Shared Function Excel(ByVal DOMAIN_URL As String, ByVal TIPO As Integer, ByVal DESDE As String, ByVal HASTA As String,
        ...
        If (data_det_ate.Count > 0) Then
            ...
            For y = 0 To (data_det_ate.Count - 1)
                ...
                Mx_Data(13, y) = data_det_ate(y).ATE_OBS_TM
                If data_det_ate(y).RECEP_ETI_FECHA = "12:00:00 AM" Then
                    Mx_Data(14, y) = ""
                Else
                    Mx_Data(14, y) = Format(data_det_ate(y).RECEP_ETI_FECHA, "dd/MM/yyyy HH:mm:ss")
                End If
                Mx_Data(15, y) = data_det_ate(y).RATE_OBS_VIH
                Mx_Data(16, y) = data_det_ate(y).EST_DESCRIPCION
            Next y
        Else
            Return "null"
        End If
        ...
        sl.SetCellValue("P8", "Obs. VIH")
        sl.SetCellValue("Q8", "Estado")

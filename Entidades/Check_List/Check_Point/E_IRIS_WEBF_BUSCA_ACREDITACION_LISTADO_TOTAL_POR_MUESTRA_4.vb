Public Class E_IRIS_WEBF_BUSCA_ACREDITACION_LISTADO_TOTAL_POR_MUESTRA_4
    ...
    Dim EE_ID_RECEP_ETI_RECHAZO As String
    Dim EE_ID_RECEP_ETI_DERIVA As String
    ...
    Public Property ID_RECEP_ETI_RECHAZO As String
        Get
    ...
    Public Property ID_RECEP_ETI_DERIVA As String
        Get

...
Public Class Rev_Est_Exa
    ...
    Public Shared Function Llenar_DataTable(ByVal DESDE As String, ByVal HASTA As String,
        ...
        Dim Data As New List(Of E_IRIS_WEBF_BUSCA_EST_ESTADOS_INFORMAR3)
        ...
        Data = NN.IRIS_WEBF_BUSCA_EST_ESTADOS_INFORMAR3(CDate(DESDE), CDate(HASTA), ID_PRE, ID_CF, ID_EST)

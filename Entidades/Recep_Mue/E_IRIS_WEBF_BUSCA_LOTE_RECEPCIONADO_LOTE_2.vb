Public Class E_IRIS_WEBF_BUSCA_LOTE_RECEPCIONADO_LOTE_2
    Dim EE_LOTE_NUM As Integer
    ...
    Dim EE_RECEP_ETI_FECHA As String
    Dim EE_ID_LOTE As Integer
    ...
    Public Property USU_NIC As String
        ...
        End Set
    End Property
    Public Property LOTE_NUM As Integer
        Get
            Return EE_LOTE_NUM
        End Get
    ...
    Public Property RECEP_ETI_FECHA As String
        Get

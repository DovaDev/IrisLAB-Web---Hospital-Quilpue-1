...
Public Class D_REP_LAB_CANT_EXA_ARE_SECC
    ...
    Function IRIS_BUSCA_WEBF_LIS_ADM_RESU_CANT_EXAMENES_AREA_SECCION(ByVal ID_TP_PAGO As Long, ByVal DESDE As Date, ByVal HASTA As Date) As List(Of E_IRIS_BUSCA_WEBF_LIS_ADM_RESU_CANT_EXAMENES_AREA_SECCION)
        ...
        'Declaraciones 'lista'
        Dim E_Proc_Item As E_IRIS_BUSCA_WEBF_LIS_ADM_RESU_CANT_EXAMENES_AREA_SECCION
        Dim E_Proc_List As New List(Of E_IRIS_BUSCA_WEBF_LIS_ADM_RESU_CANT_EXAMENES_AREA_SECCION)
        ...
        While Obj_Reader.Read
            E_Proc_Item = New E_IRIS_BUSCA_WEBF_LIS_ADM_RESU_CANT_EXAMENES_AREA_SECCION
            ...
            E_Proc_Item.ID_RLS_LS = DD_GEN.DB_NULL(Obj_Reader, 11, Nothing)

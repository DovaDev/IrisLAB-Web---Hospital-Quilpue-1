<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Ingreso_Ate_Avis.aspx.vb" Inherits="Presentacion.Ingreso_Ate_Avis" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#Actuales2, #Disponibles2").attr("hidden", true);
            ...
            //$("#button_modal2_3").click(function () {
            //    Ajax_N_PACIENTE_3();
        ...
        function ajax_eliminar() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis.aspx/MODAL_elimanar",
                "data": Data_Par44,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
    ...
    <script>
        ...
        function Ajax_guardar() {
            ...
            var Data_Par = {
                ...
                "EMAIL_PAC": $("#Email").val(),
                "CUPO_AGEND": $("#sub_atencion").val(),
                "DNI": $("#Dni").val()
            };

            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis.aspx/Guardar_TodoByVal",
                ...
                "success": function (response) {
                    ...
                    if (json_receiver != "null") {
                        ...
                        if (Mx_AVIS[0].HO_RutPaciente == "") {
                            ...
                            $("#mError_AAH p").html("<p  style='text-align: center;'> <strong>La orden no cuenta con fecha de nacimiento.</strong></p><p style='text-align: center;'>Nombre:</p> <p style='text-align: center;'><strong>" + Mx_AVIS[0].HO_Nombres + " " + Mx_AVIS[0].HO_ApellidoPaterno + " " + Mx_AVIS[0].HO_ApellidoMaterno + "</strong></p> <p style='text-align: center;'>Procedencia:</p> <p style='text-align: center;'><strong> " + Mx_AVIS[0].HO_ProcedenciaDescripcion + "</strong></p> <p style='text-align: center;'> <strong>Por lo cual la acción fue cancelada.</strong></p>");
                            $("#mError_AAH").modal();

                        }else {
                            if (parseInt(Mx_AVIS[0].HO_ProcedenciaCodigo) == $("#Procedencia").val()) {
                                Fill_DL_AVIS();
                                Hide_Modal();
                                verrut = 1;
                            } else {
    ...
    "CF_DIAS": 0,
        ...
        var Mx_Dtt_exam02_respaldo_global = [
      {
        ...
        function Ajax_DataTable_examen0GObal() {
           $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Avis.aspx/Llenar_tabla_exam2_global",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Ddl = [
     {
        ...
        function Fill_DL_Rut_2() {
            var ffmm = moment(Mx_Dtt2_rut[0].PAC_FNAC).format("DD-MM-YYYY");
            console.log(ffmm);
        ...
        var Mx_DL_Diag2 = [
{
    ...
    <script>
        ...
        function Fill_DL_Rut() {
            ...
            if (parseInt(Mx_Dtt2[0].HO_ProcedenciaCodigo) == 0) {

            } else {

                $("#Procedencia").val(parseInt(Mx_Dtt2[0].HO_ProcedenciaCodigo));
            }
        ...
        function Fill_DL_AVIS() {
            ...
            let bolRUT = (function () {
                let strM = Mx_AVIS[0].HO_RutPaciente;

                if (strM.match(/\-([0-9]|k)$/gi) != null) {
                    return true;
                } else {
                    return false;
                }
            ...
            var obj_RUT3 = Valid_RUT(Mx_AVIS[0].HO_RutPaciente);
                if (obj_RUT3.Valid == false) {
                    ...
                    let strRUT = obj_RUT3.Format;
                    let bolOver40 = (function () {
                        if (strRUT.match(/^[4-9][0-9]\./gi) != null) {
                            return true;
                        } else {
                            return false;
                        }
        ...
        <div class="modal-dialog ml-xl-auto">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="btn_eliminar" class="btn btn-danger" data-dismiss="modal">Atender</button>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-sm">
                                            ...
                                            <input type='text' id="rut_3" readonly="true" class="form-control textoReducido2 borderaaa" disabled="disabled" />
                                        </div>
                                        ...
                                        <div class="col-sm">
                                            <label id="ATENe_2" class="textoReducido2">N°Atención:</label>
                 ...
                 <%--                       <div class="col-sm">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm">
                                            ...
                                            <input type='text' id="FUR_3" readonly="true" class="form-control textoReducido2 borderaaa" disabled="disabled" />
                                        </div>
                                        <div class="col-sm">
                                            <label class="textoReducido2">Nacionalidad:</label>
                                            <input type='text' id="Nacio_3" readonly="true" class="form-control textoReducido2 borderaaa" disabled="disabled" />
                                        </div>
                                        <div class="col-sm">
                                        ...
                                        <div class="col-sm">
                                            ...
                                            <input type='text' id="Celular_3" readonly="true" class="form-control textoReducido2 borderaaa" disabled="disabled" />
                                        </div>
                                    ...
                                    <div class="row" style="margin-bottom: 10px;">
                                        ...
                                        <div class="col-sm">
                                            ...
                                            <input type='text' id="Comuna_3" readonly="true" class="form-control textoReducido2 borderaaa" disabled="disabled" />
                                        </div>
                                        <div class="col-sm">
                                        ...
                                        <div class="col-sm">
                                            ...
                                            <input type='text' id="Email_3" readonly="true" class="form-control textoReducido2 borderaaa" disabled="disabled" />
                                        </div>
                                        <div class="col-sm">
                    ...
                    <div class="card border-bar">
                        ...
                        <div class="card-body">
                            <div id="Div_Tabla3_3" style="width: 100%;" class="highlights3"></div>
                        </div>
                    </div>
                </div>
    ...
    <div class="card border-bar">
        ...
        <div class="card-body p-3">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-lg checkbox checkbox-success">
                               ...
                               <input id="checkBox999" value="rutee" type="checkbox"/> <label class="textoReducido" style="padding-left: 0px !important;" for="checkBox999">N° Avis</label><input id="checkBox8887" value="DNI" type="checkbox"/><label style="margin-left: 15px; padding-left: 0px !important;" class="textoReducido" for="checkBox8887">N° Atención:</label>
                                <div class="input-group" style="height: 31.75px;" id="avusg">
                            ...
                            <input type='text' id="Dni" class="form-control textoReducido" placeholder="" disabled="disabled"/>
                        </div>
                            <div class="col-lg">
                                <label class="textoReducido">Nombres:</label>
                                <input type='text' id="Nom" class="form-control textoReducido" placeholder="" disabled="disabled"/>
                            </div>
                            <div class="col-lg">
                                <label class="textoReducido">Apellidos:</label>
                                <input type='text' id="Ape" class="form-control textoReducido" placeholder="" disabled="disabled"/>
                            </div>
                            <div class="col-lg">
                                <label class="textoReducido">F.Nacimiento:</label>
                                <div class='input-group date' id='datetimepicker1' style="margin-bottom: 1vh;">
                                    <input type='text' id="fecha" class="form-control textoReducido" readonly="true" placeholder="Fecha" disabled="disabled"/>
                        ...
                        <div class="row" style="margin-bottom: 10px;">
                            <div class="col-lg">
                                ...
                                <select id="sex" class="form-control textoReducido" style="height: 31.75px;" disabled="disabled">
                                </select>
                            </div>
                            <div class="col-lg checkbox checkbox-success">
                            ...
                            <div class="col-lg">
                                ...
                                <select id="Nacio" class="form-control textoReducido" style="height: 31.75px;" disabled="disabled">
                                    <option value="volvo">Seleccionar</option>
                                </select>
                            </div>
                            <div class="col-lg">
                                <label class="textoReducido">Tel. Fijo:</label>
                                <input type='text' id="telfijo" class="form-control textoReducido" placeholder="" disabled="disabled"/>
                            </div>
                            <div class="col-lg">
                                <label class="textoReducido">Celular:</label>
                                <input type='text' id="Celular" class="form-control textoReducido" placeholder="" disabled="disabled"/>
                            </div>


                            <div class="col-lg">
                                <label class="textoReducido">Ciudad:</label>
                                <select id="Cuidad" class="form-control textoReducido" style="height: 31.75px;" disabled="disabled">
                        ...
                        <div class="row" style="margin-bottom: 10px;">
                            <div class="col-lg">
                                ...
                                <select id="Comuna" class="form-control textoReducido" style="height: 31.75px;" disabled="disabled">
                                    <option value="0">Seleccionar</option>
                                </select>
                            </div>
                            <div class="col-lg">
                            ...
                            <div class="col-lg">
                                ...
                                <input type='text' id="direccion" class="form-control textoReducido" placeholder="" disabled="disabled"/>
                            </div>
                            <div class="col-lg">
                                <label class="textoReducido">Email:</label>
                                <input type='text' id="Email" class="form-control textoReducido" placeholder="Irislab@irislab.cl" disabled="disabled"/>
                            </div>
                            <div class="col-lg">
                                <label class="textoReducido">observacion:</label>
                                <input type='text' id="Diag" class="form-control textoReducido" placeholder="" disabled="disabled"/>
                            </div>
                            <div class="col-lg">
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-lg">
                                ...
                                <select id="Doctor" class="form-control textoReducido" style="height: 31.75px;" disabled="disabled">
                                    <option value="volvo">Seleccionar</option>
                                </select>
                            </div>
                            <div class="col-lg">
                            ...
                            <div class="col-sm">
                                ...
                                <input type='text' id="Total" class="form-control textoReducido" readonly="true" placeholder="" disabled="disabled" text-align: center;" />
                            </div>
                            <div class="col-sm" id="Actuales2">
                            ...
                            <div class="col-sm" id="Disponibles2">
                            ...
                            <div class="col-sm">
                                ...
                                <select id="sub_atencion" class="form-control textoReducido" style="height: 31.75px; " disabled="disabled">
                                    <%--<option value="0">Seleccionar</option>--%>
                        ...
                        <div class="row" style="margin-bottom: 10px;">
                            ...
                            <div class="col-sm">
                                ...
                                <input type='text' id="vih" class="form-control textoReducido" placeholder="" style="text-align: center;" disabled="disabled"/>
                            </div>
                            <div class="col-lg">
                            ...
                            <div class="col-lg">
                                ...
                                <input type='text' id="Autorizo_retirar" class="form-control textoReducido" placeholder="" disabled="disabled"/>
                            </div>
                            <div class="col-lg">
                                <label class="textoReducido">Prioridad TM:</label>
                                <select id="PrioridadTM" class="form-control textoReducido" style="height: 31.75px;" disabled="disabled">
                                    <option value="volvo">Seleccionar</option>
                                </select>
                            </div>
            ...
            <div class="container" style="max-width: 100%; border: 0px solid #fff;">
                <div class="row">
                    <div class="col-sm-3">
                        <button id="Examen" type="button" class="btn btn-pendiente btn-block" disabled="disabled">
                            <br />

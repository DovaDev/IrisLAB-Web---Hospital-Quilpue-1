...
Public Class D_IRIS_WEBF_BUSCA_SECCIONES
    Dim DD_GEN As New D_General_Functions
    Function IRIS_WEBF_BUSCA_SECCIONES() As List(Of E_IRIS_WEBF_BUSCA_SECCIONES)
        'Declaraciones
        Dim objconexion As New Conexion.ConexionBD
        Dim Cmd_command As New OleDb.OleDbCommand
        Dim Obj_Read_Dt As E_IRIS_WEBF_BUSCA_SECCIONES
        Dim List_Reader As New List(Of E_IRIS_WEBF_BUSCA_SECCIONES)
        Dim Reader_Comm As OleDbDataReader

        'Configuración general
        Cmd_command.CommandType = CommandType.StoredProcedure
        Cmd_command.CommandText = "IRIS_WEBF_BUSCA_SECCIONES"
        ...
        While Reader_Comm.Read
            Obj_Read_Dt = New E_IRIS_WEBF_BUSCA_SECCIONES

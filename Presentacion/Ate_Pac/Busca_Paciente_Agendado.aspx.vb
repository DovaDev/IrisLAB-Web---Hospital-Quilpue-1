...
Public Class Busca_Paciente_Agendado
    ...
    Public Shared Function Llenar_DataTable(ByVal RUT_P As String, ByVal NOM_P As String, ByVal APE_P As String, ByVal DNI_P As String) As String
        ...
        data_paciente = NN.IRIS_WEBF_BUSCA_PACIENTE_LIKE2_AGENDAMIENTO_DNI(RUT_P, nombre, apellido, sinpuntos, denei)
    ...
    Public Shared Function Llenar_DataTable_Ate(ByVal NUM_ATE As String) As String
        ...
        data_ate = NN_Ate.IRIS_WEBF_BUSCA_ID_PREINGRESO_POR_NUMERO_DE_AGENDA(NUM_ATE)
        If (data_ate.Count > 0) Then
            data_ate_2 = NN_Ate_2.IRIS_WEBF_BUSCA_MUESTRA_ANTECEDENTES_PACIENTES______2_AGENDA(data_ate(0).ID_ATENCION)
    ...
    Public Shared Function Llenar_DataTable_Ate_ONCLICK(ByVal ID_PAC As String) As String
        ...
        data_ate = NN_Ate.IRIS_WEBF_BUSCA_ATENCIONES_POR_PACIENTE_EXAMENES_VER_AGENDA(ID_PAC)
        If (data_ate.Count > 0) Then
            'Serializar con JSON
            Serializer.MaxJsonLength = 999999999
    ...
    Public Shared Function Llenar_DataTable_Det_Ate(ByVal ID_ATE As String) As String
        ...
        data_det_ate = NN_Det_Ate.IRIS_WEBF_BUSCA_LISTADO_DE_EXAMENES_CODIGO_FONASA_PACIENTE2_AGENDA(ID_ATE)
        If (data_det_ate.Count > 0) Then
            data_num = NN_Num.IRIS_WEBF_BUSCA_MUESTRA_ANTECEDENTES_PACIENTES_AGENDA(data_det_ate(0).ID_ATENCION)

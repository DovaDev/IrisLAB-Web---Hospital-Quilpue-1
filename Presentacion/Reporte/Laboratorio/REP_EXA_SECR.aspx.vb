...
Public Class REP_EXA_SECR
    ...
    Public Shared Function Llenar_DataTable(ByVal ID_CODIGO_FONASA As Long, ByVal DATE_str01 As String,
        ...
        Dim Data_Prev As New List(Of E_IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_SECCION)
        ...
        Data_Prev = NN_Exam.IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_SECCION(ID_CODIGO_FONASA, Date_01, Date_02)
    ...
    Private Sub REP_EXA_SECR_Load(sender As Object, e As EventArgs) Handles Me.Load

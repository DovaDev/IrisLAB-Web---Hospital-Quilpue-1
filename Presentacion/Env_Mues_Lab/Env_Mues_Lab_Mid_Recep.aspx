<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Env_Mues_Lab_Mid_Recep.aspx.vb" Inherits="Presentacion.Env_Mues_Lab_Mid_Recep" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#Btn_Recepcionar").click(function () {
                if ($("#TxtNLote").val() == "") {
                    $("#mError_AAH h4").text("Ingrese Num");
                    $("#mError_AAH button").attr("class", "btn btn-danger");
                    $("#mError_AAH p").text("Por favor, ingrese un número de lote.");
                    $("#mError_AAH").modal();
                }else{
                    IRIS_WEBF_UPDATE_LOTE_RECEPCION_ENVIO_RECEP();
                }
    ...
    <script>
        ...
        function Ajax_Ver_Lotes_Anteriores() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Env_Mues_Lab_Mid_Recep.aspx/IRIS_WEBF_BUSCA_CANTIDAD_LOTE_RECEPCIONADO_ENVIO",
                //"data": Data_Par,
        ...
        function Ajax_Ver_Lotes_Anteriores_Fecha() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Env_Mues_Lab_Mid_Recep.aspx/IRIS_WEBF_BUSCA_CANTIDAD_LOTE_RECEPCIONADO_ENVIO_POR_FECHA",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        //-------------------------------------------------- UPDATE RECEP LOTES ----------------------------------------------------|
        function IRIS_WEBF_UPDATE_LOTE_RECEPCION_ENVIO_RECEP() {
            modal_show();

            var Data_Par = JSON.stringify({
                "NUMLOTE": $("#TxtNLote").val()
            });
            $.ajax({
                "type": "POST",
                "url": "Env_Mues_Lab_Mid_Recep.aspx/IRIS_WEBF_UPDATE_LOTE_RECEPCION_ENVIO_RECEP",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
                    ...
                    if (json_receiver == 1) {
                        ...
                        Hide_Modal();
                        $("#mError_AAH h4").text("Verifique");
                        $("#mError_AAH button").attr("class", "btn btn-danger");
                        $("#mError_AAH p").text("El lote ya ha sido recepcionado o no existe.");
                        $("#mError_AAH").modal();
                    }
                },
                "error": function (response) {
        ...
        function Ajax_Muestras_Lotes(NUMLOTE) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Env_Mues_Lab_Mid_Recep.aspx/IRIS_WEBF_BUSCA_LOTE_RECEPCIONADO_LOTE_2_ENVIO_LISTA_TUBO",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Env_Mues_Lab_Mid_Recep.aspx/Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": (resp) => {
        ...
        var Mx_Dtt_PDF = [
{
    "urls": ""
        ...
        function Ajax_PDF() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Env_Mues_Lab_Mid_Recep.aspx/PDFF",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": (resp) => {
        ...
        function Fill_DataTable_Muestras_Por_Lotes() {
            ...
            $("#DataTable_Muestras_Por_Lotes thead").append(
                $("<tr>").append(
                    ...
                    $("<th>", { "class": "textoReducido" }).text("Lugarde TM"),
                    $("<th>", { "class": "textoReducido" }).text("Etiqueta"),
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
    ...
    <div class="card-header bg-bar">
        <h5 style="text-align: center; padding: 5px;">
            ...
            Listado de Lotes Enviados Recepcionados en Sección
        </h5>
    </div>
    ...
    <div class="row" style="margin-left:2px; margin-right: 2px;">
        <div class="col-md">
            <button id="Btn_Recepcionar" class="btn btn-dark btn-block" style="margin-bottom: 1vh; padding: 3px;" type="submit"><i class="fa fa-fw fa-upload mr-2"></i> Recibir</button>

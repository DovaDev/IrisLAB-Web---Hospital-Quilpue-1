<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Excel_TP_Real_ADM_2.aspx.vb" Inherits="Presentacion.Excel_TP_Real_ADM_2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        function ajax_eliminar(ID_WEN) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Excel_TP_Real_ADM_2.aspx/Eliminar",
                "data": Data_Par44,
                ...
                $("<tr>", {
                    ...
                    "class": "manito"
                        ...
                        $("<td>", {
                            ...
                            //Retornar un campo input                       NUEVO CAMPO DE Contenedor de Envió AP
                            return $("<input>", {
                                "data-id": "",
                                "data-cod": "1111",
                                "class": "td_input jump GG",
        ...
        let GET_Elem_Txt = (me) => {
            ...
            obj_data.contenedor_envio = getInput(3).val();
            obj_data.fecha_ingreso = getInput(4).val();
            obj_data.muestras_recepc = getInput(5).val();
            obj_data.muestras_enviadas = getInput(6).val();
            obj_data.folio = getInput(7).val();
            obj_data.fecha_envio = getInput(8).val();
            obj_data.fecha_recepc = getInput(9).val();
            obj_data.fecha_validac = getInput(10).val();
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Excel_TP_Real_ADM_2.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
        ...
        function Ajax_DataTable_agregar(value) {
            ...
            var Data_Par = JSON.stringify({
                ...
                "Contenedor_Envio": obj_transfer.contenedor_envio,
            ...
            $.ajax({
                "type": "POST",
                "url": "Excel_TP_Real_ADM_2.aspx/Ajax_DataTable_agregar",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_LugarTM = [
    {
        ...
        function Ajax_LugarTM() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Excel_TP_Real_ADM_2.aspx/Llenar_Ddl_LugarTM",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Exam = [
    {
        ...
        var Mx_Dtt_Excel = [
      {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Excel_TP_Real_ADM_2.aspx/Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
    ...
    <script>
                        ...
                        "class": "manito"
                            ...
                            $("<td>", {
                                ...
                                return $("<input>", {
                                    ...
                                    "data-cod": "11111",
                                    "class": "td_input jump",
                                    "value": Mx_Dtt[i].Contenedor_Envio,
                                })
                            }())),
        ...
        function Ajax_DataTable_examen3(id, cod, xo) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Excel_TP_Real_ADM_2.aspx/Llenar_tabla_exam",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {

...
Public Class D_GraficoAteTP
    'Declaraciones Generales
    Dim CC_ConnBD As C_ConnBD
    Dim DD_GEN As New D_General_Functions
    Function IRIS_WEBF_BUSCA_CANT_EXAMENES_ATE_FORMA_PAGO(ByVal ID_PAC As Long, ByVal Año As Long, ByVal Mes As Long) As List(Of E_IRIS_WEBF_BUSCA_CANT_EXAMENES_ATE_POR_LUGAR_TM1_TODOS)
        'Declaraciones
        ...
        With Cmd_SQL
            ...
            .CommandText = "IRIS_WEBF_BUSCA_CANT_EXAMENES_ATE_FORMA_PAGO"
        ...
        While Obj_Reader.Read
            ...
            E_Proc_Item.ID_TP_PAGO = DD_GEN.DB_NULL(Obj_Reader, 5, Nothing)

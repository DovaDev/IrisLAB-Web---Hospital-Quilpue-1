...
Public Class IN_PAC_MAN_3
    ...
    Public Shared Function Guardar_TodoByVal(ByVal RUT_PAC As String,
                                               ...
                                               ByVal ids As List(Of ids4),
                                               ByVal xHora As String,
                                             ByVal id_Diag As String,
                                             ByVal id_Diag2 As String,
                                             ByVal sub_atencion As String, ByVal vih As String, ByVal dni As String, ByVal Numero_clini As String, ByVal Sub_progra As String, id_etnia As Integer,
        ...
        If (Paridad = 2) Then
            ...
            PREINGRESO2_PRO_SEC = cc.IRIS_WEBF_GRABA_PREINGRESO3_PRO_SEC_AVIS_NEW(correlativo,
                                                              ...
                                                              FECHA_PRE,
                                                              Programa,
                                                              Sector, Numero_clini, 0, 0, sub_atencion, vih, Sub_progra, 0, xHora
                                                             )
        Else

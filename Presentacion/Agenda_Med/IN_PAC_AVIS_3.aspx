<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="IN_PAC_AVIS_3.aspx.vb" Inherits="Presentacion.IN_PAC_AVIS_3" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function ajax_eliminar() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_AVIS_3.aspx/MODAL_elimanar",
                "data": Data_Par44,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
        ...
        function Ajax_guardar() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_AVIS_3.aspx/Guardar_TodoByVal",
        ...
        var Mx_Dtt_exam02_respaldo_global = [
   {
       ...
       "CF_DIAS": 0,
        ...
        function Ajax_DataTable_examen0GObal() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_AVIS_3.aspx/Llenar_tabla_exam2_global",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Diagnostico() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_AVIS_3.aspx/IRIS_WEBF_BUSCA_DIAGNOSTICO",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function buscar_avis() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_AVIS_3.aspx/Llenar_AVIS",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_exam02_respaldo = [
  {
      ...
      "CF_DIAS": 0,
        ...
        function Ajax_DataTable_examen02() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_AVIS_3.aspx/Llenar_tabla_exam2",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable_examen3(cod_fonasa, id, cod, txis) {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_AVIS_3.aspx/Llenar_tabla_exam",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_AVIS_3.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Ddl = [
    {
        ...
        function Call_AJAX_Ddl() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_AVIS_3.aspx/Llenar_Ddl_LugarTM",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_busca_rut() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_AVIS_3.aspx/Llenar_AVIS_RUT",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DL_SEXO() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_AVIS_3.aspx/Llenar_DL_SEXO",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DL_NAC() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_AVIS_3.aspx/Llenar_DL_NAC",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Ciudad() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_AVIS_3.aspx/IRIS_WEBF_BUSCA_CIUDAD",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Comuna() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_AVIS_3.aspx/IRIS_WEBF_BUSCA_RELACION_CIU_COMUNA",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_prevision = [
      {
        ...
        function Ajax_DL_prevision() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_AVIS_3.aspx/Llenar_DL_prevision",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function AJAX_SIN_RUT() {
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_AVIS_3.aspx/AJAX_SIN_RUT",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_TP_ATE = [
     {
        ...
        function Ajax_DL_TP_ATE() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_AVIS_3.aspx/Llenar_DL_aTENCIONES",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_Sec = [
    {
        ...
        function Ajax_DL_sec() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_AVIS_3.aspx/Llenar_DL_Sectores",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_Programa = [
   {
       ...
       "ID_ESTADO": 0
        ...
        function Ajax_DL_programa() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_AVIS_3.aspx/Llenar_DL_Programa",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_DOC = [
  {
      ...
      "ID_ESTADO": 0
        ...
        function Ajax_DL_DOC() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_AVIS_3.aspx/Llenar_DL_DOC",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_orden_ate = [
 {
     ...
     "ID_ESTADO": 0
        ...
        function Ajax_DL_orden_ate() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_AVIS_3.aspx/Llenar_DL_ordenATE",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_Diag = [
{
    ...
    "DIA_HOST_AVIS": 0
        ...
        function Ajax_DLdiag(hosts) {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_AVIS_3.aspx/IRIS_WEBF_BUSCA_DIAGNOSTICO_POR_HOST",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_Diag2 = [
{
    ...
    "DIA_HOST_AVIS": 0
        ...
        function Ajax_DLdiag2(hosts) {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_AVIS_3.aspx/IRIS_WEBF_BUSCA_DIAGNOSTICO_POR_HOST2",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
    ...
    <div class="card border-bar">
        ...
        <div class="card-body">
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-sm">
                            ...
                            <div class="input-group" style="height: 31.75px;">
                                <input type='text' id="rut" class="form-control textoReducido" placeholder="12.345.789-0" disabled="disabled"/>
                                <span class="input-group-btn">
                ...
                <div class="col-md-12">
                   ...
                   <%--             <option value="0">Seleccionar</option>--%>
                        ...
                        <div class="col-sm">
                            ...
                            <select id="Programa" class="form-control textoReducido" style="height: 31.75px;" disabled="disabled">
                                <option value="volvo">Seleccionar</option>
                            </select>
                        </div>
                        <div class="col-sm">
                            <label class="textoReducido">Sector:</label>
                            <select id="Sector" class="form-control textoReducido" style="height: 31.75px;" disabled="disabled">
                                <option value="volvo">Seleccionar</option>
                            </select>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-sm-3">
                    <button id="Examen" type="button" class="btn btn-pendiente topbuttom2" disabled="disabled">

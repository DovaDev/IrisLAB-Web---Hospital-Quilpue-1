<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="HT_Sec_Proce.aspx.vb" Inherits="Presentacion.HT_Sec_Proce" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
        ...
        var Mx_LugarTM = [
    {
        ...
        function Ajax_LugarTM() {
            ...
            $.ajax({
                "type": "POST",
                "url": "HT_Sec_Proce.aspx/Llenar_Ddl_LugarTM",
                //"data": Data_Par,
        ...
        var Mx_Dtt_Seccion = [
    {
        ...
        function Ajax_Seccion() {
            ...
            $.ajax({
                "type": "POST",
                "url": "HT_Sec_Proce.aspx/Llenar_Ddl_Seccion",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Fill_Ddl_Seccion() {
            $("#DdlSeccion").empty();
            //console.log(Mx_Dtt_Seccion);
            $("<option>", { "value": 0 }).text("Seleccionar").appendTo("#DdlSeccion");
            for (y = 0; y < Mx_Dtt_Seccion.length; ++y) {
                $("<option>", {
                    "value": Mx_Dtt_Seccion[y].ID_SECCION
                }).text(Mx_Dtt_Seccion[y].SECC_DESC).appendTo("#DdlSeccion");
            }
        };
        ...
        function Call_Data_Table() {
            ...
            var Data_Par = JSON.stringify({
                ...
                "ID_SECC": String($("#DdlSeccion").val()),
                "ID_PRE": String($("#Ddl_LugarTM").val()),
            ...
            AJAX_Data_Table = $.ajax({
                "type": "POST",
                "url": "HT_Sec_Proce.aspx/Call_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
                ...
                for (i = 0; i < JSON_Data_Table.length; i++) {
                    ...
                    $("#DataTable tbody").append(
                        $("<tr>", {
                            ...
                            $("<td>", { "align": "left" }, { "class": "textoReducido" }).text(JSON_Data_Table[i].PAC_RUT),
        ...
        function Call_Export() {
            ...
            $.ajax({
                "type": "POST",
                "url": "HT_Sec_Proce.aspx/Gen_Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
            ...
            <div class="card mb-3 border-bar">
                <div class="card-header bg-bar p-1">
                    <h5 style="text-align: center; padding: 5px;">
                        ...
                        Listado de Trabajo Sección y Procedencia
                    </h5>
                </div>
                <div class="card-body">

...
Public Class GraficoAtenciones
    ...
    Public Shared Function Gen_Excel(ByVal MAIN_URL As String, ByVal Mes As String, ByVal Año As String) As String
        ...
        Return NN_Prev.Gen_Excel(MAIN_URL, Mes, Año)
    End Function

    Private Sub GraficoAtenciones_Load(sender As Object, e As EventArgs) Handles Me.Load

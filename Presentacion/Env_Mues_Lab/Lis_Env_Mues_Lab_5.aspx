<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Lis_Env_Mues_Lab_5.aspx.vb" Inherits="Presentacion.Lis_Env_Mues_Lab_5" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
        ...
        var Mx_Dtt_LugarTM = [
    {
        ...
        function Ajax_LugarTM() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Lis_Env_Mues_Lab_5.aspx/Llenar_Ddl_LugarTM",
                //"data": Data_Par,
        ...
        var Mx_Exam = [
    {
        ...
        function Ajax_Exam() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Lis_Env_Mues_Lab_5.aspx/Llenar_Ddl_Exam",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable() {
            ...
            var Data_Par = JSON.stringify({
                ...
                "ID_CF": $("#Ddl_Exam option:selected").text()
            });
            $(".block_wait").fadeIn(500);
            $.ajax({
                "type": "POST",
                "url": "Lis_Env_Mues_Lab_5.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_Excel = [
    {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Lis_Env_Mues_Lab_5.aspx/Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": (resp) => {
        ...
        var Mx_Dtt_PDF = [
{
    "urls": ""
        ...
        function Ajax_PDF() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Lis_Env_Mues_Lab_5.aspx/PDFF",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": (resp) => {
    ...
    <script>
        ...
        function Fill_Ddl_Exam() {
            ...
            for (y = 0; y < Mx_Exam.length; ++y) {
                $("<option>", {
                    "value": Mx_Exam[y].ID_CODIGO_BARRA
                }).text(Mx_Exam[y].CB_DESC).appendTo("#Ddl_Exam");
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
    ...
    <div class="row mb-3" style="margin-left:2px; margin-right: 2px;">
        ...
        <div class="col-md">
            <label for="Ddl_Exam">Cod. Barra:</label>

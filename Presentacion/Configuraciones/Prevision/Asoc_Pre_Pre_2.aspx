<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Asoc_Pre_Pre_2.aspx.vb" Inherits="Presentacion.Asoc_Pre_Pre_2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
    <script>
        ...
        var Mx_Dtt = [{
            ...
            "ID_CF_PRECIO": "",
            "CF_BONIFICACION": "",
            "CF_PRECIO_PARTICULAR": ""
        }];
        function Llenar_Ddl_Examen() {
            //Debug
            $.ajax({
                "type": "POST",
                "url": "Asoc_Pre_Pre_2.aspx/Llenar_Ddl_Examen",
                //"data": Data_Par,
        ...
        function Llenar_Ddl_Año() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Asoc_Pre_Pre_2.aspx/Llenar_Ddl_Año",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": data => {
        ...
        function Llenar_Ddl_Preve() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Asoc_Pre_Pre_2.aspx/Llenar_Ddl_Preve",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": data => {
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Asoc_Pre_Pre_2.aspx/Llenar_DataTable",
                "data": Data_Param,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
        ...
        function Update_Precio() {
            if (Mx_Pos.length > 0) {
                ...
                $.ajax({
                    "type": "POST",
                    "url": "Asoc_Pre_Pre_2.aspx/Update_Precio",
                    "data": Data_Param,
                    "contentType": "application/json;  charset=utf-8",
                    "dataType": "json",
                    "success": data => {
        ...
        function Elimina_Precio() {
            if (Mx_Pos4.length > 0) {
                ...
                $.ajax({
                    "type": "POST",
                    "url": "Asoc_Pre_Pre_2.aspx/Elimina_Precio",
                    "data": Data_Param,
                    "contentType": "application/json;  charset=utf-8",
                    "dataType": "json",
                    "success": data => {
        ...
        function Graba_Precio() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Asoc_Pre_Pre_2.aspx/Graba_Precio",
                "data": Data_Param,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": data => {
        ...
        function Fill_Dtt() {
            ...
            Mx_Dtt.forEach(aah => {
                $("<tr>", {
                    ...
                    $("<td>").append(
                    "<input id='BON" + i + "' class='form-control btn-sm' name='bon' data-toggle='tooltip' title='Para confirmar presione Enter' data-placement='right' />"),
                    $("<td>").append(
                    "<input id='PAR" + i + "' class='form-control btn-sm' name='par' data-toggle='tooltip' title='Para confirmar presione Enter' data-placement='right' />"),
                ...
                $("#BON" + i).val(aah.CF_BONIFICACION);
                $("#PAR" + i).val(aah.CF_PRECIO_PARTICULAR);
                i += 1;
            });
            ...
            $("input[name='amb']").change(function (Me) {
                ...
                var pbon = $("#BON" + pos).val();
                var ppar = $("#PAR" + pos).val();
            ...
            $("input[name='bon']").keypress(function (e) {
               
                var Val_reg2 = 0;
                Val_reg2 = $(this).val();
                Val_reg2 = Val_reg2.replace(/\D/gi, "");
                $(this).val(Val_reg2);
                console.log("nuevo valor bonificacion: " + Val_reg2);
                var pos2 = $(this).parents("tr").attr("data-pos");
                console.log("pos: " + pos2);
                if (e.which == 13) {
                    ////////////////////////////
                    if (Mx_Dtt[pos2].CF_BONIFICACION == 0) {
                        console.log("cero Est" + pos2);
                        Mx_Dtt[pos2].CF_BONIFICACION = parseInt($(this).val());
                    ...
                    if (Mx_Dtt.length >= parseInt(pos2) + 1) {
                        //console.log("#AMB" + (parseInt(pos) + 1));
                        $("#BON" + (parseInt(pos2) + 1)).focus();
                    }
                }

            });
            $("input[name='bon']").change(function (Me) {
                var Val_reg2 = 0;
                Val_reg2 = $(this).val();
                Val_reg2 = Val_reg2.replace(/\D/gi, "");
                $(this).val(Val_reg2);

                var pos2 = $(Me.currentTarget).parents("tr").attr("data-pos");
                var pid = $(Me.currentTarget).parents("tr").attr("value");
                ...
                var pamb = $("#AMB" + pos2).val();
                var pbon = $("#BON" + pos2).val();
                var ppar = $("#PAR" + pos2).val();
                ...
                /////////////////////////////////
                var pos2 = $(this).parents("tr").attr("data-pos");
                if (parseInt($("#BON" + pos).val()) != parseInt(Mx_Pos[pos2].CF_BONIFICACION)) {
                    //console.log("igual");
                    $("#Est" + pos2).empty();
                    $("#Est" + pos2).append(
                        $("<i class='fa fa-check ml-3 text-success fa-2x'></i>")
            ...
            //------------------------------------------------------------------------------------- PARTICULAR
            $("input[name='par']").keypress(function (e) {
                var Val_reg3 = 0;
                Val_reg3 = $(this).val();
                Val_reg3 = Val_reg3.replace(/\D/gi, "");
                $(this).val(Val_reg3);

                var pos3 = $(this).parents("tr").attr("data-pos");
                if (e.which == 13) {
                    ////////////////////////////
                    if (Mx_Dtt[pos3].CF_PRECIO_PARTICULAR == 0) {
                        console.log("cero Est" + pos3);
                        Mx_Dtt[pos3].CF_PRECIO_PARTICULAR = parseInt($(this).val());
                    ...
                    if (Mx_Dtt.length >= parseInt(pos3) + 1) {
                        //console.log("#AMB" + (parseInt(pos) + 1));
                        $("#PAR" + (parseInt(pos3) + 1)).focus();
                    }
                }

            });
            $("input[name='par']").change(function (Me) {
                var Val_reg3 = 0;
                Val_reg3 = $(this).val();
                Val_reg3 = Val_reg3.replace(/\D/gi, "");
                $(this).val(Val_reg3);

                var pos3 = $(Me.currentTarget).parents("tr").attr("data-pos");
                var pid3 = $(Me.currentTarget).parents("tr").attr("value");

                for (var i = 0; i < Mx_Pos.length ; i++) {
                    if (Mx_Pos[i]["ID_PRECIO"] === pid3) {
                        Mx_Pos.splice(i, 1);
                    }
                }

                var pamb = $("#AMB" + pos3).val();
                var pbon = $("#BON" + pos3).val();
                var ppar = $("#PAR" + pos3).val();

                //console.log("change id parent: " + pid3);
                Mx_Pos.push({
                    "ID_PRECIO": pid3,
                    "AMB": pamb,
                    "BON": pbon,
                ...
                /////////////////////////////////
                var pos3 = $(this).parents("tr").attr("data-pos");
                if (parseInt($("#PAR" + pos3).val()) != parseInt(Mx_Dtt[pos3].CF_PRECIO_PARTICULAR)) {
                    //console.log("igual");
                    $("#Est" + pos3).empty();
                    $("#Est" + pos3).append(
                        $("<i class='fa fa-check ml-3 text-success fa-2x'></i>")
                ...
                //console.log(parseInt($("#PAR" + pos3).val())+" "+parseInt(Mx_Dtt[pos3].CF_PRECIO_AMB));

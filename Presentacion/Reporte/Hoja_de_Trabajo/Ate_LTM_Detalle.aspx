<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Ate_LTM_Detalle.aspx.vb" Inherits="Presentacion.Ate_LTM_Detalle" %>
    ...
    <script>
        ...
        var Mx_Dtt_Excel = [
     {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ate_LTM_Detalle.aspx/Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": (resp) => {
            ...
            <div class="card mb-3 border-bar">
                <div class="card-header bg-bar p-1">
                    <h5 style="text-align: center; padding: 5px;">
                        ...
                        Listado de hoja de trabajo por Procedencia Detallado
                    </h5>
                </div>
                <div class="card-body">

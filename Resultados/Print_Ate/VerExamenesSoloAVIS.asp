...
<%
					...
					w_USU_NIC_WW  = w_USU_NIC(A__)  
							...
							IF (CANTIDAD_REG + contLINEA_ ) < 50 THEN
								...
								WHILE NOT rst_BM3.eof
									...
									CALL IMPRIME_RESULTADO(w_ID_PRUEBA, w_ID_UM, w_UM, w_ResultadoA, w_ResultadoN, w_Rango_DESDE, w_Rango_HASTA, w_ID_TP_RESUL, contLINEA_, w_Nom_Seccion, w_TP_Alerta,w_FORMATON, w_TXT_EXTRA,w_EST_RECHAZO)										
									rst_BM3.MOVENEXT
									cont_ = cont_ + 1
									'contLINEA_ = contLINEA_ + 1
								WEND
    ...
    CALL IMPRIME_FECHA_HOY(contLINEA_,w_ID_CF(A__),w_ID_PRUEBA)
					...
					ELSE
								...
								WHILE NOT rst_BM3.eof
									...
									w_TP_Alerta = rst_BM3("ATE_RESULTADO_ALT") 		
                                    w_EST_RECHAZO = rst_BM3("ATE_EST_RECHAZO")																							
									CALL IMPRIME_RESULTADO(w_ID_PRUEBA, w_ID_UM, w_UM, w_ResultadoA, w_ResultadoN, w_Rango_DESDE, w_Rango_HASTA, w_ID_TP_RESUL, contLINEA_, w_Nom_Seccion, w_TP_Alerta,w_EST_RECHAZO)										
									rst_BM3.MOVENEXT
									cont_ = cont_ + 1
									contLINEA_ = contLINEA_ + 1
								WEND
    ...
    Set rst_BM3= connBM3.execute("IRIS_BUSCA_ID_CF_LINK_ANTIBIOGRAMA '"&w_ID_PER_P&"' ")
					...
					CALL IMPRIME_METODO_DEBAJO_2(w_ID_PER_P, contLINEA_)
					CALL IMPRIME_TIPO_MUESTRA_DEBAJO2(w_ID_PER_P, contLINEA_)
...
WHILE NOT rst_BM_HORA.eof
    ...
    NOMBRE_TEST_VV = Replace(NOMBRE_TEST_VV,":","")
        ...
        Set Font = Doc.Fonts("Helvetica-Bold")
		Params("x") = XXX_VVV	+ 25
		Params("y") = (FILAMAXX_VV)-30 - ( CANTIDAD_ANT2 *3)
		Params("size") = 6.5
    ...
    Params("x") = XXX_VVV	+ 30
    Params("y") = (FILAMAXX_VV)-37 - ( CANTIDAD_ANT2 *3)
		Params("size") = 6.5
...
FUNCTION LLAMA_IMPRESION_ANTIBIOGRAMA_(CF_ID, ID_ATEVV_ ,FILAMAXX_VV, XXX_VVV, YYY_VV, CEPA__, ID_DET_ATE)   
...
WHILE NOT rst_BM_HORA.eof
    ...
    NOMBRE_TEST_VV = Replace(NOMBRE_TEST_VV,":","")
        ...
        Set Font = Doc.Fonts("Helvetica-Bold")
		Params("x") = XXX_VVV	+ 30
		Params("y") = (FILAMAXX_VV)-30 - ( CANTIDAD_ANT2 *12)
		Params("size") = 6.5
		Page.Canvas.DrawText FR_TEXTO_, Params, Font							
    ...
    Next 
        ...
        Params("x") = XXX_VVV	+ 30
        Params("y") = (FILAMAXX_VV)-37 - ( CANTIDAD_ANT2 *12)
		Params("size") = 6.5
		Page.Canvas.DrawText res2, Params, Font		
        'contfinal = 1
    ELSE
...
FUNCTION IMPRIME_RESULTADO(w_ID_PRUEBA, w_ID_UM, w_UM, w_ResultadoA, w_ResultadoN, w_Rango_DESDE, w_Rango_HASTA, w_ID_TP_RESUL, contLINEA_, w_Nom_Seccion, w_TP_Alerta,w_FORMATON ,w_TXT_EXTRA,w_EST_RECHAZO)

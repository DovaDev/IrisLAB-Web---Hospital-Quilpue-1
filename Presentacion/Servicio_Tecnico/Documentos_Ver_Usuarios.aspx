<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master_Solicitud.Master" CodeBehind="Documentos_Ver_Usuarios.aspx.vb" Inherits="Presentacion.Documentos_Ver_Usuarios" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function Fill_DataTable() {
            ...
            $("#DataTable_Prevision thead").append(
                $("<tr>").append(
                    ...
                    $("<th>", { "class": "textoReducido" }).text("Acceso")
                )
            );
                ...
                $("#DataTable_Prevision tbody").append(
                    $("<tr>", {
                        ...
                        $("<td>", { "align": "left" }, { "class": "textoReducido" }).text(1),
                        $("<td>", { "align": "left" }, { "class": "textoReducido" }).text("Nómina de exámenes realizados en Laboratorio Clínico CMVM"),
                        $("<td>", { "align": "left" }, { "class": "textoReducido" }).text(function () {                      
                            $(this).append($("<button>", { type: "button", class: "btn btn-success btn-sm", "data-ruta": "ANX_MTM_20110301_ANEXOCARTERA_PRESTACIONES_EXAMENES_LABORATORIO_CLINICO_CMVM.pdf", "data-btn": 1 }).text("Ver Documento"));
                        })
                    )
                );
        ...
        $("<tr>", {
            ...
            $("<td>", { "align": "left" }, { "class": "textoReducido" }).text(2),
            $("<td>", { "align": "left" }, { "class": "textoReducido" }).text("Nómina de exámenes derivados  desde Laboratorio Clínico CMVM a otros prestadores"),
            $("<td>", { "align": "left" }, { "class": "textoReducido" }).text(function () {
                $(this).append($("<button>", { type: "button", class: "btn btn-success btn-sm", "data-ruta": "ANX_MTM_20110301_ANEXOCARTERA_PRESTACIONES_EXAMENES_LABORATORIO_CLINICO_CMVM.pdf", "data-btn": 1 }).text("Ver Documento"));
            })
        )
        ...
        $("<tr>", {
            ...
            $("<td>", { "align": "left" }, { "class": "textoReducido" }).text(3),
            $("<td>", { "align": "left" }, { "class": "textoReducido" }).text("Requisitos para la obtención de muestras: Instrucciones que debe seguir"),
            $("<td>", { "align": "left" }, { "class": "textoReducido" }).text(function () {
                $(this).append($("<button>", { type: "button", class: "btn btn-success btn-sm", "data-ruta": "ANX_MT_20150220_INSTRUCTIVO_PREPARACION_DE_PACIENTES_IPP_PARA_LA_TOMA_DE_MUESTRA.pdf", "data-btn": 1 }).text("Ver Documento"));
            })
        )
    );

...
Public Class D_IRIS_WEBF_GRABA_SECCIONES
    Dim CC_ConnBD As Conexion.ConexionBD
    Dim DD_GEN As New D_General_Functions
    Function IRIS_WEBF_GRABA_SECCIONES(ByVal SECC_COD As String,
        ...
        With Cmd_SQL
            ...
            .CommandText = "IRIS_WEBF_GRABA_SECCIONES"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Enviar parámetros
        With Cmd_SQL.Parameters
            .Add("@SECC_COD", OleDbType.VarChar).Value = SECC_COD
            .Add("@SECC_DES", OleDbType.VarChar).Value = SECC_DES

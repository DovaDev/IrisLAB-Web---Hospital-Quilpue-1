<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="AGRE_EXA_ATE_NORMAL.aspx.vb" Inherits="Presentacion.AGRE_EXA_ATE_NORMAL" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    <script src="../js/Deep-Copy.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <script src="AGRE_EXA_ATE_NORMAL.js?version=<%= DateTime.Now.ToString() %>"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
            ...
            <!-- Modal -->
    <div id="mError_AAH2" class="modal fade" role="dialog" style="z-index:9999999;">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <%--<button type="button" class="close" data-dismiss="modal">&times;</button>--%>
                    <h4 class="modal-title">Seguro Complementario</h4>
                </div>
                <div class="modal-body">
                    <p>Monto 0 en seguro complementario ¿Desea continuar?</p>
                </div>
                <div class="modal-footer">
                    <button type="button" id="button_modal_s_comple" class="btn btn-success" data-dismiss="modal">
                        <span>Si</span>
                    </button>
    ...
    <div class="card border-bar">
        <div class="card-header bg-bar p-2">
            <h5 style="text-align: center; padding: 5px;">
                ...
                Agregar/Quitar Exámenes a una Atención
            </h5>
        </div>

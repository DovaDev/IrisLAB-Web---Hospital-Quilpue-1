...
Public Class REP_LAB_CANT_EXA_AREA
    ...
    Public Shared Function Llenar_Ddl() As String
        ...
        Dim Data_Prev_Activo As New List(Of E_IRIS_WEBF_BUSCA_AREA_TRABAJO_ACTIVA)
        'Consultar por previsiones activas
        Data_Prev_Activo = NN_Activos.IRIS_WEBF_BUSCA_AREA_TRABAJO_ACTIVA
    ...
    Public Shared Function Llenar_DataTable(ByVal ID_CODIGO_FONASA As Long, ByVal DATE_str01 As String,
        ...
        Dim Data_Prev As New List(Of E_IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_AREA)
        ...
        Data_Prev = NN_Exam.IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_AREA(ID_CODIGO_FONASA, Date_01, Date_02)
    ...
    Private Sub REP_LAB_CANT_EXA_AREA_Load(sender As Object, e As EventArgs) Handles Me.Load

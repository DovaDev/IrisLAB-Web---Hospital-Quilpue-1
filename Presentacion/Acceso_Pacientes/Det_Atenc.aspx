<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Det_Atenc.aspx.vb" Inherits="Presentacion.Det_Atenc" %>
...
<head runat="server">
    ...
    <script>
        ...
        function Ajax_Redirect() {
            ...
            window.open(loc + "/Print_Ate/VerExamenes.asp?dato1=" + (ateIDD * 5) + "&dato2=" + (ateIDD * 3) + "&dato3=" + (ateIDD - 9));
            console.log(ateIDD);
        }
        function Ajax_Redirect2() {
            ...
            var loc = location.origin;
            window.open(loc + "/Resultados/Ate_Resultados.aspx?ID=" + idAte);
        }

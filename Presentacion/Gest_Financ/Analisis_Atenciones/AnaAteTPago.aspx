<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="AnaAteTPago.aspx.vb" Inherits="Presentacion.AnaAteTPago" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function Ajax_Ddl() {
            ...
            $.ajax({
                "type": "POST",
                "url": "AnaAteTPago.aspx/Llenar_Ddl",
                //"data": '{}',
        ...
        function Ajax_Ddl_TP() {
            ...
            $.ajax({
                "type": "POST",
                "url": "AnaAteTPago.aspx/Llenar_Ddl_TP",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function AJAX_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "AnaAteTPago.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "AnaAteTPago.aspx/Gen_Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
    <div class="card mb-3 border-bar">
        <div class="card-header bg-bar">
            <h5>Análisis por Forma de Pago</h5>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg">
    ...
    <%--<div id="Flexsupremo">
            <div id="Flexesemisupremo">
                <div id="Div_Table" class="div_main table_data" runat="server">
                    <p>Detalle Mensual</p>
                    <div id="Div_Tabla" style="overflow: auto; max-height: 320px;">
                    </div>
                </div>
                <div id="Div_Total" class="div_main table_data" runat="server">
                    <p>Totales</p>
                    <div id="Div_Tabla_Total">
                    </div>
                </div>
            </div>
            <div id="Div_grafico" class="div_main table_data" runat="server">
                <p>Gráfico</p>
                <div>
                    <div id="Summary_Graph"></div>
                </div>

...
Public Class AnaAteTPago
    ...
    End Function
    <Services.WebMethod()>
    Public Shared Function Llenar_Ddl_TP() As List(Of E_IRIS_WEBF_BUSCA_TIPO_DE_PAGO_INGRESO_ATE)
        'Declaraciones del Serializador
        Dim Serializer As New JavaScriptSerializer
        Dim str_Builder As New StringBuilder
        'Declaraciones Internas
    ...
    Public Shared Function Gen_Excel(ByVal MAIN_URL As String, ByVal Dll As String, ByVal Año As String) As String
        Dim NN_Grafico_Ate As New N_AnaAteTPago
        Return NN_Grafico_Ate.Gen_Excel(MAIN_URL, Dll, Año)
    End Function

    Private Sub AnaAteTPago_Load(sender As Object, e As EventArgs) Handles Me.Load

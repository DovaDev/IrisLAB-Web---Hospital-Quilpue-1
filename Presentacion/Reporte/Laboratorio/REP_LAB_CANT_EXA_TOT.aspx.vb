...
Public Class REP_LAB_CANT_EXA_TOT
    ...
    Public Shared Function Llenar_Ddl() As String
        ...
        Data_Prev_Activo = NN_Activos.IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_ACTIVOS_ASOCIADO_PREVISION
    ...
    Public Shared Function Llenar_DataTable(ByVal ID_CODIGO_FONASA As Long, ByVal DATE_str01 As String,
        ...
        Data_Prev = NN_Exam.IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENES(ID_CODIGO_FONASA, Date_01, Date_02, PROCEDENCIA)

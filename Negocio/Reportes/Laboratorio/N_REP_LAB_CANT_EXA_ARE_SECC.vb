...
Imports Entidades
Imports Datos
Public Class N_REP_LAB_CANT_EXA_ARE_SECC
    'Declaraciones Generales
    Dim DD_Data As D_REP_LAB_CANT_EXA_ARE_SECC
    Sub New()
        DD_Data = New D_REP_LAB_CANT_EXA_ARE_SECC
    End Sub
    Function IRIS_BUSCA_WEBF_LIS_ADM_RESU_CANT_EXAMENES_AREA_SECCION(ByVal ID_TP_PAGO As Long, ByVal DESDE As Date, ByVal HASTA As Date) As List(Of E_IRIS_BUSCA_WEBF_LIS_ADM_RESU_CANT_EXAMENES_AREA_SECCION)
        Return DD_Data.IRIS_BUSCA_WEBF_LIS_ADM_RESU_CANT_EXAMENES_AREA_SECCION(ID_TP_PAGO, DESDE, HASTA)
    End Function
    Function Gen_Excel(ByVal MAIN_URL As String, ByVal ID_CODIGO_FONASA As Long, ByVal DATE1 As String, ByVal DATE2 As String) As String
        ...
        Dim Data_Exam As New List(Of E_IRIS_BUSCA_WEBF_LIS_ADM_RESU_CANT_EXAMENES_AREA_SECCION)
        ...
        'Realizar Consulta
        Data_Exam = NN_Exam.IRIS_BUSCA_WEBF_LIS_ADM_RESU_CANT_EXAMENES_AREA_SECCION(ID_CODIGO_FONASAA, Date01, Date02)
        ...
        'nombrar hoja 
        sl.RenameWorksheet("Sheet1", "Cantidad de Exámenes por Área y Sección")
        'titulo de la tabla
        sl.SetCellValue("B2", "Cantidad de Exámenes por Área y Sección")

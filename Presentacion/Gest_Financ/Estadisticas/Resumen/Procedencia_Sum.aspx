<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Procedencia_Sum.aspx.vb" Inherits="Presentacion.Procedencia_Sum" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#Btn_Search").click(function () {
                ...
                var Date_Diff = restaFechas(String($("#Txt_Date02 input").val()), String($("#Txt_Date02 input").val()));
    ...
    <script>
        ...
        function Ajax_Ddl() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Procedencia_Sum.aspx/Llenar_Ddl",
                //"data": '{}'
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Procedencia_Sum.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Procedencia_Sum.aspx/Gen_Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
    ...
    <script>
        ...
        function Fill_Ddl() {
            ...
            if (procee == 0) {
                ...
                ).text("Todos").appendTo("#DdlProcedencia");
                Mx_Ddl.forEach(aaa => {
                    $("<option>",
                        {
                            "value": aaa.ID_PROCEDENCIA
                        }
                    ).text(aaa.PROC_DESC).appendTo("#DdlProcedencia");
                });
            }
            else {
                Mx_Ddl.forEach(aaa => {
        ...
        function Fill_DataTable() {
            ...
            for (i = 0; i < Mx_Dtt.length; i++) {
                ...
                AR_pro.push(Mx_Dtt[i].PROC_DESC);
...
<div id="mError_AAH" class="modal fade" role="dialog">
    ...
    <div class="card mb-3 border-bar">
        <div class="card-header bg-bar p-2">
            <h5>Resumen de Atenciones por Procedencia</h5>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg">
        ...
        <div class="col-lg">
            ...
            <div class='input-group date' id='Txt_Date02'>
                ...
                <div class="col-lg">
                    <label for="DdlProcedencia">Lugar de TM:</label>
                    <select id="DdlProcedencia" class="form-control"></select>
                </div>
                <%--  <div class="col-lg-1">

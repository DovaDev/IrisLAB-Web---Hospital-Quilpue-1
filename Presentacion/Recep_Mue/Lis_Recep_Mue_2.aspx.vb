...
Public Class Lis_Recep_Mue_2
    ...
    Public Shared Function Excel(ByVal DOMAIN_URL As String, ByVal TIPO As Integer, ByVal DESDE As String, ByVal HASTA As String,
        ...
        If TIPO = 7 Then ' 7 = NO RECEPCIONADO
            data_det_ate = NN_Det_Ate.IRIS_WEBF_BUSCA_ETIQUETAS_NO_RECEPCIONADA_Y_OTRAS_RVDR_2_2_2(TIPO, DESDE, HASTA, ID_PRE, ID_CF)
        ElseIf TIPO = 9 Then '9 RECEPCIONADO
            data_det_ate = NN_Det_Ate.IRIS_WEBF_BUSCA_ETIQUETAS_NO_RECEPCIONADA_Y_OTRAS_RVDR_2_2_2_3_POR_FECHA_RECEP(TIPO, DESDE, HASTA, ID_PRE, ID_CF)
        ElseIf TIPO = 0 Then
            data_det_ate = NN_Det_Ate.IRIS_WEBF_BUSCA_ETIQUETAS_NO_RECEPCIONADA_Y_OTRAS_RVDR_2_2_2(7, DESDE, HASTA, ID_PRE, ID_CF)
            data_det_ate_2 = NN_Det_Ate.IRIS_WEBF_BUSCA_ETIQUETAS_NO_RECEPCIONADA_Y_OTRAS_RVDR_2_2_2_3_POR_FECHA_RECEP(9, DESDE, HASTA, ID_PRE, ID_CF)
        ...
        If (data_det_ate.Count > 0) Then
            ...
            For y = 0 To (data_det_ate.Count - 1)
                ...
                End If
                Mx_Data(4, y) = data_det_ate(y).PAC_FNAC
        ...
        'nombrar hoja 
        sl.RenameWorksheet("Sheet1", "Listado de Recepción de Exámenes")

        'titulo de la tabla
        sl.SetCellValue("B2", "Listado de Recepción de Exámenes")
    ...
    Public Shared Function Llenar_DataTable(ByVal TIPO As Integer, ByVal DESDE As String, ByVal HASTA As String, ByVal ID_PRE As Integer, ByVal ID_CF As Integer) As List(Of E_IRIS_WEBF_BUSCA_ETIQUETAS_NO_RECEPCIONADA_Y_OTRAS_RVDR_2_2_2)
        ...
        If TIPO = 7 Then ' 7 = NO RECEPCIONADO
            data_det_ate = NN_Det_Ate.IRIS_WEBF_BUSCA_ETIQUETAS_NO_RECEPCIONADA_Y_OTRAS_RVDR_2_2_2_4_COPY(TIPO, DESDE, HASTA, ID_PRE, ID_CF)
        ElseIf TIPO = 9 Then '9 RECEPCIONADO
            data_det_ate = NN_Det_Ate.IRIS_WEBF_BUSCA_ETIQUETAS_NO_RECEPCIONADA_Y_OTRAS_RVDR_2_2_2_3_POR_FECHA_RECEP(TIPO, DESDE, HASTA, ID_PRE, ID_CF)
        ElseIf TIPO = 0 Then
            data_det_ate = NN_Det_Ate.IRIS_WEBF_BUSCA_ETIQUETAS_NO_RECEPCIONADA_Y_OTRAS_RVDR_2_2_2_4_COPY(TIPO, DESDE, HASTA, ID_PRE, ID_CF)

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="REP_LAB_EXA.aspx.vb" Inherits="Presentacion.REP_LAB_EXA" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function Ajax_Ddl_Proce() {
            ...
            AJAX_Ddl = $.ajax({
                "type": "POST",
                "url": "REP_LAB_EXA.aspx/Llenar_Ddl_LugarTM",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": data => {
        ...
        function Ajax_Ddl() {
            ...
            $.ajax({
                "type": "POST",
                "url": "REP_LAB_EXA.aspx/Llenar_Ddl",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "REP_LAB_EXA.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "REP_LAB_EXA.aspx/Gen_Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_PDF() {
            ...
            var Data_Par = JSON.stringify({
                "DOMAIN_URL": location.origin,
                "ID_CODIGO_FONASA": parseInt($("#DdlExamen").val()),
...
<asp:Content ID="Content3" ContentPlaceHolderID="Cph_Body" runat="server">
    ...
    <div class="card mb-3 border-bar">
        <div class="card-header bg-bar">
            <h5>Búsqueda de Atenciones por examen</h5>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg">

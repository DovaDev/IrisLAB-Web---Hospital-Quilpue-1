...
Public Class Exa_Pen_Sec
    ...
    Public Shared Function Llenar_Ddl_Exam() As String
        ...
        Dim NN_Exam As New N_IRIS_WEBF_BUSCA_RELACION_AREA_SECCION_ESTADO
        Dim Data_Exam As New List(Of E_IRIS_WEBF_BUSCA_RELACION_AREA_SECCION_ESTADO)
        Data_Exam = NN_Exam.IRIS_WEBF_BUSCA_RELACION_AREA_SECCION_ESTADO()
    ...
    Public Shared Function Llenar_DataTable(ByVal DESDE As String, ByVal HASTA As String,
        ...
        Dim str_Builder As New StringBuilder
        'Declaraciones internas
        Dim NN As New N_IRIS_WEBF_BUSCA_EST_PENDIENTE_SECCION_INFORMAR
        Dim Data As New List(Of E_IRIS_WEBF_BUSCA_EST_PENDIENTE_SECCION_INFORMAR)
        Dim NN_Datos_Pac As New N_IRIS_WEBF_BUSCA_EST_PENDIENTE_SECCION_INFORMAR
        Dim Data_Datos_Pac As New List(Of E_IRIS_WEBF_BUSCA_EST_PENDIENTE_SECCION_INFORMAR)
        Data = NN.IRIS_WEBF_BUSCA_EST_PENDIENTE_SECCION_INFORMAR(CDate(DESDE), CDate(HASTA), ID_CF)
    ...
    Public Shared Function Excel(ByVal DOMAIN_URL As String, ByVal DESDE As String, ByVal HASTA As String,
        ...
        End If
        'nombrar hoja 
        sl.RenameWorksheet("Sheet1", "Exámenes Pendientes por Sección")
        'titulo de la tabla
        sl.SetCellValue("B2", "Exámenes Pendientes por Sección")
        For y = 1 To 11

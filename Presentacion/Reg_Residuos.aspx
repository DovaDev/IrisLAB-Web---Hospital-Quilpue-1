<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Reg_Residuos.aspx.vb" Inherits="Presentacion.Reg_Residuos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        function ajax_eliminar(ID_WEN) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Reg_Residuos.aspx/Eliminar",
                "data": Data_Par44,
        ...
        function add_row() {
            ...
            if (permiss == "1") {
                ...
                Mx_Dtt_LugarTM.forEach(aaa => {
                    $("<option>", { "value": aaa.ID_PROCEDENCIA }).text(aaa.PROC_DESC).appendTo("#DdlLugatTMTabbla");
                });
            } else if (usu_te_eme == 0) {
                Mx_Dtt_LugarTM.forEach(aaa => {
                        $("<option>", { "value": aaa.ID_PROCEDENCIA }).text(aaa.PROC_DESC).appendTo("#DdlLugatTMTabbla");
                });
            }
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Reg_Residuos.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
        ...
        function Ajax_DataTable_agregar(value) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Reg_Residuos.aspx/Ajax_DataTable_agregar",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_SECCION_RESIDUO() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Reg_Residuos.aspx/Llenar_Ddl_SECCCION_RESIDUO",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_TP_RESIDUO() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Reg_Residuos.aspx/Llenar_Ddl_TP_RESIDUO",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_LugarTM = [
    {
        ...
        function Ajax_LugarTM() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Reg_Residuos.aspx/Llenar_Ddl_LugarTM",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_Excel = [
  {
    ...
    <script>
            ...
            for (i = 0; i < Mx_Dtt.List_Data.length; i++) {
                ...
                $("#DataTable tbody").append(
                    $("<tr>", {
                        ...
                        "class": "manito"
                            ...
                            $("<td>", {
                             ...
                             $("<td>", {
                                 ...
                                 //Retornar un campo input
                                 return $("<input>", {
                                     "data-id": Mx_Dtt.List_Data[i].ID_RESIDUO,             //SUPERVISOR REAS NUEVO CAMPO
                                     "data-cod": "10",
                                     "class": "td_input jump border_round",
                            ...
                            $("<td>", {
                                ...
                                return $("<select>", {
                                    "id": "slctProce" + i,
                                    "data-id": Mx_Dtt.List_Data[i].ID_PROCEDENCIA,
                                    "data-cod": "9",
                                    "class": "td_input jump border_round"
                                })
                            }()))
                        ...
                        //    "align": "center"
                        //}).html(function () {
                        //    return "<button type='button' class='btn btn-danger btn-xs borrar' value='Eliminar' data-id='" + Mx_Dtt.List_Data[i].ID_RESIDUO + "' style='padding: .1rem .1rem;font-size: 14px;cursor: pointer;'><i class='fa fa-trash-o' aria-hidden='true'></i> Eliminar</button>"
                        //})
                ...
                if (permiss == "1") {
                    console.log("Admin");
                    Mx_Dtt_LugarTM.forEach(aaa => {
                        $("<option>", { "value": aaa.ID_PROCEDENCIA }).text(aaa.PROC_DESC).appendTo("#slctProce" + i);
        ...
        function IRIS_WEBF_UPDATE_RESIDUOS(id, cod, xo) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Reg_Residuos.aspx/IRIS_WEBF_UPDATE_RESIDUOS",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {

...
Public Class D_IRIS_WEBF_BUSCA_ETIQUETA_BARRA_PACIENTE_RECEP
    Function IRIS_WEBF_BUSCA_ETIQUETA_BARRA_PACIENTE_RECEP(ByVal NUM_ATE As String, ByVal CB As String) As List(Of E_IRIS_WEBF_BUSCA_ETIQUETA_BARRA_PACIENTE_RECEP)
        ...
        'Declaraciones 'lista'
        Dim E_Proc_Item As E_IRIS_WEBF_BUSCA_ETIQUETA_BARRA_PACIENTE_RECEP
        Dim E_Proc_List As New List(Of E_IRIS_WEBF_BUSCA_ETIQUETA_BARRA_PACIENTE_RECEP)

        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_BUSCA_ETIQUETA_BARRA_PACIENTE_RECEP"
        ...
        While Obj_Reader.Read
            E_Proc_Item = New E_IRIS_WEBF_BUSCA_ETIQUETA_BARRA_PACIENTE_RECEP

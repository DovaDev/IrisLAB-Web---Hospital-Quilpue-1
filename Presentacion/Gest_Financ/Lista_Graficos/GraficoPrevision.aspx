<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="GraficoPrevision.aspx.vb" Inherits="Presentacion.GraficoPrevision" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function Ajax_Ddl() {
            ...
            $.ajax({
                "type": "POST",
                "url": "GraficoPrevision.aspx/Llenar_Ddl",
                //"data": '{}',
        ...
        function Ajax_Ddl_Prev() {
            ...
            $.ajax({
                "type": "POST",
                "url": "GraficoPrevision.aspx/Llenar_Ddl_Prev",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function AJAX_DataTable() {
            ...
            var Data_Par = JSON.stringify({
                "Dll": String($("#DllPrev").val()),
                "Año": $("#DllAño option:selected").text()
            });
            modal_show();
            $.ajax({
                "type": "POST",
                "url": "GraficoPrevision.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "GraficoPrevision.aspx/Gen_Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {

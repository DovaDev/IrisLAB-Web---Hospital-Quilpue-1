<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="AVIS_C_D_2.aspx.vb" Inherits="Presentacion.AVIS_C_D_2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function Ajax_N_PACIENTE() {
            ...
            var ajax_tabla = $.ajax({
                "type": "POST",
                "url": "AVIS_C_D_2.aspx/Llenar_AVIS",
                "data": Data_Par_tabla,
    ...
    <script>
        function Ajax_Exa_no_dis(id_01) {
            ...
            var ajax_tabla = $.ajax({
                "type": "POST",
                "url": "AVIS_C_D_2.aspx/Ajax_Exa_dis",
                "data": Data_Par_tabla,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Exa_dis(id_02) {
            ...
            var ajax_tabla = $.ajax({
                "type": "POST",
                "url": "AVIS_C_D_2.aspx/Ajax_Exa_no_dis",
                "data": Data_Par_tabla,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {

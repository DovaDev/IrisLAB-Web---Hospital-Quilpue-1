...
Public Class D_IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_POR_ID_3
    ...
    Function IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_POR_ID_3(ByVal DESDE As Date, ByVal HASTA As Date, ByVal ID_CF As Integer, ByVal PROCEDENCIA As Integer) As List(Of E_IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_POR_ID_3)
        ...
        'Declaraciones 'lista'
        Dim E_Proc_Item As E_IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_POR_ID_3
        Dim E_Proc_List As New List(Of E_IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_POR_ID_3)
        'Configuración general
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_POR_ID_3"
        ...
        With Cmd_SQL.Parameters
            ...
            .Add("@HASTA", OleDbType.Integer).Value = ID_CF
        ...
        While Obj_Reader.Read
            E_Proc_Item = New E_IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_POR_ID_3
            ...
            E_Proc_Item.FECHA_NAC = DD_GEN.DB_NULL(Obj_Reader, 17, Nothing)
            E_Proc_Item.DNI = DD_GEN.DB_NULL(Obj_Reader, 18, Nothing)
            E_Proc_Item.NACIONALIDAD = DD_GEN.DB_NULL(Obj_Reader, 19, Nothing)
            E_Proc_Item.PROGRAMA = DD_GEN.DB_NULL(Obj_Reader, 20, Nothing)
            E_Proc_Item.SECTOR = DD_GEN.DB_NULL(Obj_Reader, 21, Nothing)
            E_Proc_Item.ATE_NUMERO_INTERNO = DD_GEN.DB_NULL(Obj_Reader, 22, Nothing)
    ...
    Function IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_POR_ID_3_2(ByVal DESDE As Date, ByVal HASTA As Date, ByVal ID_CF As Integer, ByVal PROCEDENCIA As Integer) As List(Of E_IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_POR_ID_3)
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_POR_ID_3_2"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Enviar parámetros
        With Cmd_SQL.Parameters
        ...
        While Obj_Reader.Read
            ...
            E_Proc_Item.SECTOR = DD_GEN.DB_NULL(Obj_Reader, 21, Nothing)
            E_Proc_Item.ATE_NUMERO_INTERNO = DD_GEN.DB_NULL(Obj_Reader, 22, Nothing)
            E_Proc_Item.DOC_NOMBRE = DD_GEN.DB_NULL(Obj_Reader, 23, "")
            E_Proc_Item.DOC_APELLIDO = DD_GEN.DB_NULL(Obj_Reader, 24, "")
            E_Proc_Item.PAC_RUT = DD_GEN.DB_NULL(Obj_Reader, 25, Nothing)
            E_Proc_Item.ATE_OBS_TM = DD_GEN.DB_NULL(Obj_Reader, 26, "")

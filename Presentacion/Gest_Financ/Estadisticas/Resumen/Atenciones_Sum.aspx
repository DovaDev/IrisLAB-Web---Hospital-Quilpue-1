<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Atenciones_Sum.aspx.vb" Inherits="Presentacion.Atenciones_Sum" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function Ajax_Ddl() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Atenciones_Sum.aspx/Llenar_Ddl",
                //"data": '{}'
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Atenciones_Sum.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Atenciones_Sum.aspx/Gen_Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
    ...
    <script>
        ...
        function Fill_DataTable() {
            ...
            for (i = 0; i < Mx_Dtt.length; i++) {
                $("#DataTable tbody").append(
                    $("<tr>").append(
                        ...
                        $("<td>", { "align": "left" }).text(Mx_Dtt[i].PROGRA_DESC),
            ...
            $("#DataTableTotal tbody").append(
                    $("<tr>").append(
                        $("<td>", { "align": "right" }).text(T_Ate),
                        $("<td>", { "align": "right" }).text(T_Exa),
            ...
            for (i = 0; i < Mx_Dtt.length; i++) {
                ...
                AR_pro.push(Mx_Dtt[i].PROGRA_DESC);
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
    ...
    <div class="flex_col">
        ...
        <div class="card-header bg-bar p-2">
            <h5>Resumen de Atenciones por Programa</h5>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg">
